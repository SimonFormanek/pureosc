...
?>
  ...
  <div class="buttonSet">
    <?php echo tep_draw_button(IMAGE_BUTTON_BACK_ADVANCED_SEARCH, 'fa fa-angle-left', tep_href_link(FILENAME_ADVANCED_SEARCH, tep_get_all_get_params(array('sort', 'page')), 'NONSSL', true, false)); ?>
  </div>
</div>
