        ...
        ?>
                                <tr>
                                    ...
                                    <td><table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td class="main" valign="top"><?php echo tep_image(tep_catalog_href_link(DIR_WS_LANGUAGES.$languages[$i]['directory'].'/images/'.$languages[$i]['image'],
                                                '', 'SSL'),
                                            $languages[$i]['name']); ?>&nbsp;</td>
        ...
        for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
            ?>
                                    <tr>
                                        ...
                                        <td><table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="main" valign="top"><?php echo tep_image(tep_catalog_href_link(DIR_WS_CATALOG_LANGUAGES.$languages[$i]['directory'].'/images/'.$languages[$i]['image'],
                                        '', 'SSL'), $languages[$i]['name']); ?>&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td class="main" style="padding-left: 30px;">
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        va                                        r piSize = <?php echo $pi_counter; ?>;
                                        ...
                                        <tr>
                                            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif',
                                                    ...
                                                    if (!isset($_GET['pID'])) {
                                                        ?>
                                        <tr>
                                            <td><?php echo NEW_PRODUCT_INSERTING; ?></td><td class="smallText" align="right"><?php echo TEXT_SAVE_NOW.'&nbsp;'.tep_draw_button(IMAGE_SAVE,
            ...
            ?>
                ...
                == 0) echo TEXT_PRODUCTS_SEO_KEYWORDS; ?></td>
                                                                        <td><table border="0" cellspacing="0" cellpadding="0">
                                                                                ...
                                                                                $languages[$i]['name']); ?>&nbsp;</td>
                                                                                    <td class="main" valign="top"><?php echo tep_draw_input_field('products_seo_keywords['.$languages[$i]['id'].']',
...
//		$category_seo_title_string .= '<br />Počet znaků limit max: 70 aktuálně ULOŽENO: <strong>' . (empty(tep_get_category_seo_title($cInfo->categories_id, $languages[$i]['id'])) ? mb_strlen($emptytitle) : mb_strlen(tep_get_category_seo_title($cInfo->categories_id, $languages[$i]['id']))) . '</strong>  Editace aktuálně zbývá: <span id="counter_title"></span>';
                ...
                - mb_strlen(STORE_NAME); ?>) - document.getElementById('seotitle_<?php echo $languages[$i]['id']; ?>').value.length;
                            ...
                            count_titl                                            e_<?php echo $languages[$i]['id']; ?>();
                            </script>
            <?php
            }
            for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
