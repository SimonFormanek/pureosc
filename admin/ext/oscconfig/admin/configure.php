<?php
  define('DIR_FS_DOCUMENT_ROOT', '/home/f/git/osc/osc/'); // <------ need to bee configured
...
//  define('ADMIN_PRIVATE_KEYS_PATH','/home/printondemand/admin_private_keys/'); //SECURITY WARNING: on production environement save keys on removable media
  ...
  define('HTTP_SERVER', 'http://osc.local'); // <------ need to bee configured
  define('HTTPS_SERVER', 'http://osc.local'); // <------ need to bee configured
  define('ENABLE_SSL', false);
  define('HTTP_COOKIE_DOMAIN', '');
  define('HTTPS_COOKIE_DOMAIN', '');
  define('HTTP_COOKIE_PATH', '/admin');
  define('HTTPS_COOKIE_PATH', '/admin');
  define('HTTP_CATALOG_SERVER', 'http://osc.local'); // <------ need to bee configured
  define('HTTPS_CATALOG_SERVER', 'http://osc.local'); // <------ need to bee configured
  define('ENABLE_SSL_CATALOG', 'true');
  define('DIR_WS_ADMIN', '/admin/');
  define('DIR_WS_HTTPS_ADMIN', '/admin/');// <------ need to bee configured SECURITY: obfuscation
  define('DIR_FS_ADMIN', '/home/f/git/osc/osc/admin/'); //  <------ need to bee configured SECURITY: obfuscation
  define('DIR_WS_CATALOG', '/');
  define('DIR_WS_HTTPS_CATALOG', '/');
  define('DIR_FS_CATALOG', '/home/f/git/osc/osc/'); // <------ need to bee configured
  ...
  define('DIR_FS_CATALOG_IMAGES', '/home/f/git/osc/osc/images/'); // <------ need to bee configured
