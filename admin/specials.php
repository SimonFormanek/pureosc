...
if (tep_not_null($action)) {
    switch ($action) {
        ...
        case 'update':
            ...
            tep_redirect(tep_href_link(FILENAME_SPECIALS,
                    'page='.$_GET['page'].'&sID='.$specials_id));
            break;
        case 'deleteconfirm':
...
// (when creating a new product on special)
    ...
    <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
                ...
                $specials_split     = new splitPageResults($_GET['page'],
            ...
            echo '<a href="'.tep_href_link(FILENAME_SPECIALS,
                'page='.$_GET['page'].'&sID='.$specials['specials_id']).'">'.tep_image(DIR_WS_IMAGES.'icon_info.gif',
                IMAGE_ICON_INFO).'</a>';
        } ?>&nbsp;</td>
                    </tr>
            <?php
        ...
        default:
            if (is_object($sInfo)) {
                ...
                $contents[] = array('align' => 'center', 'text' => tep_draw_button(IMAGE_EDIT,
                        'document',
                        tep_href_link(FILENAME_SPECIALS,
                            'page='.$_GET['page'].'&sID='.$sInfo->specials_id.'&action=edit')).tep_draw_button(IMAGE_DELETE,
                        'trash',
                        tep_href_link(FILENAME_SPECIALS,
