...
if (($_GET['vstup']==1)) {
if ($_GET['now']==1) tep_db_query("UPDATE orders SET date_tax=NOW() WHERE orders_id=" . $_GET['oID']); else tep_db_query("UPDATE orders SET date_tax='" . $_POST['newdate'] . "' WHERE orders_id=" . $_GET['oID']);
