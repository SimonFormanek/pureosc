              ...
              <tr>
               <td valign="top"><table border="0" cellpadding="0">           
                ...
                <tr>
                 ...
                 <td><?php echo tep_draw_input_field('silo_max_links_'.$languages[$i]['id'], $siloArray[$languages[$i]['id']]['max_links'], 'maxlength="60" size=20"', false, '', false); ?> </td>
                </tr>            
                <tr>
                 <td class="main" valign="top"><?php echo ENTRY_SILO_SORT_BY; ?></td>
                 <td><table width="280" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                   <td class="main" align=left><INPUT TYPE="radio" NAME="<?php echo 'sort_group_'.$languages[$i]['id']; ?>" VALUE="0" <?php echo ($siloArray[$languages[$i]['id']]['sorton'] == 0 ? 'checked' : ''); ?> onClick="return EnableGenericCheckBoxes(0);" ><?php echo ENTRY_SILO_SORT_DATE;   ?></td>
                   <td class="main" align=left><INPUT TYPE="radio" NAME="<?php echo 'sort_group_'.$languages[$i]['id']; ?>" VALUE="1" <?php echo ($siloArray[$languages[$i]['id']]['sorton'] == 1 ? 'checked' : ''); ?> onClick="return EnableGenericCheckBoxes(0);" ><?php echo ENTRY_SILO_SORT_NAME;   ?></td>
                   <td class="main" align=left><INPUT TYPE="radio" NAME="<?php echo 'sort_group_'.$languages[$i]['id']; ?>" VALUE="2" <?php echo ($siloArray[$languages[$i]['id']]['sorton'] == 2 ? 'checked' : ''); ?> onClick="return EnableGenericCheckBoxes(0);" ><?php echo ENTRY_SILO_SORT_BEST;   ?></td>
                   <td class="main" align=left><INPUT TYPE="radio" NAME="<?php echo 'sort_group_'.$languages[$i]['id']; ?>" VALUE="3" <?php echo ($siloArray[$languages[$i]['id']]['sorton'] == 2 ? 'checked' : ''); ?> onClick="return EnableGenericCheckBoxes(1);" ><?php echo ENTRY_SILO_SORT_CUSTOM; ?></td>
                  </tr>
                 </table></td>  
                </tr>
                <tr>
                 <td class="main" valign="top"><?php echo ENTRY_SILO_DISABLE; ?></td>
                 <td><input type="checkbox" name="<?php echo 'disable_'.$languages[$i]['id']; ?>" <?php echo ($siloArray[$languages[$i]['id']]['is_disabled'] == 1 ? 'checked' : ''); ?> ></td>
                </tr>
               </table></td>              
            ...
            <tr>
             <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="line-height: 20px; background-color: #fff; border: ridge #CCFFCC 3px; padding-left: 2px;">
              ...
              <tr>
               ...
               ?>
                <tr>
                 <td class="main" width="30%"><?php echo tep_get_category_name($silo['category_id'], $languages[$i]['id']); ?></td>
