...
if (($_POST['del']=='sessions') || ($_POST['del']=='all')) mysql_query('truncate sessions');

if (($_POST['del']=='customers_basket') || ($_POST['del']=='all')) mysql_query('truncate customers_basket');
if (($_POST['del']=='whos_online') || ($_POST['del']=='all')) mysql_query('truncate whos_online');
...
if (($_POST['del']=='administrators') || ($_POST['del']=='all')) mysql_query('truncate administrators');
if (($_POST['del']=='action_recorder') || ($_POST['del']=='all')) mysql_query('truncate action_recorder');
