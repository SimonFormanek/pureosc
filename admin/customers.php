...
if ($action == 'edit' || $action == 'update') {
    ...
    ?>
        ...
        HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT); ?></td>
                ...
                <tr><?php echo tep_draw_form('customers', FILENAME_CUSTOMERS,
            ...
            <tr>
                ...
                while ($customers           = tep_db_fetch_array($customers_query)) {
                    ...
                    ?>
                        ...
                        && is_object($cInfo) && ($customers['customers_id'] == $cInfo->customers_id)) {
    ...
    if (isset($_GET['search']) && tep_not_null($_GET['search'])) {
        ?>
            ...
            'arrowrefresh-1-w', tep_href_link(FILENAME_CUSTOMERS)); ?></td>
                                        </tr>
        <?php
    }
    ?>
