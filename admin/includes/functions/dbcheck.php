...
//Let's find out if we have matches.  If not, we say so.
                        if ($num < 1) {
                            echo "<td width='100%' align='center' class='dataTableRow'>";
                            echo NO_PRODUCTS_NAMES;
                            "</td>";
                        } else {
...
//  Query database for related info on all products without categories.  Determined by finding p.products_id not in pc.products_id.
                                                                                        ...
                                                                                        $query
                                                                                            = "SELECT p.products_id, p.products_model, p.products_price, p.products_date_added, p.manufacturers_id, p.products_id, pd.products_id, pd.products_name, m.manufacturers_id, m.manufacturers_name FROM ".TABLE_PRODUCTS." p, ".TABLE_PRODUCTS_DESCRIPTION." pd, ".TABLE_MANUFACTURERS." m WHERE p.products_id = pd.products_id AND p.manufacturers_id = m.manufacturers_id AND p.products_id NOT IN(SELECT products_id FROM ".TABLE_PRODUCTS_TO_CATEGORIES.") GROUP BY p.products_id";

                                                                                        $query
                                                                                            = "SELECT p.products_id, p.products_model, p.products_price, p.products_date_added, p.manufacturers_id, pc.products_id AS PC_ID, pd.products_id AS PD_ID, pd.products_name, m.manufacturers_id, m.manufacturers_name FROM (((".TABLE_PRODUCTS." p) LEFT JOIN ".TABLE_PRODUCTS_DESCRIPTION." pd ON p.products_id = pd.products_id) LEFT JOIN ".TABLE_MANUFACTURERS." m ON p.manufacturers_id = m.manufacturers_id) LEFT JOIN ".TABLE_PRODUCTS_TO_CATEGORIES." pc on p.products_id = pc.products_id WHERE  pc.products_id IS NULL GROUP BY p.products_id ORDER BY p.products_id";
...
//  Begin loop for results.
                                                                                                        ...
                                                                                                        = 0; $i
                                                                                                            ...
                                                                                                            $querya
                                                                                                                = "SELECT c.categories_id, c.parent_id FROM ".TABLE_CATEGORIES." c WHERE c.parent_id = '".$categories_id."' ORDER BY c.categories_id";
...
//  Query database for products to categories duplicates.  Determined by finding duplicates instances of the same (products_id) AND (categories_id) together from products_to_categories > 1.
                                                                                                                    $query
                                                                                                                        = "SELECT products_id, categories_id, COUNT(products_id + categories_id) AS NumberOccurances FROM ".TABLE_PRODUCTS_TO_CATEGORIES." GROUP BY products_id, categories_id HAVING ( COUNT(*) > 1)";
                                                                                                                    $query_info
                                                                                                                        = tep_db_query($query);
...
//  Let's get more user friendly information based on the results of the first query.
                                                                                                                            $second_query
                                                                                                                                = "SELECT p.products_id, p.products_model, pd.products_id, pd.products_name, c.categories_id, c.parent_id, cd.categories_name FROM ".TABLE_PRODUCTS." p, ".TABLE_PRODUCTS_DESCRIPTION." pd, ".TABLE_CATEGORIES." c, ".TABLE_CATEGORIES_DESCRIPTION." cd WHERE p.products_id = '".(int) $products_id."' AND pd.products_id = '".(int) $products_id."' AND c.categories_id = '".(int) $categories_id."' AND cd.categories_id = '".(int) $categories_id."'";
                                                                                                                            $second_query_info
                                                                                                                                = mysqli_query($second_query);
                                                                                                                            $row2
                                                                                                                                = tep_db_fetch_array($second_query_info);
                                                                                                                            $cPath
                                                                                                                                = $row2['parent_id'];
                                                                                                                            $products_name
                                                                                                                                = $row2['products_name'];
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td width="100%"><table border="1" width="100%" cellspacing="0" cellpadding="0">
                                                                                                                                                    ...
                                                                                                                                                    $prodCount
                                                                                                                                                        = 0;
                                                                                                                                                    $ptc_query
                                                                                                                                                        = tep_db_query("select cd.categories_id as categories_id, c.categories_id as the_id, cd.categories_name as categories_name from (".TABLE_CATEGORIES_DESCRIPTION." cd) left join ".TABLE_CATEGORIES." c on  c.categories_id = cd.categories_id where isnull(c.categories_id) order by  cd.categories_id");

//  Count the number of rows that are returned. (if any)
                                                                                                                                                    $num
                                                                                                                                                        = tep_db_num_rows($ptc_query);
                                                                                                                                                    ?>
                                                                                                                                                                        ...
                                                                                                                                                                        <tr>
                                                                                                                                                                            <td width="100%"><table border="1" width="100%" cellspacing="0" cellpadding="0">
                                                                                                                                                                                    <tr class="dataTableHeadingRow">
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <?php
                                                                                                                                                                                                        $query
                                                                                                                                                                                                            = tep_db_query("select c.categories_id, c.parent_id, categories_image from ".TABLE_CATEGORIES." c where c.categories_image = '' or isnull(c.categories_image)");

//  Count the number of rows that are returned. (if any)
                                                                                                                                                                                                        $num
                                                                                                                                                                                                            = tep_db_num_rows($query);
                                                                                                                                                                                                        ?>
...
function non_existant_cat_on_ptc()
{ //  12
    ?>
...
function non_existant_prod_on_ptc()
{ //13
    ?>
...
{ // 14
    ?>
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            <tr class="dataTableHeadingRow">
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        <?php
                                                                                                                                                                                                                                                        $query
                                                                                                                                                                                                                                                            = tep_db_query("select cd.categories_id, cd.categories_name as categories_name, length(cd.categories_name) as name_length from ".TABLE_CATEGORIES_DESCRIPTION." cd where length(cd.categories_name) > 31 order by categories_name");
...
//			tep_db_query("delete from " . TABLE_CATEGORIES . " where categories_id = '" . $row['categories_id'] . "'");
    ...
    ?>
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            <tr class="dataTableHeadingRow">
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        <?php
                                                                                                                                                                                                                                                                        $query
                                                                                                                                                                                                                                                                            = tep_db_query("select ptc.products_id as products_id, p.products_id as the_id from (".TABLE_PRODUCTS." p) left join ".TABLE_PRODUCTS_TO_CATEGORIES." ptc on  ptc.products_id = p.products_id where ptc.products_id is null order by  p.products_id");
...
//  Query database for related info on all manufacturers with no products.  Determined by finding manufacturers (categories_id) not in products (categories_id).
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    $query
                                                                                                                                                                                                                                                                                                        = "SELECT m.manufacturers_id, p.products_id, m.manufacturers_name FROM (".TABLE_MANUFACTURERS." m) LEFT JOIN ".TABLE_PRODUCTS." p ON m.manufacturers_id = p.manufacturers_id WHERE p.products_id IS NULL GROUP BY m.manufacturers_id ORDER BY m.manufacturers_id";
...
function finish()
{
    ...
    echo '<tr>';
    echo "<td width='100%' class='dataTableRow'>";
    echo FINISH;
    "</td>";
    echo '</table>';
    ?>
