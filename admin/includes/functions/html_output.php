                               ...
                               $connection = 'NONSSL')
{
    if ($connection == 'NONSSL') {
        ...
        if (ENABLE_SSL_CATALOG == 'true') {
            $link = HTTPS_CATALOG_SERVER.(defined('DIR_WS_HTTPS_CATALOG') ? DIR_WS_HTTPS_CATALOG
                    : DIR_WS_CATALOG);
        } else {
            $link = HTTP_CATALOG_SERVER.DIR_WS_CATALOG;
        }
...
////
// Output a form
function tep_draw_form($name, $action, $parameters = '', $method = 'post',
                       $params = '')
{
...
{
    $field = tep_draw_input_field($name, $value, 'maxlength="40"', $required,
        'password', false);
...
////
// Output a form textarea field special for ckeditor
function tep_draw_textarea_field_ckeditor($name, $wrap, $width, $height,
                                          $text = '', $parameters = '',
                                          $reinsert_value = true)
{
    global $_GET, $_POST;
