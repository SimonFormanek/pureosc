...
define('TEXT_SET_DOWNLOADS_STATUS', 'Permitir la descarga de productos virtuales en este nivel el estado del pedido');
...
define('ERROR_STATUS_USED_IN_HISTORY', 'Error: Este estado de pedido se esta usando en alg&uacute;n hist&oacute;rico de estados de pedidos.');
?>
