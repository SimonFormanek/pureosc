...
define('TEXT_CONFIRM_DELETE', 'Are you sure you want to delete this Coupon? Deleting this coupon will delete it completely from the database.',true);
// email discount vouchers to customers text
define('TEXT_TO_REDEEM', 'You can redeem this coupon during checkout. Just enter the code in the box provided, and click on the redeem button.',true);
define('TEXT_IN_CASE', ' in case you have any problems. ',true);
define('TEXT_VOUCHER_IS', 'The coupon code is ',true);
define('TEXT_REMEMBER', 'Don\'t lose the coupon code, make sure to keep the code safe so you can benefit from this special offer.',true);
...
define('ERROR_NO_COUPON_AMOUNT', 'No Coupon Created. Please complete the fields below',true);
define('COUPON_STATUS_HELP', 'Set the status of the coupon',true);
define('COUPON_NAME_HELP', 'A short name for the coupon',true);
define('COUPON_AMOUNT_HELP', 'The value of the discount for the coupon, either fixed or add a % on the end for a percentage discount.',true);
define('COUPON_CODE_HELP', 'You can enter your own code here, or leave blank for an auto generated one.',true);
...
define('COUPON_FREE_SHIP_HELP', 'The coupon gives free shipping on an order. Note. This overrides the coupon_amount figure but respects the minimum order value',true);
define('COUPON_DESC_HELP', 'A description of the coupon for the customer',true);
define('COUPON_MIN_ORDER_HELP', 'The minimum order value before the coupon is valid',true);
define('COUPON_USES_COUPON_HELP', 'The maximum number of times the coupon can be used, leave blank if you want no limit.',true);
define('COUPON_USES_USER_HELP', 'Number of times a user can use the coupon, leave blank for no limit.',true);
define('COUPON_PRODUCTS_HELP', 'A comma separated list of product_ids that this coupon can be used with. Leave blank for no restrictions.',true);
define('COUPON_CATEGORIES_HELP', 'A comma separated list of cpaths that this coupon can be used with, leave blank for no restrictions.',true);
?>