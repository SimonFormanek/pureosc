...
INSERT INTO `information` (`information_id`, `information_group_id`, `visible`, `sort_order`, `information_title`, `information_description`, `language_id`, `parent_id`) VALUES (1, 2, '1', 1, 'HEADING_TITLE', 'Store title', 1, 0);
...
INSERT INTO `information` (`information_id`, `information_group_id`, `visible`, `sort_order`, `information_title`, `information_description`, `language_id`, `parent_id`) VALUES (6, 2, '1', 6, 'META_SEO_TITLE', '', 1, 0);
INSERT INTO `information` (`information_id`, `information_group_id`, `visible`, `sort_order`, `information_title`, `information_description`, `language_id`, `parent_id`) VALUES (7, 2, '1', 7, 'META_SEO_DESCRIPTION', '', 1, 0);
INSERT INTO `information` (`information_id`, `information_group_id`, `visible`, `sort_order`, `information_title`, `information_description`, `language_id`, `parent_id`) VALUES (8, 2, '1', 8, 'META_SEO_KEYWORDS', '', 1, 0);
