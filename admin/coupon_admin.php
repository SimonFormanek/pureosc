...
if (($_GET['action'] == 'send_email_to_user') && ($_POST['customers_email_address'])
    && (!$_POST['back_x'])) {
...
switch ($_GET['action']) {
    ...
    case 'update':
        ...
        if (tep_db_num_rows($query1) && $_POST['coupon_code'] && $_GET['oldaction']
            != 'voucheredit') {
            $update_errors = 1;
    ...
    case 'update_confirm':
        if (($_POST['back_x']) || ($_POST['back_y'])) {
            ...
            $coupon_start_date = (date('Y-m-d') < $coupon_start_date) ? $coupon_start_date
                    : 'now()';
            ...
            if ($_GET['oldaction'] == 'voucheredit') {
                tep_db_perform(TABLE_COUPONS, $sql_data_array, 'update',
                    "coupon_id='".$_GET['cid']."'");
                for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                    $language_id = $languages[$i]['id'];
                ...
                for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                    ...
                    tep_db_perform(TABLE_COUPONS_DESCRIPTION,
                        $sql_data_marray[$i]);
                }
            }
        }
                                ...
                                <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                                        ...
                                        while ($cc_list      = tep_db_fetch_array($cc_query)) {
                                            ...
                                            if (((!$_GET['uid']) || (@$_GET['uid']
                                                == $cc_list['unique_id'])) && (!$cInfo)) {
                                                $cInfo = new objectInfo($cc_list);
                                            }
                                            if ((is_object($cInfo)) && ($cc_list['unique_id']
                                                == $cInfo->unique_id)) {
                                                echo '          <tr class="dataTableRowSelected" onmouseover="this.style.cursor=\'hand\'" onclick="document.location.href=\''.tep_href_link(FILENAME_COUPON_ADMIN,
                                                    tep_get_all_get_params(array(
                                                        'cid', 'action', 'uid')).'cid='.$cInfo->coupon_id.'&action=voucherreport&uid='.$cinfo->unique_id).'\'">'."\n";
                                            } else {
                                                echo '          <tr class="dataTableRow" onmouseover="this.className=\'dataTableRowOver\';this.style.cursor=\'hand\'" onmouseout="this.className=\'dataTableRow\'" onclick="document.location.href=\''.tep_href_link(FILENAME_COUPON_ADMIN,
                                                    tep_get_all_get_params(array(
                                                        'cid', 'action', 'uid')).'cid='.$cc_list['coupon_id'].'&action=voucherreport&uid='.$cc_list['unique_id']).'\'">'."\n";
                                            }
                                            ...
                                            <td class="dataTableContent" align="right"><?php if ((is_object($cInfo))
                && ($cc_list['unique_id'] == $cInfo->unique_id)) {
                echo tep_image(DIR_WS_IMAGES.'icon_arrow_right.gif');
            } else {
                echo '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                    'page='.$_GET['page'].'&cid='.$cc_list['coupon_id']).'">'.tep_image(DIR_WS_IMAGES.'icon_info.gif',
                    IMAGE_ICON_INFO).'</a>';
            } ?>&nbsp;</td>
                                </tr>
                        <?php
    ...
    case 'preview_email':
        ...
        ?>
                    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                            ...
                            <tr>
                            <tr><?php echo tep_draw_form('mail', FILENAME_COUPON_ADMIN,
            'action=send_email_to_user&cid='.$_GET['cid']); ?>
        ...
        ?>
                                                <table border="0" width="100%" cellpadding="0" cellspacing="2">
                                                    <tr>
                                                        <td align="right"><?php echo '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN).'">'.tep_draw_button(IMAGE_CANCEL,
                                            'cancel').'</a> '.tep_draw_button(IMAGE_SEND_EMAIL,
                                            'check', null, 'primary'); ?></td>
                                                    </tr>
                                                </table></td>
                                        </tr>
                                    </table></td>
    ...
    case 'email':
        ...
        ?>
                            <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                                    ...
                                    <tr><?php echo tep_draw_form('mail',
            FILENAME_COUPON_ADMIN, 'action=preview_email&cid='.$_GET['cid']); ?>
        ...
        ?>
            ...
            '10', '10'); ?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo tep_draw_pull_down_menu('customers_email_address',
            $customers, $_GET['customer']); ?></td>
                                                </tr>
                                                <tr>
                            ...
                            <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                                    ...
                                    <tr>
                                        <td>
                                                    <?php echo tep_draw_form('coupon',
                                                        FILENAME_COUPON_ADMIN,
                                                        'action=update_confirm&oldaction='.$_GET['oldaction'].'&cid='.$_GET['cid']); ?>
                                            <table border="0" width="100%" cellspacing="0" cellpadding="6">
                                                <tr>
                                                    <td align="left" class="main"><?php echo COUPON_NAME; ?></td>
                                                    <td align="left" class="main"><?php echo $_POST['coupon_status']
                                                    ? 'Active' : 'Inactive'; ?></td>
                                                </tr>
                                                    <?php
                                                    $languages = tep_get_languages();
        ...
        if ($_POST['coupon_free_ship']) {
            ?>
                    ...
                    for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                        $language_id = $languages[$i]['id'];
                        echo tep_draw_hidden_field('coupon_name['.$languages[$i]['id'].']',
                            $_POST['coupon_name'][$language_id]);
                        echo tep_draw_hidden_field('coupon_desc['.$languages[$i]['id'].']',
                            $_POST['coupon_desc'][$language_id]);
                    }
                    echo tep_draw_hidden_field('coupon_amount',
                        $_POST['coupon_amount']);
                    echo tep_draw_hidden_field('coupon_min_order',
                        $_POST['coupon_min_order']);
                    echo tep_draw_hidden_field('coupon_free_ship',
                        $_POST['coupon_free_ship']);
                    echo tep_draw_hidden_field('coupon_code', $c_code);
                    echo tep_draw_hidden_field('coupon_uses_coupon',
                        $_POST['coupon_uses_coupon']);
                    echo tep_draw_hidden_field('coupon_uses_user',
                        $_POST['coupon_uses_user']);
                    echo tep_draw_hidden_field('coupon_products',
                        $_POST['coupon_products']);
                    echo tep_draw_hidden_field('coupon_categories',
                        $_POST['coupon_categories']);
                    echo tep_draw_hidden_field('coupon_start_date',
                        $_POST['coupon_start_date']);
                    echo tep_draw_hidden_field('coupon_expire_date',
                        $_POST['coupon_expire_date']);
                    echo tep_draw_hidden_field('coupon_status',
                        $_POST['coupon_status']);
                    ?>
                                                <tr>
                                                    <td align="left"><?php echo tep_draw_button('Confirm Update',
                        'help', null, 'primary'); ?></td>
                                                    <td align="left"><?php echo tep_draw_button('Back',
                                'arrowthick-1-w', null, 'primary'); ?></td>
                                                    </td>
                                                </tr>
                                        </td></table></form>
                                </tr>
...
// sets status of coupon
                    ...
                    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                            ...
                            <tr>
                                <td>
        <?php
        echo tep_draw_form('coupon', FILENAME_COUPON_ADMIN,
            'action=update&oldaction='.$_GET['action'].'&cid='.$_GET['cid']);
        ?>
                                    <table border="0" width="100%" cellspacing="0" cellpadding="6">
                                        <tr>
                                            <td class="main"><?php echo TEXT_COUPON_STATUS; ?></td>
                                            <td class="main"><?php echo tep_draw_radio_field('coupon_status',
            '1', $active).'&nbsp;'.TEXT_COUPON_IS_ACTIVE.'&nbsp;'.tep_draw_radio_field('coupon_status',
            '0', $inactive).'&nbsp;'.TEXT_COUPON_NOT_ACTIVE; ?></td>
        ...
        for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
            ...
            ?>
                                            <tr>
                                                ...
                                                <td align="left"><?php echo tep_draw_input_field('coupon_name['.$languages[$i]['id'].']',
                $coupon_name[$language_id]).'&nbsp;'.tep_image(DIR_WS_CATALOG_LANGUAGES.$languages[$i]['directory'].'/images/'.$languages[$i]['image'],
                $languages[$i]['name']); ?></td>
                                                <td align="left" class="main" width="40%"><?php if ($i
                == 0) echo COUPON_NAME_HELP; ?></td>
                                            </tr>
            <?php
        }
        ?>
        ...
        for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
            ...
            ?>
                                            <tr>
                                                <td align="left" valign="top" class="main"><?php if ($i
                == 0) echo COUPON_DESC; ?></td>
                                                <td align="left" valign="top"><?php echo tep_draw_textarea_field('coupon_desc['.$languages[$i]['id'].']',
                'physical', '24', '3', $coupon_desc[$language_id]).'&nbsp;'.tep_image(DIR_WS_CATALOG_LANGUAGES.$languages[$i]['directory'].'/images/'.$languages[$i]['image'],
                $languages[$i]['name']); ?></td>
                                                <td align="left" valign="top" class="main"><?php if ($i
                == 0) echo COUPON_DESC_HELP; ?></td>
                                            </tr>
            <?php
        }
        ?>
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_AMOUNT; ?></td>
                                            <td align="left"><?php echo tep_draw_input_field('coupon_amount',
            $coupon_amount); ?></td>
                                            <td align="left" class="main"><?php echo COUPON_AMOUNT_HELP; ?></td>
                                        </tr>
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_MIN_ORDER; ?></td>
                                            <td align="left"><?php echo tep_draw_input_field('coupon_min_order',
            $coupon_min_order); ?></td>
                                            <td align="left" class="main"><?php echo COUPON_MIN_ORDER_HELP; ?></td>
                                        </tr>
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_FREE_SHIP; ?></td>
                                            <td align="left"><?php echo tep_draw_checkbox_field('coupon_free_ship',
            $coupon_free_ship); ?></td>
                                            <td align="left" class="main"><?php echo COUPON_FREE_SHIP_HELP; ?></td>
                                        </tr>
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_CODE; ?></td>
                                            <td align="left"><?php echo tep_draw_input_field('coupon_code',
                                    $coupon_code); ?></td>
                                            <td align="left" class="main"><?php echo COUPON_CODE_HELP; ?></td>
                                        </tr>
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_USES_COUPON; ?></td>
                                            <td align="left"><?php echo tep_draw_input_field('coupon_uses_coupon',
                                    $coupon_uses_coupon); ?></td>
                                            <td align="left" class="main"><?php echo COUPON_USES_COUPON_HELP; ?></td>
                                        </tr>
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_USES_USER; ?></td>
                                            <td align="left"><?php echo tep_draw_input_field('coupon_uses_user',
                                    $coupon_uses_user); ?></td>
                                            <td align="left" class="main"><?php echo COUPON_USES_USER_HELP; ?></td>
                                        </tr>
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_PRODUCTS; ?></td>
                                            <td align="left"><?php echo tep_draw_input_field('coupon_products',
                                    $coupon_products); ?> <a href="validproducts.php" target="_blank" onclick="window.open('validproducts.php', 'Valid_Products', 'scrollbars=yes,resizable=yes,menubar=yes,width=600,height=600'); return false">Get Product's ID's</a></td>
                                            <td align="left" class="main"><?php echo COUPON_PRODUCTS_HELP; ?></td>
                                        </tr>
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_CATEGORIES; ?></td>
                                            <td align="left"><?php echo tep_draw_input_field('coupon_categories',
                                    $coupon_categories); ?> <a href="validcategories.php" target="_blank" onclick="window.open('validcategories.php', 'Valid_Categories', 'scrollbars=yes,resizable=yes,menubar=yes,width=600,height=600'); return false">Get Category's ID's </a></td>
                                            <td align="left" class="main"><?php echo COUPON_CATEGORIES_HELP; ?></td>
                                        </tr>
                                        <tr>
                                            <td class="main"><?php echo COUPON_STARTDATE; ?></td>
                                            <td class="main"><?php echo tep_draw_input_field('coupon_start_date',
                                        $coupon_start_date,
                                        'id="coupon_start_date"'); ?></td>
                                            <td align="left" class="main"><?php echo COUPON_STARTDATE_HELP; ?></td>
                                        </tr>
                                        <tr>
                                            <td class="main"><?php echo COUPON_FINISHDATE; ?></td>
                                            <td class="main"><?php echo tep_draw_input_field('coupon_expire_date',
                                        $coupon_expire_date,
                                        'id="coupon_expire_date"'); ?></td>
                                            <td align="left" class="main"><?php echo COUPON_FINISHDATE_HELP; ?></td>
                                        </tr>
                                        <tr>
                                            <td align="left"><?php echo tep_draw_button(COUPON_BUTTON_PREVIEW,
                                        'disk', null, 'primary'); ?></td>
                                            <td align="left"><?php echo '&nbsp;&nbsp;<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                                        ''); ?>"><?php echo tep_draw_button(IMAGE_CANCEL,
                                        'cancel'); ?></a>
                                            </td>
                                        </tr>
                                </td></table>
        ...
        <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                ...
                <tr>
                    ...
                    while ($cc_list  = tep_db_fetch_array($cc_query)) {
                        ...
                        if (((!$_GET['cid']) || (@$_GET['cid'] == $cc_list['coupon_id']))
                            && (!$cInfo)) {
                            $cInfo = new objectInfo($cc_list);
                        }
                        if ((is_object($cInfo)) && ($cc_list['coupon_id'] == $cInfo->coupon_id)) {
                            ...
                            echo '          <tr class="dataTableRow" onmouseover="this.className=\'dataTableRowOver\';this.style.cursor=\'hand\'" onmouseout="this.className=\'dataTableRow\'" onclick="document.location.href=\''.tep_href_link(FILENAME_COUPON_ADMIN,
                                tep_get_all_get_params(array('cid', 'action')).'cid='.$cc_list['coupon_id']).'\'">'."\n";
                        }
                        ...
                        ?>
                                            ...
                                            <td class="dataTableContent" align="center"><?php echo date("d/m/Y",
                strtotime($coupon_start_date)); ?></td>
                                            <td class="dataTableContent" align="center"><?php echo date("d/m/Y",
                strtotime($coupon_expire_date)); ?></td>
                                            <td class="dataTableContent" align="center">
            <?php
            if ($cc_list['coupon_status'] == '1') {
                echo tep_image(DIR_WS_IMAGES.'icon_status_green.gif',
                    IMAGE_ICON_STATUS_GREEN, 10, 10).'&nbsp;&nbsp;<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                    'action=setstatus&flag=0&cid='.$cc_list['coupon_id'].'&page='.$_GET['page']).'">'.tep_image(DIR_WS_IMAGES.'icon_status_red_light.gif',
                    IMAGE_ICON_STATUS_RED_LIGHT, 10, 10).'</a>';
            } else {
                echo '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                    'action=setstatus&flag=1&cid='.$cc_list['coupon_id'].'&page='.$_GET['page']).'">'.tep_image(DIR_WS_IMAGES.'icon_status_green_light.gif',
                    IMAGE_ICON_STATUS_GREEN_LIGHT, 10, 10).'</a>&nbsp;&nbsp;'.tep_image(DIR_WS_IMAGES.'icon_status_red.gif',
                    IMAGE_ICON_STATUS_RED, 10, 10);
            }
            ?></td>
                                            <td class="dataTableContent" align="right"><?php if ((is_object($cInfo))
                && ($cc_list['coupon_id'] == $cInfo->coupon_id)) {
                echo tep_image(DIR_WS_IMAGES.'icon_arrow_right.gif');
            } else {
                echo '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                    'page='.$_GET['page'].'&cid='.$cc_list['coupon_id']).'">'.tep_image(DIR_WS_IMAGES.'icon_info.gif',
        ...
        ?>
                            <tr>
                                <td colspan="5" align="right" class="smallText"><br><br><?php echo '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
            'page='.$_GET['page'].'&cID='.$cInfo->coupon_id.'&action=new').'">'.tep_draw_button(IMAGE_INSERT,
            'plus').'</a>'; ?></td>
                            </tr>
                        </table></td>
        <?php
            ...
            default:
                ...
                if ($_GET['action'] == 'voucherdelete') {
                    ...
                    $contents[] = array('text' => TEXT_CONFIRM_DELETE.'<br><br>'.
                        '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                            'action=confirmdelete&cid='.$_GET['cid'], 'NONSSL').'">'.tep_draw_button('Confirm Delete Voucher',
                            'notice').'</a>'.
                        '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                            'cid='.$cInfo->coupon_id, 'NONSSL').'">'.tep_draw_button('Cancel',
                            'cancel').'</a>'
                    );
                } else {
                    $prod_details = NONE;
                    ...
                    $contents[]        = array('text' =>
                        '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                            'action=voucheredit&cid='.$cInfo->coupon_id,
                            'NONSSL').'">'.tep_draw_button('Edit', 'pencil').'</a>&nbsp;&nbsp;'.
                        '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                            'action=voucherdelete&cid='.$cInfo->coupon_id,
                            'NONSSL').'">'.tep_draw_button('Delete', 'trash').'</a><br><br>'.
                        '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                            'action=email&cid='.$cInfo->coupon_id, 'NONSSL').'">'.tep_draw_button('Email Coupon',
                            'mail-closed').'</a>&nbsp;&nbsp;'.
                        '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                            'action=voucherreport&cid='.$cInfo->coupon_id,
                            'NONSSL').'">'.tep_draw_button('Redemption Report',
                            'document').'</a>');
                }
                break;
        }
