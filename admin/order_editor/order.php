...
class manualOrder
{
    ...
    function query($order_id)
    {
        ...
        $this->customer = array('id' => $order['customers_id'],
            ...
            'zone_id' => oe_get_zone_id(oe_get_country_id($order['customers_country']),
        ...
        $this->delivery = array('name' => $order['delivery_name'],
            ...
            'zone_id' => oe_get_zone_id(oe_get_country_id($order['delivery_country']),
        ...
        $this->billing = array('name' => $order['billing_name'],
            ...
            'zone_id' => oe_get_zone_id(oe_get_country_id($order['billing_country']),
                $order['billing_state']),
        ...
        while ($orders_products = tep_db_fetch_array($orders_products_query)) {
            ...
            $this->products[$index] = array(
                ...
                'tax_description' => tep_get_tax_description($orders_products_tax['products_tax_class_id'],
                    $this->delivery["country_id"], $this->delivery["zone_id"]),
    ...
    function adjust_zones()
    {
        ...
        $this->customer['zone_id'] = oe_get_zone_id($customer_country_id,
            $this->customer['state']);
        ...
        $this->billing['zone_id'] = oe_get_zone_id($billing_country_id,
            $this->billing['state']);
        ...
        $this->delivery['zone_id'] = oe_get_zone_id($delivery_country_id,
            $this->delivery['state']);
    }
