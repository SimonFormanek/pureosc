...
*/
  ...
  if (HEADER_TAGS_CHECK_TAGS == 'true') {
   if (tep_not_null($missingTags = CheckForMissingTags(false, false, $missingArray)))
            ...
            for ($i=0; $i < count($languages); ++$i) {
                ...
                if (! $failedDupSort && isset($_POST[$name])) {
                    ...
                    if (tep_db_num_rows($pageTags_query)) {
                        tep_db_perform(TABLE_HEADERTAGS, $sql_data_array, 'update', "page_name LIKE '" . tep_db_input($newfiles[$pageNumb]['text']) . "' and language_id = '" . (int)$languages[$i]['id'] . "'");
                    } else {
          ...
          for ($i=0; $i < count($languages); ++$i) {
              ...
              if (isset($_POST[$name])) {
                  ...
                  if (tep_db_num_rows($defaultTags_query)) {
                     tep_db_perform(TABLE_HEADERTAGS_DEFAULT, $sql_data_array, 'update', "language_id = '" . (int)$languages[$i]['id'] . "'");
                  } else {
     ...
     <tr>
      <td><table border="0" width="100%" cellspacing="0" cellpadding="2" class="BorderedBox">
       ...
       <tr>
        ...
        <?php echo sprintf(TEXT_PAGE_TAGS, $stats['cat_desc'],$stats['missing_c'],$stats['manu_desc'],$stats['missing_m'],$stats['keywords_searched'], $stats['keywords_not_found'], $stats['missing_p']); ?>
        </td>
       </tr>
                      ...
                      <td><table border="1" width="100%">
                        ...
                        <td class="smallText" title="<?php echo $commonPopup['title']; ?>" class="popup" >
                         <div style="float:left; width:100%;">
                          <div style="float:left">
                           <input type="text" name="title_<?php echo $id; ?>" value="<?php echo ($pageTags['page_title']) ? $pageTags['page_title'] : ''; ?>" maxlength="255" size="55" id="pagetitle_<?php echo $id_toggle; ?>"                             
                       ...
                       <tr>
                        ...
                        <td class="smallText" title="<?php echo $commonPopup['desc']; ?>" class="popup" >
                         <div style="float:left; width:100%;">
                          <div style="float:left;">                        
                           <input type="text" name="desc_<?php echo $id; ?>" value="<?php echo ($pageTags['page_description']) ? $pageTags['page_description'] : ''; ?>" maxlength="255" size="55" id="pagedesc_<?php echo $id_toggle; ?>" onkeyup="javascript:return ShowCharacterCount('<?php echo 'pagedesc_' . $id_toggle; ?>')">  
                          </div> 
                       ...
                       <tr style="background: <?php echo (tep_not_null($pageTags['alt_1']) ? "#99ffff" : white) ?>;">
                        ...
                        <td class="smallText" title="<?php echo $commonPopup['logo']; ?>" class="popup" ><input type="text" name="logo_<?php echo $id; ?>" value="<?php echo ($pageTags['page_logo']) ? $pageTags['page_logo'] : ''; ?>" maxlength="255" size="60" id="logo_<?php echo $id_toggle; ?>">
                           ...
                           $sortNumb = (tep_not_null($pageTags[$sortoptTag]) && $pageTags[$sortoptTag] !== '0') ? $pageTags[$sortoptTag] : '';                              
                            ...
                            <td><table border="0" style="border: ridge 1 px; width: 100%">
                             <tr>
                              ...
                              <td align="left" width="10" align="right" title="<?php echo $optionPopup[$z + $incrCheckNumb]; ?>" class="popup"><input type="checkbox" name="option_<?php echo $z . '_' . $id; ?>" id="option_<?php echo $z . '_' . $id; ?>" <?php echo $checked; ?> onClick="UpdateSortOrder('<?php echo $z . '_'. $id; ?>');"></td>
                              <td class="smallText" align="right" title="<?php echo $optionPopup[$z + $incrSortNumb]; ?>" class="popup"><?php echo tep_draw_input_field('sortoption_'.$z . '_'. $id, $sortNumb, 'maxlength="2" size="1" ' . $disabled . ' id="' . $z . '_' . $id . '"'); ?> </td>
                             </tr>
                            </table></td> 
                           <?php } else { ?>
                     ...
                     <tr>            
                      <td><table border="1" width="100%">
                       <tr>
                        ...
                        <td class="smallText" title="<?php echo $commonPopup['def_title']; ?>" class="popup" ><input type="text" name="default_title_<?php echo $id; ?>" value="<?php echo (tep_not_null($defaultTags['default_title']) ? $defaultTags['default_title'] : ''); ?>" maxlength="255" size="36"> </td>
                       </tr> 
                       <tr>
                        <td class="smallText" style="font-weight: bold;"><?php echo HEADING_TITLE_SEO_DESCRIPTION; ?></td>
                        <td class="smallText" title="<?php echo $commonPopup['def_desc']; ?>" class="popup" ><input type="text" name="default_desc_<?php echo $id; ?>" value="<?php echo (tep_not_null($defaultTags['default_description']) ? $defaultTags['default_description'] : ''); ?>" maxlength="255" size="36"> </td>
                       </tr> 
                       <tr>
                        <td class="smallText" style="font-weight: bold;"><?php echo HEADING_TITLE_SEO_KEYWORDS; ?></td>
                        <td class="smallText" title="<?php echo $commonPopup['def_keywords']; ?>" class="popup" ><input type="text" name="default_keyword_<?php echo $id; ?>" value="<?php echo (tep_not_null($defaultTags['default_keywords']) ? $defaultTags['default_keywords'] : ''); ?>" maxlength="255" size="36"> </td>
                       </tr>
                       <tr>
                        <td class="smallText" style="font-weight: bold;"><?php echo HEADING_TITLE_SEO_LOGO; ?></td>
                        <td class="smallText" title="<?php echo $commonPopup['def_logo']; ?>" class="popup" ><input type="text" name="default_logo_text_<?php echo $id; ?>" value="<?php echo (tep_not_null($defaultTags['default_logo_text']) ? $defaultTags['default_logo_text'] : ''); ?>" maxlength="255" size="36"> </td>
                       </tr>
                       <tr>
                        ...
                        <td class="smallText" title="<?php echo $commonPopup['def_home_text']; ?>" class="popup" >
                         ...
                         if (HEADER_TAGS_ENABLE_HTML_EDITOR == 'CKEditor') { 
                             echo tep_draw_textarea_field('home_page_text_' . $id, 'soft', 37, 8, (tep_not_null($defaultTags['home_page_text']) ? $defaultTags['home_page_text'] : ''), 'id = "home_page_text_' . $id . '" class="ckeditor"');
                         } else {
                             echo tep_draw_textarea_field('home_page_text_' . $id, 'soft', 36, 8, (tep_not_null($defaultTags['home_page_text']) ? $defaultTags['home_page_text'] : ''));
                         }                       
                         ?>
                        </td>
                       </tr>                                               
