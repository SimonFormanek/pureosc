       ...
       //--></script>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="2">
                ...
                if ($action == 'new') {
                    ...
                    if ($form_action == 'update') echo tep_draw_hidden_field('banners_id',
                        ...
                        (isset($bInfo->banners_image) ? $bInfo->banners_image : '')); ?></td>
                                </tr>
                                <tr>
                                    <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif',
                            '1', '10'); ?></td>
                        ...
                        'soft', '60', '5', $bInfo->banners_html_text); ?></td>
                                </tr>
                                <tr>
                                    <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif',
                        '1', '10'); ?></td>
                            ...
                            $bInfo->date_scheduled, 'id="date_scheduled"').' <small>(YYYY-MM-DD)</small>'; ?></td>
                                </tr>
                                <tr>
                                    <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif',
                            '1', '10'); ?></td>
                            ...
                            'maxlength="7" size="7"').' '.TEXT_BANNERS_IMPRESSIONS; ?></td>
                                </tr>
                            </table>
        ...
        $('#expires_date').datepicker({
                            ...
                            <tr>
                                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                                        <tr>
                                            ...
                                            <td class="smallText" align="right" valign="top" nowrap><?php echo tep_draw_button(IMAGE_SAVE,
                            ...
                            <tr>
                                ...
                                while ($banners           = tep_db_fetch_array($banners_query)) {
                                    ...
                                    $banners_shown   = ($info['banners_shown'] != '')
                                            ? $info['banners_shown'] : '0';
                                    $banners_clicked = ($info['banners_clicked']
                                        != '') ? $info['banners_clicked'] : '0';
                                ...
                                'View Banner').'</a>&nbsp;'.$banners['banners_title']; ?></td>
            ...
            ?>
                ...
                'plus', tep_href_link(FILENAME_BANNER_MANAGER, 'action=new')); ?></td>
                                                    </tr>
                                                </table></td>
                                        </tr>
                                    </table></td>
        ...
        default:
            if (is_object($bInfo)) {
                ...
                if ((function_exists('imagecreate')) && ($dir_ok) && ($banner_extension)) {
                    ...
                    $contents[] = array('align' => 'center', 'text' => '<br />'.tep_banner_graph_infoBox($bInfo->banners_id,
                            '3'));
                }
