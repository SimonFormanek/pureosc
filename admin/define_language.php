        ...
        while (false !== ($filename = readdir($handle))) {
            if (!in_array($filename, $exclude_array)) {
                $file = array('name' => $path.$filename,
                    ...
                    'last_modified' => strftime(DATE_TIME_FORMAT,
...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
    <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
                <tr><?php echo tep_draw_form('lng', FILENAME_DEFINE_LANGUAGE,
    '', 'get'); ?>
                    <td class="pageHeading"><?php echo HEADING_TITLE; ?></td>
                    <td class="pageHeading" align="right"><?php echo tep_draw_separator('pixel_trans.gif',
    '1', HEADING_IMAGE_HEIGHT); ?></td>
                    <td class="pageHeading" align="right"><?php echo tep_draw_pull_down_menu('lngdir',
                    $languages_array, $HTTP_GET_VARS['lngdir'],
    ...
    <tr>
                ...
                if (isset($HTTP_GET_VARS['lngdir']) && isset($HTTP_GET_VARS['filename'])) {
                    ...
                    if (file_exists($file)) {
                        ...
                        if (!tep_is_writable($file)) {
                            ...
                            $messageStack->reset();
                            $messageStack->add(sprintf(ERROR_FILE_NOT_WRITEABLE,
                                    $file), 'error');
                            echo $messageStack->output();
                        }
                        ?>
                        <tr><?php echo tep_draw_form('language',
                            FILENAME_DEFINE_LANGUAGE,
                            'lngdir='.$HTTP_GET_VARS['lngdir'].'&filename='.$HTTP_GET_VARS['filename'].'&action=save'); ?>
                            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                                    <tr>
                                        <td class="main"><strong><?php echo $HTTP_GET_VARS['filename']; ?></strong></td>
                                    </tr>
                                    <tr>
                                        <td class="main"><?php echo tep_draw_textarea_field('file_contents',
                            'soft', '80', '25', $contents,
                            (($file_writeable) ? '' : 'readonly').' style="width: 100%;"'); ?></td>
                                    </tr>
                                    <tr>
                            ...
                            '1', '10'); ?></td>
                                    ...
                                    <tr>
                                        <td class="smallText" align="right"><?php if ($file_writeable
                    == true) {
        ...
        ?>
            ...
            '10'); ?></td>
                        ...
                        <tr>
                            <td><?php echo tep_draw_button(IMAGE_BACK, 'arrow-1-w',
                                tep_href_link(FILENAME_DEFINE_LANGUAGE,
                                    'lngdir='.$HTTP_GET_VARS['lngdir'])); ?></td>
                        </tr>
                                    <?php
                                }
                            } else {
                    ...
                    <tr>
                        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                                ...
                                <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
                                    <td class="dataTableContent"><a href="<?php echo tep_href_link(FILENAME_DEFINE_LANGUAGE,
        'lngdir='.$HTTP_GET_VARS['lngdir'].'&filename='.$filename); ?>"><strong><?php echo $filename; ?></strong></a></td>
    ...
    foreach (tep_opendir(DIR_FS_CATALOG_LANGUAGES.$HTTP_GET_VARS['lngdir']) as $file) {
        if (substr($file['name'], strrpos($file['name'], '.')) == $file_extension) {
            ...
            '                <td class="dataTableContent"><a href="'.tep_href_link(FILENAME_DEFINE_LANGUAGE,
                'lngdir='.$HTTP_GET_VARS['lngdir'].'&filename='.$filename).'">'.substr($filename,
                strlen($HTTP_GET_VARS['lngdir'].'/')).'</a></td>'.
