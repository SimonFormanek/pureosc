...
?>
      ...
      <tr><?php echo tep_draw_form('authors', FILENAME_AUTHORS, 'action=insert', 'post', 'enctype="multipart/form-data"') . tep_hide_session_id(); ?>

        <td><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td class="smallText"><?php echo TEXT_AUTHORS_NAME; ?></td>
            <td class="smallText"><?php echo tep_draw_input_field('authors_name', '', 'size="20"'); ?></td>
          </tr>
          <tr>
...
?>
                ...
                <tr>
                  ...
                  <?php
                    if (ARTICLE_ENABLE_HTML_EDITOR == 'No Editor')
                      echo tep_draw_textarea_field('authors_description[' . $languages[$i]['id'] . ']', 'soft', '70', '15', (($authors_description[$languages[$i]['id']]) ? stripslashes($authors_description[$languages[$i]['id']]) : tep_get_author_description($aInfo->articles_id, $languages[$i]['id'])));
                    else
                    {
                      if (ARTICLE_ENABLE_HTML_EDITOR == 'FCKEditor') {
                          echo tep_draw_fckeditor('authors_description[' . $languages[$i]['id'] . ']','700','300', '');
                      } else if (ARTICLE_ENABLE_HTML_EDITOR == 'CKEditor') {
                          echo tep_draw_textarea_field('authors_description[' . $languages[$i]['id'] . ']', 'soft', '70', '15', '', 'id = "authors_description[' . $languages[$i]['id'] . ']" class="ckeditor"');
                      } else {
                          echo tep_draw_textarea_field('authors_description[' . $languages[$i]['id'] . ']', 'soft', '70', '15', '');
                      }
                    }
                  ?>
                  </td>
          ...
          <tr>
            ...
            <td class="smallText" valign="top"><?php echo tep_draw_input_field('authors_url[' . $languages[$i]['id'] . ']', '', 'size="30"'); ?></td>
          <tr>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
...
?>
          <tr>
            <td colspan="3" class="smallText" align="center"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_image_submit('button_save.gif', IMAGE_SAVE) . ' <a href="' . tep_href_link(FILENAME_AUTHORS, 'page=' . $_GET['page'] . '&auID=' . $_GET['auID']) . '">' . tep_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>'; ?></td>
          </tr>
        </table></td>
      </form>
      </tr>
...
?>
      ...
      <tr><?php echo tep_draw_form('authors', FILENAME_AUTHORS, 'page=' . $_GET['page'] . '&auID=' . $authors['authors_id'] . '&action=save', 'post', 'enctype="multipart/form-data"'); ?>
        <td><table border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="smallText"><?php echo TEXT_AUTHORS_NAME; ?></td>
            <td class="smallText"><?php echo tep_draw_input_field('authors_name', $authors['authors_name'], 'size="20"'); ?></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
...
?>
            ...
            <td>
              <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <?php
                    if (ARTICLE_ENABLE_HTML_EDITOR == 'No Editor')
                      echo tep_draw_textarea_field('authors_description[' . $languages[$i]['id'] . ']', 'soft', '70', '15', (($authors_description[$languages[$i]['id']]) ? stripslashes($authors_description[$languages[$i]['id']]) : tep_get_author_description($authors['authors_id'], $languages[$i]['id'])));
                    else
                    {
                      if (ARTICLE_ENABLE_HTML_EDITOR == 'FCKEditor') {
                          echo tep_draw_fckeditor('authors_description[' . $languages[$i]['id'] . ']','700','300',(isset($authors_description[$languages[$i]['id']]) ? stripslashes($authors_description[$languages[$i]['id']]) : tep_get_author_description($authors['authors_id'], $languages[$i]['id'])));
                      } else if (ARTICLE_ENABLE_HTML_EDITOR == 'CKEditor') {
                          echo tep_draw_textarea_field('authors_description[' . $languages[$i]['id'] . ']', 'soft', '70', '15', (($authors_description[$languages[$i]['id']]) ? stripslashes($authors_description[$languages[$i]['id']]) : tep_get_author_description($authors['authors_id'], $languages[$i]['id'])), 'id = "authors_description[' . $languages[$i]['id'] . ']" class="ckeditor"');
                      } else {
                          echo tep_draw_textarea_field('authors_description[' . $languages[$i]['id'] . ']', 'soft', '70', '15', (($authors_description[$languages[$i]['id']]) ? stripslashes($authors_description[$languages[$i]['id']]) : tep_get_author_description($authors['authors_id'], $languages[$i]['id'])));
                      }
                    }
          ...
          <tr>
            <td class="smallText" valign="top"><?php echo TEXT_AUTHORS_URL; ?></td>
            <td class="smallText" valign="top"><?php echo tep_draw_input_field('authors_url[' . $languages[$i]['id'] . ']', tep_get_author_url($authors['authors_id'], $languages[$i]['id']), 'size="30"'); ?></td>
          <tr>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
...
?>
          <tr>
            <td colspan="3" class="smallText" align="center"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_image_submit('button_save.gif', IMAGE_SAVE) . ' <a href="' . tep_href_link(FILENAME_AUTHORS, 'page=' . $_GET['page'] . '&auID=' . $authors['authors_id']) . '">' . tep_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>'; ?></td>
          </tr>
        </table></td>
      </form>
      </tr>
      ...
      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td align="right"><?php echo tep_image(DIR_WS_CATALOG_IMAGES . 'article_manager_uploads/' . $authors['authors_image'], HEADING_TITLE, HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT); ?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
?>
          ...
          <tr>
            <td class="smallText" valign="top"><?php echo tep_get_author_description($authors['authors_id'], $languages[$i]['id']); ?></td>
          <tr>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
          ...
          <tr>
            <td class="smallText" valign="top"><?php echo sprintf(TEXT_MORE_INFORMATION, tep_get_author_url($authors['authors_id'], $languages[$i]['id'])); ?></td>
          <tr>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
...
?>
      <tr>
        <td class="smallText" colspan="2" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_AUTHORS, 'page=' . $_GET['page'] . '&auID=' . $authors['authors_id']) . '">' . tep_image_button('button_back.gif', IMAGE_BACK) . '</a>'; ?></td>
      </form>
      </tr>
          </tr>
        </table></td>
