...
$_SERVER['REQUEST_SCHEME'] = 'https'; // http | https
...
define('OSC_DIR','osc/');
define('RSYNC_LOCAL_SRC_PATH','/home/user/WWW/'); //trailing slash at the end (/); Without including OSC_DIR!
define('DIR_FS_CONFIG','/home/user/WWW/oscconfig/'); //trailing slash! '/'
