...
<div class="contentContainer">
    ...
    if ($reviews_split->number_of_rows > 0) {
        if ((PREV_NEXT_BAR_LOCATION == '1') || (PREV_NEXT_BAR_LOCATION == '3')) {
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <span class="pull-right pagenav"><ul class="pagination"><?php
        ...
        <div class="contentText">
            <div class="reviews">
                ...
                while ($reviews       = tep_db_fetch_array($reviews_query)) {
                    ...
                    echo '  <p><span class="pull-left">'.tep_image(DIR_WS_IMAGES.tep_output_string_protected($reviews['products_image']),
                        tep_output_string_protected($reviews['products_name']),
                        SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT).'</span>'.tep_output_string_protected($reviews['reviews_text']).' ... </p><div class="clearfix"></div>';
                    $reviews_name = tep_output_string_protected($reviews['customers_name']);
                    echo '  <footer>'.sprintf(REVIEWS_TEXT_RATED,
                        tep_draw_stars($reviews['reviews_rating']),
                        $reviews_name, $reviews_name).' <a href="'.tep_href_link(FILENAME_PRODUCT_REVIEWS,
                        'products_id='.(int) $reviews['products_id']).'"><span class="pull-right label label-info">'.REVIEWS_TEXT_READ_MORE.'</span></a></footer>';
                    echo '</blockquote>';
                }
                ?>
            </div>
    ...
    if (($reviews_split->number_of_rows > 0) && ((PREV_NEXT_BAR_LOCATION == '2')
