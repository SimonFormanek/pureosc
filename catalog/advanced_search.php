        ...
        <div class="contentText">
            ...
            <div class="buttonSet row">
                ...
                <div class="col-xs-6 text-right"><?php
                    echo tep_draw_button(IMAGE_BUTTON_SEARCH, 'fa fa-search',
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="checkbox">
                        <label>
                            <?php
                            echo tep_draw_checkbox_field('inc_subcat', '1',
                                true, 'id="entryIncludeSubs"');
                            ?>
                        </label>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <?php
                    echo tep_draw_pull_down_menu('manufacturers_id',
                        tep_get_manufacturers(array(array('id' => '', 'text' => TEXT_ALL_MANUFACTURERS))),
                        NULL, 'id="entryManufacturers"');
                    ?>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    echo tep_draw_input_field('pto', '',
                        'id="PriceTo" placeholder="'.ENTRY_PRICE_TO.'"');
                    ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <?php
                    echo tep_draw_input_field('dfrom', '',
                        'id="dfrom" placeholder="'.ENTRY_DATE_FROM.'"');
                    ?>
                </div>
            </div>
            <div class="form-group">
