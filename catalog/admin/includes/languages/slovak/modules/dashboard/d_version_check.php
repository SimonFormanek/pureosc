...
define('MODULE_ADMIN_DASHBOARD_VERSION_CHECK_TITLE', 'Kontrola verzie');
define('MODULE_ADMIN_DASHBOARD_VERSION_CHECK_DESCRIPTION', 'Zobraziť check verzie výsledky sa');
define('MODULE_ADMIN_DASHBOARD_VERSION_CHECK_DATE', 'Naposledy');
