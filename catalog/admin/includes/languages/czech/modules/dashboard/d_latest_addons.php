...
define('MODULE_ADMIN_DASHBOARD_LATEST_ADDONS_TITLE', 'Latest Add-Ons',true);
define('MODULE_ADMIN_DASHBOARD_LATEST_ADDONS_DESCRIPTION', 'Show the latest osCommerce Add-Ons',true);
define('MODULE_ADMIN_DASHBOARD_LATEST_ADDONS_DATE', 'Date',true);
