...
define('MODULE_ADMIN_DASHBOARD_LATEST_NEWS_TITLE', 'Latest News',true);
define('MODULE_ADMIN_DASHBOARD_LATEST_NEWS_DESCRIPTION', 'Show the latest osCommerce News',true);
define('MODULE_ADMIN_DASHBOARD_LATEST_NEWS_DATE', 'Date',true);
