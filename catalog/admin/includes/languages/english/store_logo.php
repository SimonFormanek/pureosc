...
define('HEADING_TITLE', 'Store Logo',true);

define('TEXT_LOGO_IMAGE', 'New Logo:',true);
define('TEXT_FORMAT_AND_LOCATION', 'The store logo must be in .png or .jpg or .gif format and will be saved into:',true);
