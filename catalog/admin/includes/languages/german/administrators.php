...
define('HEADING_TITLE', 'Administratoren',true);

define('TABLE_HEADING_ADMINISTRATORS', 'Administratoren',true);
define('TABLE_HEADING_HTPASSWD','Abgesichert mit htpasswd',true);
define('TABLE_HEADING_ACTION', 'Action',true);

define('TEXT_INFO_INSERT_INTRO', 'Bitte den neuen Administrator mit seinen Daten eingeben',true);
define('TEXT_INFO_EDIT_INTRO', 'Nehmen Sie bitte alle notwendigen änderungen vor',true);
define('TEXT_INFO_DELETE_INTRO', 'Sind Sie sicher dass Sie diesen Administrator löschen möchten?',true);
define('TEXT_INFO_HEADING_NEW_ADMINISTRATOR', 'Neuer Administrator',true);
define('TEXT_INFO_USERNAME', 'Benutzername:',true);
define('TEXT_INFO_NEW_PASSWORD', 'Neues Password:',true);
define('TEXT_INFO_PASSWORD', 'Password:',true);
define('TEXT_INFO_PROTECT_WITH_HTPASSWD','mit .htpasswd schützen',true);

define('ERROR_ADMINISTRATOR_EXISTS', 'Error: Administrator existiert bereits.',true);
...
define('HTPASSWD_SECURED', '<strong>Zusätzlicher Schutz durch htaccess/htpasswd</strong><p>Diese osCommerce Online Merchant Administration Tool Installation wird weiter durch htaccess / htpasswd Schutz gesichert.</p>',true); 
