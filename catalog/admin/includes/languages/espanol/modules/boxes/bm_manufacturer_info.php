...
*/
  ...
  define('MODULE_BOXES_MANUFACTURER_INFO_TITLE', 'Información del Fabricante',true);
  define('MODULE_BOXES_MANUFACTURER_INFO_DESCRIPTION', 'Mostrar información del fabricante en la página de información del producto',true);
