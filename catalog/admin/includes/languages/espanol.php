...
define('JS_FIRST_NAME',
    '* El \'Nombre\' debe tener al menos '.ENTRY_FIRST_NAME_MIN_LENGTH.' caracteres.\n',
    true);
define('JS_LAST_NAME',
    '* El \'Apellido\' debe tener al menos '.ENTRY_LAST_NAME_MIN_LENGTH.' caracteres.\n',
    true);
define('JS_DOB',
    '* La \'Fecha de Nacimiento\' debe tener el formato: xx/xx/xxxx (d&iacute;a/mes/a&ntilde;o).\n',
    true);
define('JS_EMAIL_ADDRESS',
    '* El \'Correo Electr&oacute;nico\' debe tener al menos '.ENTRY_EMAIL_ADDRESS_MIN_LENGTH.' caracteres.\n',
    true);
define('JS_ADDRESS',
    '* El \'Domicilio\' debe tener al menos '.ENTRY_STREET_ADDRESS_MIN_LENGTH.' caracteres.\n',
    true);
define('JS_POST_CODE',
    '* El \'C&oacute;digo Postal\' debe tener al menos '.ENTRY_POSTCODE_MIN_LENGTH.' caracteres.\n',
    true);
define('JS_CITY',
    '* La \'Ciudad\' debe tener al menos '.ENTRY_CITY_MIN_LENGTH.' letras.\n',
    true);
define('JS_STATE', '* Debe indicar la \'Provincia\'.\n', true);
define('JS_STATE_SELECT', '-- Seleccione Arriba --', true);
define('JS_ZONE',
    '* La \'Provincia\' se debe seleccionar de la lista para este pa&iacute;s.',
    true);
define('JS_COUNTRY', '* Debe seleccionar un \'Pa&iacute;s\'.\n', true);
define('JS_TELEPHONE',
    '* El \'Tel&eacute;fono\' debe tener al menos '.ENTRY_TELEPHONE_MIN_LENGTH.' letras.\n',
    true);
define('JS_PASSWORD',
    '* La \'Contrase&ntilde;a\' y \'Confirmaci&oacute;n\' deben ser iguales y tener al menos '.ENTRY_PASSWORD_MIN_LENGTH.' caracteres.\n',
    true);
...
define('ENTRY_FIRST_NAME_ERROR',
    '&nbsp;<span class="errorText">min '.ENTRY_FIRST_NAME_MIN_LENGTH.' caracteres</span>',
    true);
define('ENTRY_LAST_NAME', 'Apellidos:', true);
define('ENTRY_LAST_NAME_ERROR',
    '&nbsp;<span class="errorText">min '.ENTRY_LAST_NAME_MIN_LENGTH.' caracteres</span>',
    true);
define('ENTRY_DATE_OF_BIRTH', 'Fecha de Nacimiento:', true);
define('ENTRY_DATE_OF_BIRTH_ERROR',
    '&nbsp;<span class="errorText">(ej. 05/21/1970)</span>', true);
define('ENTRY_EMAIL_ADDRESS', 'Correo Electr&oacute;nico:', true);
define('ENTRY_EMAIL_ADDRESS_ERROR',
    '&nbsp;<span class="errorText">min '.ENTRY_EMAIL_ADDRESS_MIN_LENGTH.' caracteres</span>',
    true);
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR',
    '&nbsp;<span class="errorText">El correo electr&oacute;nico no es v&aacute;lido !</span>',
    true);
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS',
    '&nbsp;<span class="errorText">El correo electr&oacute;nico ya existe!</span>',
    true);
define('ENTRY_STREET_ADDRESS', 'Direcci&oacute;n:', true);
define('ENTRY_STREET_ADDRESS_ERROR',
    '&nbsp;<span class="errorText">min '.ENTRY_STREET_ADDRESS_MIN_LENGTH.' caracteres</span>',
    true);
define('ENTRY_SUBURB', '', true);
define('ENTRY_POST_CODE', 'C&oacute;digo Postal:', true);
define('ENTRY_POST_CODE_ERROR',
    '&nbsp;<span class="errorText">min '.ENTRY_POSTCODE_MIN_LENGTH.' caracteres</span>',
    true);
define('ENTRY_CITY', 'Poblaci&oacute;n:', true);
define('ENTRY_CITY_ERROR',
    '&nbsp;<span class="errorText">min '.ENTRY_CITY_MIN_LENGTH.' caracteres</span>',
    true);
...
define('ENTRY_COUNTRY_ERROR',
    'Debe seleccionar un Pa&iacute;s del Men&uacute; Pa&iacute;ses.', true);
define('ENTRY_TELEPHONE_NUMBER', 'Tel&eacute;fono:', true);
define('ENTRY_TELEPHONE_NUMBER_ERROR',
    '&nbsp;<span class="errorText">min '.ENTRY_TELEPHONE_MIN_LENGTH.' caracteres</span>',
    true);
...
define('TEXT_DISPLAY_NUMBER_OF_BANNERS',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> banners)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_COUNTRIES',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> pa&iacute;ses)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_CUSTOMERS',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> clientes)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_CURRENCIES',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> monedas)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_ENTRIES',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> entradas)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_LANGUAGES',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> idiomas)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_MANUFACTURERS',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> fabricantes)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_NEWSLETTERS',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> boletines)',
    true);
...
define('TEXT_DISPLAY_NUMBER_OF_ORDERS_STATUS',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> estados de pedido)',
    true);
...
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_EXPECTED',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> productos esperados)',
    true);
...
define('TEXT_DISPLAY_NUMBER_OF_TAX_CLASSES',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> tipos de impuesto)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_TAX_ZONES',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> zonas de impuestos)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_TAX_RATES',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> porcentajes de impuestos)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_ZONES',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> zonas)',
    true);
...
define('TEXT_FIELD_REQUIRED',
    '&nbsp;<span class="fieldRequired">* Obligatorio</span>', true);
...
define('ERROR_DESTINATION_NOT_WRITEABLE',
    'Error: Destino no tiene permisos de escritura.', true);
define('ERROR_FILE_NOT_SAVED', 'Error: Archivo subido no guardado.', true);
define('ERROR_FILETYPE_NOT_ALLOWED',
    'Error: Tipo de archivo subido no permitido.', true);
define('SUCCESS_FILE_SAVED_SUCCESSFULLY',
    'Exito: Archivo subido guardado exitosamente.', true);
