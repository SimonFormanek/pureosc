...
define('JS_SPECIALS_PRODUCTS_PRICE',
    '* Novou cenu tohoto zboží je třeba nastavit.\n', true);

define('JS_GENDER', '* \'Pohlaví\' vyberte z variant.\n', true);
define('JS_FIRST_NAME',
    '* \'Jméno\' musí mít minimálně '.ENTRY_FIRST_NAME_MIN_LENGTH.' písmen.\n',
    true);
define('JS_LAST_NAME',
    '* \'Přijmení\' musí mít minimálně '.ENTRY_LAST_NAME_MIN_LENGTH.' písmen.\n',
    true);
define('JS_DOB',
    '* \'Datum narození\' ve formátu: xx/xx/xxxx (den/měsíc/rok).\n', true);
define('JS_EMAIL_ADDRESS',
    '* \'E-Mail Adresa\' musí mít minimálně '.ENTRY_EMAIL_ADDRESS_MIN_LENGTH.' písmen.\n',
    true);
define('JS_ADDRESS',
    '* \'Ulice a číslo\' musí mít minimálně '.ENTRY_STREET_ADDRESS_MIN_LENGTH.' písmen.\n',
    true);
define('JS_POST_CODE',
    '* \'Směrovací číslo\' musí mít minimálně '.ENTRY_POSTCODE_MIN_LENGTH.' písmen.\n',
    true);
define('JS_CITY',
    '* \'Město\' musí mít minimálně '.ENTRY_CITY_MIN_LENGTH.' písmen.\n', true);
...
define('JS_TELEPHONE',
    '* \'Telefonní číslo\' musí mít minimálně '.ENTRY_TELEPHONE_MIN_LENGTH.' písmen.\n',
    true);
define('JS_PASSWORD',
    '* \'Heslo\' a \'Potvrzení\' musí mít minimálně '.ENTRY_PASSWORD_MIN_LENGTH.' písmen.\n',
    true);
...
define('ENTRY_FIRST_NAME_ERROR',
    '&nbsp;<span class="errorText">min. '.ENTRY_FIRST_NAME_MIN_LENGTH.' znaků</span>',
    true);
define('ENTRY_LAST_NAME', 'Příjmení:', true);
define('ENTRY_LAST_NAME_ERROR',
    '&nbsp;<span class="errorText">min. '.ENTRY_LAST_NAME_MIN_LENGTH.' znaků</span>',
    true);
...
define('ENTRY_EMAIL_ADDRESS_ERROR',
    '&nbsp;<span class="errorText">min. '.ENTRY_EMAIL_ADDRESS_MIN_LENGTH.' znaků</span>',
    true);
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR',
    '&nbsp;<span class="errorText">Email není správně!</span>', true);
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS',
    '&nbsp;<span class="errorText">Email již existuje!</span>', true);
define('ENTRY_STREET_ADDRESS', 'Ulice:', true);
define('ENTRY_STREET_ADDRESS_ERROR',
    '&nbsp;<span class="errorText">min. '.ENTRY_STREET_ADDRESS_MIN_LENGTH.' znaků</span>',
    true);
define('ENTRY_SUBURB', 'Číslo:', true);
define('ENTRY_POST_CODE', 'Směrovací číslo:', true);
define('ENTRY_POST_CODE_ERROR',
    '&nbsp;<span class="errorText">min. '.ENTRY_POSTCODE_MIN_LENGTH.' znaků</span>',
    true);
define('ENTRY_CITY', 'Město:', true);
define('ENTRY_CITY_ERROR',
    '&nbsp;<span class="errorText">min. '.ENTRY_CITY_MIN_LENGTH.' znaků</span>',
    true);
...
define('ENTRY_TELEPHONE_NUMBER_ERROR',
    '&nbsp;<span class="errorText">min. '.ENTRY_TELEPHONE_MIN_LENGTH.' znaků</span>',
    true);
...
define('TEXT_DISPLAY_NUMBER_OF_BANNERS',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> banerů)', true);
define('TEXT_DISPLAY_NUMBER_OF_COUNTRIES',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> zemí)', true);
define('TEXT_DISPLAY_NUMBER_OF_CUSTOMERS',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> zákazníku)', true);
define('TEXT_DISPLAY_NUMBER_OF_CURRENCIES',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> měn)', true);
define('TEXT_DISPLAY_NUMBER_OF_ENTRIES',
    'Zobrazit <strong>%d</strong> od <strong>%d</strong> (do <strong>%d</strong> záznamů)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_LANGUAGES',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> jazyků)', true);
define('TEXT_DISPLAY_NUMBER_OF_MANUFACTURERS',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> výrobců)', true);
define('TEXT_DISPLAY_NUMBER_OF_NEWSLETTERS',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> @-novinek)', true);
define('TEXT_DISPLAY_NUMBER_OF_ORDERS',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> objednávek)', true);
define('TEXT_DISPLAY_NUMBER_OF_ORDERS_STATUS',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> stavů objednávek)', true);
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> zboží)', true);
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_EXPECTED',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> products expected)', true);
define('TEXT_DISPLAY_NUMBER_OF_REVIEWS',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> product reviews)', true);
define('TEXT_DISPLAY_NUMBER_OF_SPECIALS',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> zboží v akci)', true);
define('TEXT_DISPLAY_NUMBER_OF_TAX_CLASSES',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> daňových skupin)', true);
define('TEXT_DISPLAY_NUMBER_OF_TAX_ZONES',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> daňových oblastí)', true);
define('TEXT_DISPLAY_NUMBER_OF_TAX_RATES',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> daní)', true);
define('TEXT_DISPLAY_NUMBER_OF_ZONES',
    'Zobrazit <b>%d</b> - <b>%d</b> (z <b>%d</b> zón)', true);
...
define('SUCCESS_FILE_SAVED_SUCCESSFULLY',
    'Povedlo se: soubor se správně nahrál.', true);
...
define('TEXT_DISPLAY_NUMBER_OF_GIFT_VOUCHERS',
    'Zobrazit <b>%d</b> do <b>%d</b> (z <b>%d</b> dárkových poukazů)', true);
define('TEXT_DISPLAY_NUMBER_OF_COUPONS',
    'Zobrazit <b>%d</b> do <b>%d</b> (z <b>%d</b> kuponů)', true);
...
define('TEXT_DISPLAY_NUMBER_OF_AUTHORS',
    'Zobrazit <b>%d</b> do <b>%d</b> (z <b>%d</b> autorů)', true);
/* * ** END ARTICLE MANAGER *** */
