...
define('BOX_TOOLS_SEC_DIR_PERMISSIONS',
    'Verzeichnis Sicherheit/Lesezugriffsrecht', true);
...
// javascript messages
define('JS_ERROR',
    'Während der Eingabe sind Fehler aufgetreten!\nBitte korrigieren Sie folgendes:\n\n',
    true);

define('JS_OPTIONS_VALUE_PRICE',
    '* Sie müssen diesem Wert einen Preis zuordnen\n', true);
define('JS_OPTIONS_VALUE_PRICE_PREFIX',
    '* Sie müssen ein Vorzeichen für den Preis angeben (+/-)\n', true);

define('JS_PRODUCTS_NAME', '* Der neue Artikel muss einen Namen haben\n', true);
define('JS_PRODUCTS_DESCRIPTION',
    '* Der neue Artikel muss eine Beschreibung haben\n', true);
define('JS_PRODUCTS_PRICE', '* Der neue Artikel muss einen Preis haben\n', true);
define('JS_PRODUCTS_WEIGHT',
    '* Der neue Artikel muss eine Gewichtsangabe haben\n', true);
define('JS_PRODUCTS_QUANTITY',
    '* Sie müssen dem neuen Artikel eine verfügbare Anzahl zuordnen\n', true);
define('JS_PRODUCTS_MODEL',
    '* Sie müssen dem neuen Artikel eine Artikel-Nr. zuordnen\n', true);
define('JS_PRODUCTS_IMAGE', '* Sie müssen dem Artikel ein Bild zuordnen\n', true);

define('JS_SPECIALS_PRODUCTS_PRICE',
    '* Es muss ein neuer Preis für diesen Artikel festgelegt werden\n', true);

define('JS_GENDER', '* Die \'Anrede\' muss ausgewählt werden.\n', true);
define('JS_FIRST_NAME',
    '* Der \'Vorname\' muss mindestens aus '.ENTRY_FIRST_NAME_MIN_LENGTH.' Zeichen bestehen.\n',
    true);
define('JS_LAST_NAME',
    '* Der \'Nachname\' muss mindestens aus '.ENTRY_LAST_NAME_MIN_LENGTH.' Zeichen bestehen.\n',
    true);
define('JS_DOB',
    '* Das \'Geburtsdatum\' muss folgendes Format haben: xx.xx.xxxx (Tag/Jahr/Monat).\n',
    true);
define('JS_EMAIL_ADDRESS',
    '* Die \'eMail-Adresse\' muss mindestens aus '.ENTRY_EMAIL_ADDRESS_MIN_LENGTH.' Zeichen bestehen.\n',
    true);
define('JS_ADDRESS',
    '* Die \'Strasse\' muss mindestens aus '.ENTRY_STREET_ADDRESS_MIN_LENGTH.' Zeichen bestehen.\n',
    true);
define('JS_POST_CODE',
    '* Die \'Postleitzahl\' muss mindestens aus '.ENTRY_POSTCODE_MIN_LENGTH.' Zeichen bestehen.\n',
    true);
define('JS_CITY',
    '* Die \'Stadt\' muss mindestens aus '.ENTRY_CITY_MIN_LENGTH.' Zeichen bestehen.\n',
    true);
define('JS_STATE', '* Das \'Bundesland\' muss ausgewählt werden.\n', true);
define('JS_STATE_SELECT', '-- Wählen Sie oberhalb --', true);
define('JS_ZONE',
    '* Das \'Bundesland\' muss aus der Liste für dieses Land ausgewählt werden.',
    true);
define('JS_COUNTRY', '* Das \'Land\' muss ausgewählt werden.\n', true);
define('JS_TELEPHONE',
    '* Die \'Telefonnummer\' muss aus mindestens '.ENTRY_TELEPHONE_MIN_LENGTH.' Zeichen bestehen.\n',
    true);
define('JS_PASSWORD',
    '* Das \'Passwort\' sowie die \'Passwortbestätigung\' müssen übereinstimmen und aus mindestens '.ENTRY_PASSWORD_MIN_LENGTH.' Zeichen bestehen.\n',
    true);
...
define('ENTRY_GENDER_ERROR',
    '&nbsp;<span class="errorText">notwendige Eingabe</span>', true);
define('ENTRY_FIRST_NAME', 'Vorname:', true);
define('ENTRY_FIRST_NAME_ERROR',
    '&nbsp;<span class="errorText">mindestens '.ENTRY_FIRST_NAME_MIN_LENGTH.' Buchstaben</span>',
    true);
define('ENTRY_LAST_NAME', 'Nachname:', true);
define('ENTRY_LAST_NAME_ERROR',
    '&nbsp;<span class="errorText">mindestens '.ENTRY_LAST_NAME_MIN_LENGTH.' Buchstaben</span>',
    true);
...
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR',
    '&nbsp;<span class="errorText">ungültige eMail-Adresse!</span>', true);
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS',
    '&nbsp;<span class="errorText">Diese eMail-Adresse existiert schon!</span>',
    true);
define('ENTRY_STREET_ADDRESS', 'Strasse:', true);
define('ENTRY_STREET_ADDRESS_ERROR',
    '&nbsp;<span class="errorText">mindestens '.ENTRY_STREET_ADDRESS_MIN_LENGTH.' Buchstaben</span>',
    true);
define('ENTRY_SUBURB', 'weitere Anschrift:', true);
define('ENTRY_POST_CODE', 'Postleitzahl:', true);
define('ENTRY_POST_CODE_ERROR',
    '&nbsp;<span class="errorText">mindestens '.ENTRY_POSTCODE_MIN_LENGTH.' Zahlen</span>',
    true);
define('ENTRY_CITY', 'Stadt:', true);
define('ENTRY_CITY_ERROR',
    '&nbsp;<span class="errorText">mindestens '.ENTRY_CITY_MIN_LENGTH.' Buchstaben</span>',
    true);
define('ENTRY_STATE', 'Bundesland:', true);
define('ENTRY_STATE_ERROR',
    '&nbsp;<span class="errorText">notwendige Eingabe</font></small>', true);
...
define('ENTRY_TELEPHONE_NUMBER_ERROR',
    '&nbsp;<span class="errorText">mindestens '.ENTRY_TELEPHONE_MIN_LENGTH.' Zahlen</span>',
    true);
...
define('TEXT_DISPLAY_NUMBER_OF_BANNERS',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Bannern)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_COUNTRIES',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Ländern)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_CUSTOMERS',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Kunden)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_CURRENCIES',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Währungen)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_ENTRIES',
    'Angezeigt werden %d bis %d (von insgesamt %d Einträgen)', true);
define('TEXT_DISPLAY_NUMBER_OF_LANGUAGES',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Sprachen)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_MANUFACTURERS',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Herstellern)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_NEWSLETTERS',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Rundschreiben)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_ORDERS',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Bestellungen)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_ORDERS_STATUS',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Bestellstatus)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Artikeln)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_EXPECTED',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> erwarteten Artikeln)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_REVIEWS',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Bewertungen)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_SPECIALS',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Sonderangeboten)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_TAX_CLASSES',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Steuerklassen)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_TAX_ZONES',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Steuerzonen)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_TAX_RATES',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Steuersätzen)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_ZONES',
    'Angezeigt werden <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b> Bundesländern)',
    true);
...
define('TEXT_FIELD_REQUIRED',
    '&nbsp;<span class="fieldRequired">* erforderlich</span>', true);
...
define('ERROR_DESTINATION_DOES_NOT_EXIST',
    'Error: Destination existiert nicht.', true);
define('ERROR_DESTINATION_NOT_WRITEABLE',
    'Error: Destination nicht beschreibbar.', true);
...
define('SUCCESS_FILE_SAVED_SUCCESSFULLY',
    'Success: File upload erfolgreich gespeichert.', true);
