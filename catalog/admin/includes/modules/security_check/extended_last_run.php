...
class securityCheck_extended_last_run
{
    ...
    {
        $this->securityCheck_extended_last_run();
    }
    ...
    function pass()
    {
        ...
        if ($_SERVER['PHP_SELF'] == 'security_checks.php') {
        ...
        return defined('MODULE_SECURITY_CHECK_EXTENDED_LAST_RUN_DATETIME') && (MODULE_SECURITY_CHECK_EXTENDED_LAST_RUN_DATETIME
            > strtotime('-30 days'));
    }
