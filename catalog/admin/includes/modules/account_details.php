                ...
                <tr>
                    <td class="main"><table border="0" cellspacing="0" cellpadding="2">
                            ...
                            if (ACCOUNT_GENDER == 'true') {
                                $male   = ($account['customers_gender'] == 'm') ? true
                                        : false;
                                $female = ($account['customers_gender'] == 'f') ? true
                                        : false;
                                ?>
                                <tr>
                                    ...
                                    <td class="main">&nbsp;
                                        <?php
                                        if ($is_read_only) {
                                            echo ($account['customers_gender'] == 'm')
                                                    ? MALE : FEMALE;
                                        } elseif ($error) {
                                            if ($entry_gender_error) {
                                                echo tep_draw_radio_field('gender',
                                                    'm', $male).'&nbsp;&nbsp;'.MALE.'&nbsp;&nbsp;'.tep_draw_radio_field('gender',
                                                    'f', $female).'&nbsp;&nbsp;'.FEMALE.'&nbsp;'.ENTRY_GENDER_ERROR;
                                            } else {
                                            ...
                                            echo tep_draw_radio_field('gender',
                                                'm', $male).'&nbsp;&nbsp;'.MALE.'&nbsp;&nbsp;'.tep_draw_radio_field('gender',
                                                'f', $female).'&nbsp;&nbsp;'.FEMALE.'&nbsp;'.TEXT_FIELD_REQUIRED;
                                        }
                                        ?></td>
                                </tr>
                                        <?php
                                ...
                                <td class="main">&nbsp;
                                    ...
                                    if ($is_read_only) {
                                        ...
                                        echo tep_draw_input_field('firstname',
                                            $account['customers_firstname']).'&nbsp;'.TEXT_FIELD_REQUIRED;
                                    }
                                    ?></td>
                            </tr>
                            <tr>
                                ...
                                <td class="main">&nbsp;
                                    ...
                                    if ($is_read_only) {
                                        ...
                                        echo tep_draw_input_field('lastname',
                                            $account['customers_lastname']).'&nbsp;'.TEXT_FIELD_REQUIRED;
                                    }
                                    ?></td>
                            </tr>
                                    <?php
                                    ...
                                    <td class="main">&nbsp;
                                        ...
                                        if ($is_read_only) {
                                            ...
                                            echo tep_draw_input_field('dob',
                                                tep_date_short($account['customers_dob'])).'&nbsp;'.TEXT_FIELD_REQUIRED;
                                        }
                                        ?></td>
                                </tr>
                                        <?php
                                ...
                                <td class="main">&nbsp;
                                    ...
                                    if ($is_read_only) {
                                        ...
                                        echo tep_draw_input_field('email_address',
                                            $account['customers_email_address']).'&nbsp;'.TEXT_FIELD_REQUIRED;
                                    }
                                    ?></td>
                            </tr>
                        </table></td>
                    ...
                    <td class="main"><table border="0" cellspacing="0" cellpadding="2">
                            ...
                            if ($is_read_only) {
                                ...
                                echo tep_draw_input_field('street_address',
                                    $account['entry_street_address']).'&nbsp;'.TEXT_FIELD_REQUIRED;
                            }
                            ?></td>
                            </tr>
                                    <?php
                                ...
                                <td class="main">&nbsp;
                                    ...
                                    if ($is_read_only) {
                                        ...
                                        echo tep_draw_input_field('postcode',
                                            $account['entry_postcode']).'&nbsp;'.TEXT_FIELD_REQUIRED;
                                    }
                                    ?></td>
                            </tr>
                            <tr>
...
?></td>
                                ...
                                <tr>
                                    ...
                                    <td class="main">&nbsp;
                                        <?php
                                        $state = sbs_get_zone_name($country,
                                            $zone_id);
                                        if ($is_read_only) {
                                            echo sbs_get_zone_name($account['entry_country_id'],
                                                $account['entry_zone_id']);
                                        } elseif ($error) {
                                            if ($entry_state_error) {
                                                if ($entry_state_has_zones) {
                                                    ...
                                                    echo tep_draw_pull_down_menu('state',
                                            ...
                                            echo tep_draw_input_field('state',
                                                sbs_get_zone_name($account['entry_country_id'],
                                                    $account['entry_zone_id'],
                                                    $account['entry_state'])).'&nbsp;';
                                        }
                                        ?></td>
...
if ($is_read_only) {
    ...
    echo tep_draw_pull_down_menu('newsletter', $newsletter_array,
        $account['customers_newsletter']).'&nbsp;';
}
?></td>
                            </tr>
                        </table></td>
