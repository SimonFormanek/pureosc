   ...
   global $messageStack;
    ...
    if (tep_db_num_rows($db_query) && ! isset($_GET['reset'])) {
        ...
        $db_sql_array[] = array('CREATE TABLE database_optimizer (
                           ...
                           orphan_orders_last_update DATE NOT NULL,  
        ...
        VALUES
          ...
          ('Truncate Customers Old',         'DATABASE_OPTIMIZER_CUSTOMERS_OLD',          '120',  'Should older entries in the customers and address book tables be removed? Enter the number of days between removals or leave blank for no removal. (<b>Value entered must be in days</b>)', '" . $configuration_group_id . "', '30', NULL, NOW(), NULL),
          ...
          ('Truncate Orphan Orders',         'DATABASE_OPTIMIZER_ORPHAN_ORDERS',          '',     'Should orders that do not have an existing customer be deleted? (<b>Value entered must be in days</b>)', '" . $configuration_group_id . "', '42', NULL, NOW(), NULL),
