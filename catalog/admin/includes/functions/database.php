...
function tep_db_connect($server = DB_SERVER, $username = DB_SERVER_USERNAME,
                        $password = DB_SERVER_PASSWORD, $database = DB_DATABASE,
                        $link = 'db_link')
{
    global $$link;
...
function tep_db_query($query, $link = 'db_link')
{
    ...
    $result = mysqli_query($$link, $query) or tep_db_error($query,
