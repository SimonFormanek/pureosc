...
//pure:new used for customers url (orders) generated by admin 
//original osc function
...
//pure:new used for admin includes
function tep_catalog_admin_href_link($page = '', $parameters = '',
                               $connection = 'NONSSL')
{
    if ($connection == 'NONSSL') {
...
//fix kcfinder uploaded images, create webp container
function editor_img_fix($txt){
$txt = str_replace('admin/ext/kcfinder/', 'images/', $txt);
return $txt;
}
