...
//            'stat' => $country,
                    ...
                    if ($adresar->lastResponseCode == 201) {
                        $adminLog->logFlexiBeeChange($adresar, $originalData,
                            ['nazev', 'email', 'ic', 'dic']);
                    }
                }
                                    ...
                                    <td class="main">
                                        ...
                                        if ($error === true) {
                                            if ($entry_gender_error === true) {
                                                echo tep_draw_radio_field('customers_gender',
                                                    'm', false,
                                                    $cInfo->customers_gender).'&nbsp;&nbsp;'.MALE.'&nbsp;&nbsp;'.tep_draw_radio_field('customers_gender',
                                                    'f', false,
                                                    $cInfo->customers_gender).'&nbsp;&nbsp;'.FEMALE.'&nbsp;'.ENTRY_GENDER_ERROR;
                                            } else {
                                                echo ($cInfo->customers_gender == 'm')
                                                        ? MALE : FEMALE;
                            ...
                            <td class="main">
                                ...
                                if ($error === true) {
                                    ...
                                    echo tep_draw_input_field('entry_suburb',
                                        $cInfo->entry_suburb, 'maxlength="32"');
                                }
                                ?></td>
                        </tr>
                        <?php
                            ...
                            if ($error === true) {
                                if ($entry_post_code_error === true) {
                                    echo tep_draw_input_field('entry_postcode',
                                        $cInfo->entry_postcode, 'maxlength="8"').'&nbsp;'.ENTRY_POST_CODE_ERROR;
                                } else {
                                    echo $cInfo->entry_postcode.tep_draw_hidden_field('entry_postcode');
                                }
                            } else {
                                echo tep_draw_input_field('entry_postcode',
                                    $cInfo->entry_postcode, 'maxlength="8"',
                                    true);
                            }
                            ?></td>
                    </tr>
                            ...
                            if ($error === true) {
                                if ($entry_city_error === true) {
                                    echo tep_draw_input_field('entry_city',
                                        $cInfo->entry_city, 'maxlength="32"').'&nbsp;'.ENTRY_CITY_ERROR;
                                } else {
                                    echo $cInfo->entry_city.tep_draw_hidden_field('entry_city');
                                }
                            } else {
                                echo tep_draw_input_field('entry_city',
                                    $cInfo->entry_city, 'maxlength="32"', true);
                            }
                            ?></td>
                    </tr>
                    <?php
                            ...
                            if ($error === true) {
                                if ($entry_telephone_error === true) {
                                    echo tep_draw_input_field('customers_telephone',
                                        ...
                                        'maxlength="32"').'&nbsp;'.ENTRY_TELEPHONE_NUMBER_ERROR;
                                } else {
                        ...
                        <td class="main">
                            ...
                            if ($processed === true) {
                                ...
                                echo tep_draw_input_field('customers_fax',
                                    $cInfo->customers_fax, 'maxlength="32"');
                            }
                            ?></td>
                    </tr>
                </table>
                    ...
                    <tr>
                        ...
                        <td class="main">
                            ...
                            if ($processed === true) {
                                ...
                                echo tep_draw_pull_down_menu('customers_newsletter',
                                    $newsletter_array,
                                    (($cInfo->customers_newsletter == '1') ? '1'
                                            : '0'));
                            }
                            ?></td>
                    </tr>
    ...
    <tr>
                        ...
                        <table border="0" width="100%" cellspacing="0" cellpadding="2">
                            ...
                            while ($customers           = tep_db_fetch_array($customers_query)) {
                                ...
                                if ((!isset($_GET['cID']) || (isset($_GET['cID'])
                                    ...
                                    $customer_info = array_merge($country,
                                        $info, $reviews);

                                    $cInfo_array = array_merge($customers,
                                        $customer_info);
                            ...
                            if (isset($_GET['search']) && tep_not_null($_GET['search'])) {
                                ...
                                <tr>
                                    <td class="smallText" align="right"
                                        colspan="2"><?php
                                            echo tep_draw_button(IMAGE_RESET,
                                                'arrowrefresh-1-w',
                                                tep_href_link(FILENAME_CUSTOMERS));
                                            ?></td>
                                </tr>
        ...
        switch ($action) {
            case 'confirm':
                ...
                $contents   = array('form' => tep_draw_form('customers',
                        FILENAME_CUSTOMERS,
                ...
                if (isset($cInfo->number_of_reviews) && ($cInfo->number_of_reviews)
                    > 0)
                        $contents[] = array('text' => '<br />'.tep_draw_checkbox_field('delete_reviews',
