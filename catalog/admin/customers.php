    ...
    if ($action == 'edit' || $action == 'update') {
        ...
        <tr>
            <td align="right" class="smallText"><?php
                echo tep_draw_button(IMAGE_SAVE, 'disk', null, 'primary') . tep_draw_button(IMAGE_CANCEL, 'close', tep_href_link(FILENAME_CUSTOMERS, tep_get_all_get_params(array('action'))));
                ?></td>
        </tr> </form>
        <?php
    } else {
                            ...
                            <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                ...
                                while ($customers = tep_db_fetch_array($customers_query)) {
                                    ...
                                    <td class="dataTableContent"
                                        align="right"><?php echo tep_date_short($info['date_account_created']); ?></td>
                                            ...
                                            if (isset($_GET['search']) && tep_not_null($_GET['search'])) {
                                                ...
                                                <tr>
                                                    <td class="smallText" align="right"
                                                        colspan="2"><?php echo tep_draw_button(IMAGE_RESET,
