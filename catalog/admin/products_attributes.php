...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr>
                                    ...
                                    <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                                            ...
                                            if (tep_db_num_rows($products)) {
                                                ...
                                                while ($products_values = tep_db_fetch_array($products)) {
                                                    ...
                                                    ?>
                                                    <tr class="<?php
                                                    echo (floor($rows / 2) == ($rows
                                                    / 2) ? 'attributes-even' : 'attributes-odd');
                                                    ?>">
                                                ...
                                                <tr>
                                                    <td align="right" colspan="3" class="smallText"><br /><?php
        ...
        ?>
                                                ...
                                                <tr>
                                                    <td class="smallText" align="right" colspan="3"><br /><?php
    ...
    ?>
                                ...
                                echo tep_draw_button(IMAGE_SAVE, 'disk', null,
                                    'primary').tep_draw_button(IMAGE_CANCEL,
                                    'close',
                                    tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES,
                                        $page_info));
                                            ...
                                            <td align="center" class="smallText">&nbsp;<?php
                                        echo tep_draw_button(IMAGE_EDIT,
                                            'document',
                                            tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES,
...
?>
    ...
    echo $values_split->display_links($values_query_numrows,
        MAX_ROW_LISTS_OPTIONS, MAX_DISPLAY_PAGE_LINKS, $value_page,
                                    ...
                                    <tr class="<?php echo (floor($rows / 2) == ($rows / 2)
                                            ...
                                            ?>">
                                                ...
                                                if (($action == 'update_option_value')
                                                    && ($_GET['value_id'] == $values_values['products_options_values_id'])) {
                                            ...
                                            while ($options_values = tep_db_fetch_array($options)) {
                                                ...
                                                if ($values_values['products_options_id']
                                                    == $options_values['products_options_id']) {
                                                    echo ' selected';
                                                }
            ...
            ?>
                                            ...
                                            <td align="center" class="smallText">&nbsp;<?php
                                                echo tep_draw_button(IMAGE_EDIT,
                                                    ...
                                                    'trash',
                                                    tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES,
                                                        'action=delete_option_value&value_id='.$values_values['products_options_values_id'].'&'.$page_info));
                                                ?>&nbsp;</td>
                                                    <?php
                                                }
...
echo $attributes_split->display_links($attributes_query_numrows,
    MAX_ROW_LISTS_OPTIONS, MAX_DISPLAY_PAGE_LINKS, $attribute_page,
    'option_page='.$option_page.'&value_page='.$value_page, 'attribute_page');
?>
                    </td>
                </tr>
            </table>
            <form name="attributes" action="<?php echo tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES,
                        'action='.$form_action.'&'.$page_info);
?>" method="post"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                    ...
                    <tr>
                        ...
                        <tr class="<?php echo (floor($rows / 2) == ($rows / 2) ? 'attributes-even'
                                ...
                                <td class="smallText">&nbsp;<select name="products_id">
                                        ...
                                        while ($products_values = tep_db_fetch_array($products)) {
                                            if ($attributes_values['products_id']
                              ...
                              where products_attributes_id='".$attributes_values['products_attributes_id']."'";
                                                    ...
                                                    if (tep_db_num_rows($download_query)
                                                        ...
                                                        $products_attributes_filename
                                                            = $download['products_attributes_filename'];
                                                        $products_attributes_maxdays
                                                            = $download['products_attributes_maxdays'];
                                                        $products_attributes_maxcount
                                                            = $download['products_attributes_maxcount'];
                                                    }
                                                    ?>
                            ...
                            $products_attributes_filename, 'size="15"');
                                                    ?>&nbsp;</td>
                        ...
                        $products_attributes_maxdays, 'size="5"');
                    ?>&nbsp;</td>
                    ...
                    echo tep_draw_button(IMAGE_DELETE, 'trash',
                        ...
                        tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, $page_info));
                            ?>&nbsp;</td>
                                        <?php
                                    } else {
                                        ?>
                            ...
                            <td align="center" class="smallText">&nbsp;<?php
                                        echo tep_draw_button(IMAGE_EDIT,
                                            ...
                                            'trash',
                                            tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES,
                                                'action=delete_product_attribute&attribute_id='.$attributes_values['products_attributes_id'].'&'.$page_info));
                                        ?>&nbsp;</td>
                                        <?php
                                    }
