...
\PureOSC\ui\WebPage::singleton()->includeJavaScript('../ext/select2/js/select2.js');
\PureOSC\ui\WebPage::singleton()->includeCss('../ext/select2/css/select2.css');
\PureOSC\ui\WebPage::singleton()->addJavaScript("$('#productSelector').select2();");
    ...
    case 'update_confirm':
        if (($_POST['back_x']) || ($_POST['back_y'])) {
            ...
            $sql_data_array = array('coupon_code' => tep_db_prepare_input($_POST['coupon_code']),
                ...
                'coupon_expire_date' => empty($_POST['coupon_expire_date']) ? (new \DateTime())->add(new \DateInterval('P2M'))->format('Y-m-d') : tep_db_prepare_input($_POST['coupon_expire_date']),
            ...
            if ($_GET['oldaction'] == 'voucheredit') {
                ...
                $query = tep_db_perform(cfg('TABLE_COUPONS'), $sql_data_array);
        ...
        <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
                ...
                case 'preview_email':
                    ...
                    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                            ...
                            <tr>
                            <tr><?php
            echo tep_draw_form('mail', FILENAME_COUPON_ADMIN,
                                    ...
                                    <tr><?php
                                        ...
                                        <td><table border="0" cellpadding="0" cellspacing="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php
                                                echo tep_draw_pull_down_menu('customers_email_address',
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php
                                                echo tep_draw_input_field('from',
                                                        EMAIL_FROM);
                                                        ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php
                            echo tep_draw_textarea_field('message',
                                    'soft', '60', '15');
                            ?></td>
                                                </tr>
                                                <tr>
    ...
    case 'update_preview':
        ?>
                            <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        echo $_POST['coupon_status'] ? 'Active' : 'Inactive';
                                                ?></td>
                                                </tr>
                                                <?php
                                                $languages = tep_get_languages();
        ...
        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    if(  is_array($_POST['coupon_products'])  ){
                                                        echo implode(',', array_values($_POST['coupon_products'])) ;
                                                    } else {
                                                ...
                                                echo tep_draw_hidden_field('coupon_products',
                                                        is_array($_POST['coupon_products']) ? implode(',', $_POST['coupon_products']) : $_POST['coupon_products']);
                                                ...
                                                <tr>
                                                    <td align="left"><?php
                    echo tep_draw_button('Confirm Update',
                            'help', null, 'primary');
                    ?></td>
                                                    <td align="left"><?php
                    echo tep_draw_button('Back',
...
// sets status of coupon
        ...
        ?>
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_AMOUNT; ?></td>
                                            <td align="left"><?php
                                                echo tep_draw_input_field('coupon_amount',
                                                        $coupon_amount);
                                                ?></td>
                                        ...
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_MIN_ORDER; ?></td>
                                            <td align="left"><?php
                                        echo tep_draw_input_field('coupon_min_order',
                                                $coupon_min_order);
                                        ?></td>
                                        ...
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_FREE_SHIP; ?></td>
                                            <td align="left"><?php
                                        echo tep_draw_checkbox_field('coupon_free_ship',
                                                $coupon_free_ship);
                                        ?></td>
                                        ...
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_CODE; ?></td>
                                            <td align="left"><?php
                                        echo tep_draw_input_field('coupon_code',
                                                $coupon_code);
                                        ?></td>
                                        ...
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_USES_COUPON; ?></td>
                                            <td align="left"><?php
                                        echo tep_draw_input_field('coupon_uses_coupon',
                                                $coupon_uses_coupon);
                                        ?></td>
                                        ...
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_USES_USER; ?></td>
                                            <td align="left"><?php
                                                echo tep_draw_input_field('coupon_uses_user',
                                                        $coupon_uses_user);
                                                ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left"><?php
                                                ...
                                                $productsForCoupon = strstr($coupon_products,',') ? explode(',', $coupon_products) : [$coupon_products];
                                                $productSelector = new ui\ProductsSelector('coupon_products[]', $productsForCoupon , ['id' => 'productSelector']);
                                                $productSelector->finalize();
                                                echo $productSelector;
                                                ?> 
                                            </td>
                                        ...
                                        <tr>
                                            <td align="left" class="main"><?php echo COUPON_CATEGORIES; ?></td>
                                            <td align="left"><?php
                                        echo tep_draw_input_field('coupon_categories',
                                                $coupon_categories);
                                        ...
                                        <tr>
                                            <td class="main"><?php echo COUPON_FINISHDATE; ?></td>
                                            <td class="main"><?php
                                                echo (new \Ease\Html\InputDateTag('coupon_expire_date', $coupon_expire_date, ['id' => 'coupon_expire_date']))->getRendered();
                                                ?></td>
                                            <td align="left" class="main"><?php echo COUPON_FINISHDATE_HELP; ?></td>
                                        </tr>
                                        <tr>
                                            <td align="left"><?php
        echo tep_draw_button(COUPON_BUTTON_PREVIEW,
                'disk', null, 'primary');
        ?></td>
                                            <td align="left"><?php
        echo '&nbsp;&nbsp;<a href="' . tep_href_link(FILENAME_COUPON_ADMIN,
