...
switch ($_GET['action']) {
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table border="0" width="100%" cellpadding="0" cellspacing="2">
                                                    <tr>
                                                        <td align="right"><?php
                            echo '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN).'">'.tep_draw_button(IMAGE_CANCEL,
    ...
    case 'update_preview':
        ...
        ?>
                                                ...
                                                echo tep_draw_hidden_field('coupon_code',
                                                    $c_code);
...
// sets status of coupon
                                ...
                                <td>
                                    ...
                                    <table border="0" width="100%" cellspacing="0" cellpadding="6">
                                        <tr>
                                            ...
                                            <td class="main"><?php
                                        echo tep_draw_radio_field('coupon_status',
                                            '1', $active).'&nbsp;'.TEXT_COUPON_IS_ACTIVE.'&nbsp;'.tep_draw_radio_field('coupon_status',
                                            '0', $inactive).'&nbsp;'.TEXT_COUPON_NOT_ACTIVE;
                                        ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left"><?php
                                            echo tep_draw_input_field('coupon_name['.$languages[$i]['id'].']',
        ...
        ?></td>
                                        ...
                                        <tr>
                                            ...
                                            $coupon_products);
                                        ?> <a href="validproducts.php" target="_blank" onclick="window.open('validproducts.php', 'Valid_Products', 'scrollbars=yes,resizable=yes,menubar=yes,width=600,height=600'); return false">Get Product's ID's</a></td>
            ...
            $coupon_categories);
        ?> <a href="validcategories.php" target="_blank" onclick="window.open('validcategories.php', 'Valid_Categories', 'scrollbars=yes,resizable=yes,menubar=yes,width=600,height=600'); return false">Get Category's ID's </a></td>
                                            <td align="left" class="main"><?php echo COUPON_CATEGORIES_HELP; ?></td>
                                        </tr>
                                        <tr>
                                            <td class="main"><?php echo COUPON_STARTDATE; ?></td>
                                            <td class="main"><?php
        echo tep_draw_input_field('coupon_start_date', $coupon_start_date,
        ...
        ?></td>
                                        ...
                                        <tr>
                                            <td class="main"><?php echo COUPON_FINISHDATE; ?></td>
                                            <td class="main"><?php
        echo tep_draw_input_field('coupon_expire_date', $coupon_expire_date,
        ...
        ?></td>
                                    ...
                                    '');
        ?>"><?php echo tep_draw_button(IMAGE_CANCEL, 'cancel');
        ?></a>
                                            </td>
                                        </tr>
                                </td></table>
        ...
        <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                                        ...
                                        <tr class="dataTableHeadingRow">
                                            ...
                                            while ($cc_list  = tep_db_fetch_array($cc_query)) {
                                                ...
                                                if (((!$_GET['cid']) || (@$_GET['cid']
                                                    == $cc_list['coupon_id'])) && (!$cInfo)) {
                                                    $cInfo = new objectInfo($cc_list);
                                                }
                                                if ((is_object($cInfo)) && ($cc_list['coupon_id']
                                                    == $cInfo->coupon_id)) {
                                                    echo '          <tr class="dataTableRowSelected" onmouseover="this.style.cursor=\'hand\'" onclick="document.location.href=\''.tep_href_link(FILENAME_COUPON_ADMIN,
                                                        tep_get_all_get_params(array(
                                                            'cid', 'action')).'cid='.$cInfo->coupon_id.'&action=edit').'\'">'."\n";
                                                } else {
                                                    echo '          <tr class="dataTableRow" onmouseover="this.className=\'dataTableRowOver\';this.style.cursor=\'hand\'" onmouseout="this.className=\'dataTableRow\'" onclick="document.location.href=\''.tep_href_link(FILENAME_COUPON_ADMIN,
                                                        tep_get_all_get_params(array(
                                                            'cid', 'action')).'cid='.$cc_list['coupon_id']).'\'">'."\n";
                                                }
                ...
                strtotime($coupon_start_date));
                        ?></td>
                                            <td class="dataTableContent" align="center"><?php echo date("d/m/Y",
                strtotime($coupon_expire_date));
                        ?></td>
                                            <td class="dataTableContent" align="center">
                        <?php
                    ...
                    ?>
                            <tr>
                                <td colspan="5" align="right" class="smallText"><br><br><?php
                    echo '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                            ...
                            if ($_GET['action'] == 'voucherdelete') {
                                ...
                                $contents[] = array('text' => TEXT_CONFIRM_DELETE.'<br><br>'.
                                    '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                                        'action=confirmdelete&cid='.$_GET['cid'],
                                        'NONSSL').'">'.tep_draw_button('Confirm Delete Voucher',
                                        'notice').'</a>'.
                                    '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                                ...
                                $contents[]        = array('text' =>
                                    '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                                        ...
                                        'NONSSL').'">'.tep_draw_button('Edit',
                                        'pencil').'</a>&nbsp;&nbsp;'.
                                    '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                                        'action=voucherdelete&cid='.$cInfo->coupon_id,
                                        'NONSSL').'">'.tep_draw_button('Delete',
                                        'trash').'</a><br><br>'.
                                    '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
                                        'action=email&cid='.$cInfo->coupon_id,
                                        'NONSSL').'">'.tep_draw_button('Email Coupon',
                                        'mail-closed').'</a>&nbsp;&nbsp;'.
                                    '<a href="'.tep_href_link(FILENAME_COUPON_ADMIN,
