...
?></td>
                ...
                if ($action == 'edit') {
                    ...
                    ?>
                    <tr><?php
                        echo tep_draw_form('review', FILENAME_ARTICLE_REVIEWS,
                    ...
                    <tr>
                        <td class="main"><b><?php echo ENTRY_RATING; ?></b>&nbsp;<?php echo TEXT_BAD; ?>&nbsp;<?php
                        for ($i = 1; $i <= 5; $i++)
                    ...
                    <tr>
                        <td align="right" class="main"><?php
                            echo tep_draw_hidden_field('reviews_id',
                    ...
                    if (tep_not_null($_POST)) {
                        ...
                        $rInfo_array = array_merge($reviews, $articles,
                            $articles_name);
                        $rInfo       = new objectInfo($rInfo_array);
                    }
                    ?>
                    <tr><?php
                    echo tep_draw_form('update', FILENAME_ARTICLE_REVIEWS,
                                    ...
                                    <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                                            ...
                                            while ($reviews           = tep_db_fetch_array($reviews_query)) {
                                                ...
                                                echo $reviews['approved'] == 1 ? tep_image(DIR_WS_IMAGES.'icon_status_green.gif',
                                                        ...
                                                        10, 10) : tep_image(DIR_WS_IMAGES.'icon_status_red.gif',
                                ...
                                if (isset($rInfo) && is_object($rInfo)) {
                                    ...
                                    if ($rInfo->approved == 0) {
                                        ...
                                        $contents[] = array('align' => 'center',
                                            'text' => '<a href="'.tep_href_link(FILENAME_ARTICLE_REVIEWS,
                                                tep_get_all_get_params(array('action',
                                                    'info')).'action=approve_review&rID='.$rInfo->reviews_id,
                                        ...
                                        $contents[] = array('align' => 'center',
                                            'text' => '<a href="'.tep_href_link(FILENAME_ARTICLE_REVIEWS,
                                                tep_get_all_get_params(array('action',
                                                    'info')).'action=disapprove_review&rID='.$rInfo->reviews_id,
