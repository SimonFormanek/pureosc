...
if (defined("tep_db_affected_rows"))
        $changedStr .= sprintf("Changed %d category titles<br />\n",
...
if (defined("tep_db_affected_rows"))
        $changedStr .= sprintf("Changed %d category descriptions<br />\n",
        tep_db_affected_rows());
...
if (defined("tep_db_affected_rows"))
        $changedStr .= sprintf("Changed %d category keywords<br />\n",
        tep_db_affected_rows());
...
if (defined("tep_db_affected_rows"))
        $changedStr .= sprintf("Changed %d manufacturer titles<br />\n",
        tep_db_affected_rows());
...
if (defined("tep_db_affected_rows"))
        $changedStr .= sprintf("Changed %d manufacturer descriptions<br />\n",
        tep_db_affected_rows());
...
if (defined("tep_db_affected_rows"))
        $changedStr .= sprintf("Changed %d manufacturer keywords<br />\n",
        tep_db_affected_rows());
...
if (defined("tep_db_affected_rows"))
        $changedStr .= sprintf("Changed %d product keywords<br />\n",
        tep_db_affected_rows());
...
tep_mail(STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS,
    'Header Tags SEO Cron Update Report', $str, STORE_OWNER,
