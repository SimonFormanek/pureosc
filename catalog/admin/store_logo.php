...
if (!tep_is_writable(DIR_FS_CATALOG_IMAGES)) {
    $messageStack->add(sprintf(ERROR_IMAGES_DIRECTORY_NOT_WRITEABLE,
                    tep_href_link(FILENAME_SEC_DIR_PERMISSIONS)), 'error');
}
...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
    ...
    <tr>
        <td><?php
            echo tep_draw_form('logo', FILENAME_STORE_LOGO,
                    'action=save', 'post',
