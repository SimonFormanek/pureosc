    ...
    <div class="dialog" id="dialog-massColumnsEdit" title="<?php echo AAS_DIALOG_TITLE_MASS_COLUMNS_EDIT; ?>">
        <div class="message">
            ...
            <select id="massColumnsEditOptions-select-sta">
                <option value="2" <?php echo $show_products_by_status == 2 ? 'selected="selected"'
            : ''; ?>><?php echo AAS_DIALOG_TEXT_MASS_EDIT_ALL_STATUS; ?></option>
                <option value="1" <?php echo $show_products_by_status == 1 ? 'selected="selected"'
            : ''; ?>><?php echo AAS_DIALOG_TEXT_MASS_EDIT_ACTIVE_STATUS; ?></option>
                <option value="0" <?php echo $show_products_by_status == 0 ? 'selected="selected"'
            : ''; ?>><?php echo AAS_DIALOG_TEXT_MASS_EDIT_INACTIVE_STATUS; ?></option>
            </select>
            ...
            <table class="tbl-attributes tablesorter">
                ...
                case'manufacturers_name':
                    ?>
                                    ...
                                    <?php foreach ($manufacturers_array as $man)
                ...
                case'tax_class_title':
                    ?>
                                    ...
                                    <?php foreach ($tax_class_array as $tca)
                                        echo '<option value="'.$tca['id'].'_'.$tca['tax_rate'].'" >'.$tca['title'].' '.$tca['tax_rate'].'%</option>'; ?>
                                            </select>
                                        </td>
                                        <td>
                                            ---
    ...
    <div id="radio-show-alerts" style="text-align:right;">
        <label><?php echo AAS_SETTINGS_DISPLAY_SUCCESS_MESSAGES; ?>
            <select onchange="settings(this.value, 'show_success_alert_messages')">
                <option <?php echo $show_success_alert_messages ? 'selected="selected"'
        : ''; ?> value="1"><?php echo AAS_DIALOG_BUTTON_YES; ?></option>
                <option <?php echo!$show_success_alert_messages ? 'selected="selected"'
        : ''; ?> value="0"><?php echo AAS_DIALOG_BUTTON_NO; ?></option>
            </select>
        </label>
        ...
        <label><?php echo AAS_SETTINGS_DISPLAY_ERROR_MESSAGES; ?>
            <select onchange="settings(this.value, 'show_error_alert_messages')">
                <option <?php echo $show_error_alert_messages ? 'selected="selected"'
        : ''; ?> value="1"><?php echo AAS_DIALOG_BUTTON_YES; ?></option>
                <option <?php echo!$show_error_alert_messages ? 'selected="selected"'
        : ''; ?> value="0"><?php echo AAS_DIALOG_BUTTON_NO; ?></option>
            </select>
        ...
        <label><?php echo AAS_SETTINGS_ENABLE_COLUMN_SORTING; ?>
            <select onchange="settings(this.value, 'enable_column_sorting')">
                <option <?php echo $enableColumnSorting ? 'selected="selected"'
        : ''; ?> value="1"><?php echo AAS_DIALOG_BUTTON_YES; ?></option>
                <option <?php echo!$enableColumnSorting ? 'selected="selected"'
        : ''; ?> value="0"><?php echo AAS_DIALOG_BUTTON_NO; ?></option>
            </select>
...
<div class="dialog" id="dialog-upload_module" title="<?php echo AAS_DIALOG_TITLE_UPLOAD_MODULE; ?>">
    ...
    <?php if ($_SESSION['admin']['id'] == '1') { ?><th><?php echo AAS_DIALOG_UPLOAD_MODULE_TEXT_AAC; ?></th><?php } ?>
                        ...
                        <tbody>
    <?php $modules_counter = 1;
    foreach ($modules as $key => $module) { ?>
                                <tr class="<?php echo ($modules_counter & 1) && $defaults['colorEachTableRowDifferently']
                ? 'odd' : 'even'; ?>">
        ...
        foreach ($module['developers'] as $modDevs)
            $modDevsArray[] = tep_not_null($modDevs['website']) ? '<a href="'.$modDevs['website'].'">'.$modDevs['fullname'].'</a>'
                    : $modDevs['fullname'];
