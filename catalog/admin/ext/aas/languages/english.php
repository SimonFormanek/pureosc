...
define('AAS_HEADING_TITLE_BACK_TO_DEFAULT_ADMIN',
    'Back To Default Administration Panel :( ');
...
define('AAS_ERROR_EMPTY_VALUE',
    'Error: empty value is unaccepted. Old value still in use.');
define('AAS_ERROR_NONUMERIC_VALUE',
    'Error: value must be numeric. Old value still in use.');
define('AAS_ERROR_STATUS_VALUE_LENGTH_MUST_BE_ONE',
    'Error: status value length must be 1. Old value still in use.');
define('AAS_ERROR_STATUS_VALUE_MUST_BE_0_OR_1',
    'Error: status value must be 0 or 1. Old value still in use.');
...
define('AAS_AJAX_MANUFACTURER_CHANGE_SUCCESS',
    'Successfully changed Manufacturer!');
define('AAS_AJAX_DATE_AVAILABLE_CHANGE_SUCCESS',
    'Successfully changed Date Available!');
...
define('AAS_BUTTON_TOOLTIP_CHANGE_PRODUCTS_STATUS',
    'Change Status of selected Products!');
...
define('AAS_BUTTON_TOOLTIP_ADD_SELECTED_TO_SAVED_LIST',
    'Add selected products to Temp list');
...
define('AAS_ACTION_STATUS_NOT_CHANGED',
    'Something went wrong. Status not changed!');

//dialog titles
define('AAS_DIALOG_TITLE_PRODUCT_DESCRIPTION',
    'Editing/Viewing Product Description');
...
define('AAS_DIALOG_TITLE_DELETE_OPTION_VALUE',
    'Delete products options value name?');
...
define('AAS_DIALOG_TITLE_ATTRIBUTES_VISUALIZER',
...
//Export Dialog
define('AAS_DIALOG_EXPORT_MESSAGE',
    'Please select type and delimeter to export:');
define('AAS_DIALOG_EXPORT_MESSAGE_JSON_NOTE',
    'Delimeter does not used when type is Json');
...
define('AAS_DIALOG_SETTINGS_SOMETHING_WENT_WRONG',
    'Something went wrong!<br />Please contact webmaster in order to solve this.');
define('AAS_DIALOG_SETTINGS_YOU_MUST_RELOAD_THE_WEB_PAGE',
    'In order for changes to apply you need to reload the web page');
...
define('AAS_DIALOG_ATTRIBUTES_SUCCESSFULLY_SUBMITED_ATTRIBUTES_CHANGES',
    'Successfully submitted attributes changes');
define('AAS_DIALOG_ATTRIBUTES_THERE_WAS_AN_ERROR',
    'There was an error during submiting attributes changes');

define('AAS_DIALOG_DELETE_PRODUCTS_DELETING', 'Deleting, please wait!');
define('AAS_DIALOG_DELETE_PRODUCTS_SUCCESSFULLY_DELETED',
    'Selected Products Deleted successfully');
define('AAS_DIALOG_DELETE_PRODUCTS_SOMETHING_WENT_WRONG',
    'Something went wrong. Please try again!');
define('AAS_DIALOG_ATTRIBUTES_SUCCESSFULLY_DELETED_ATTRIBUTE',
    'Successfully deleted selected attribute/s');
define('AAS_DIALOG_ATTRIBUTES_SOMETHING_WENT_WRONG',
    'Something went wrong. Please try again!');
define('AAS_DIALOG_SESSION_TIMEOUT_IN_ORDER',
    'In order for changes to apply you need to reload the web page');
define('AAS_DIALOG_SESSION_TIMEOUT_SOMETHING_WENT_WRONG_CONTACT',
    'Something went wrong!<br />Please contact webmaster in order to solve this.');
define('AAS_DIALOG_TEXT_SOMETHING_WENT_WRONG_TRY_AGAIN',
    'Something went wrong. Please try again!');
define('AAS_DIALOG_TEXT_WRONG_AMOUNT', 'Wrong amount input');
define('AAS_DIALOG_TEXT_APPLY_TO_SELECTION', 'Wrong apply to selection');
define('AAS_DIALOG_TEXT_SUCCESSFULLY_ALTERED_OPTION_PRICES',
    'Successfully altered option prices');
define('AAS_DIALOG_TEXT_COULD_NOT_ALTER_OPTION_PRICES',
    'Could not alter option prices');
define('AAS_DIALOG_TEXT_OPTION_NAME_DONT_HAVE_OPTION_VALUES_ASSIGNED',
    'Selected Option Name does not have any Option Values assigned to it!');
...
define('AAS_DIALOGS_PHP_PRODUCT_DESCRIPTION_UNIQUE_ID_WRAPPER',
    'Product Description Unique Id Wrapper:&nbsp;');
define('AAS_DIALOGS_PHP_PRODUCT_DESCRIPTION_UNIQUE_ID_WRAPPER_USE_THIS_ONLY',
    'Use this only if you want to have the abillity to preview product description before applying any changes');
define('AAS_DIALOGS_PHP_PRODUCT_DESCRIPTION_UNIQUE_ID_WRAPPER_IN_ORDER',
    'In order to be able to preview the product description before applying changes,<br>you need to set up a unique id that is wrapped on the product description code<br>which can be found in the catalog\'s product_info.php page.');
define('AAS_DIALOGS_PHP_PRODUCT_DESCRIPTION_UNIQUE_ID_WRAPPER_INSTRUCTIONS',
    'Instructions');
define('AAS_DIALOGS_PHP_PRODUCT_DESCRIPTION_UNIQUE_ID_WRAPPER_OPEN_EDIT',
    'Open - edit product_info.php and change:');
...
define('AAS_DIALOGS_PHP_PRODUCT_DESCRIPTION_UNIQUE_ID_WRAPPER_WHERE_IS',
    ' is a unique id, feel free to change.');
define('AAS_DIALOGS_PHP_PRODUCT_DESCRIPTION_UNIQUE_ID_WRAPPER_SAVE',
    'Save product_info.php');
define('AAS_DIALOGS_PHP_PRODUCT_DESCRIPTION_UNIQUE_ID_WRAPPER_NOW',
    'Now every product_info.php page has a unique span id.');
define('AAS_DIALOGS_PHP_PRODUCT_DESCRIPTION_UNIQUE_ID_WRAPPER_SPAN',
    'SPAN tag does not apply any styling, so no changes will be done to your theme.');
define('AAS_DIALOGS_PHP_ERROR_UNIQUE_ID_WRAPPER_I_COULD_NOT',
    'I could not find a unique id with the name:');
define('AAS_DIALOGS_PHP_ERROR_UNIQUE_ID_WRAPPER_CLICK_HERE_TO_FIND_MORE',
    'Click Here to find out about this awesome feature!');
define('AAS_DIALOGS_PHP_SUCCESS_SUBMITED_SUCCESSFULLY',
    'Changes Submitted Successfully');
define('AAS_DIALOGS_PHP_MASS_DELETE_ARE_YOU_SURE',
    'Are you sure you want to delete selected products?');
define('AAS_DIALOGS_PHP_MASS_DELETE_WARNING',
    'Warning: after deletion product/s cannot be recovered!');
define('AAS_DIALOGS_PHP_SESSION_TIMEOUT',
    'Session Timeout!<br>Please login again!');
define('AAS_DIALOGS_TEXT_SUCCESSFULLY_SET_PRODUCTS_AVAILABLE_DATE_TO_NULL',
    'Successfully set products available date to null!');
define('AAS_DIALOGS_TEXT_COULD_NOT_SET_PRODUCTS_AVAILBALE_TO_NULL',
    'Could not set products available date to null!');

define('AAS_DIALOG_TITLE_AJAX_FAILED', 'Ajax failed!');
define('AAS_DIALOG_TEXT_AJAX_FAILED', 'Sorry but ajax failed!');
define('AAS_DIALOG_TITLE_NOT_WRITABLE_IMAGE_FOLDERS_WARNING',
    'and its subfolders are not writable.<br>Make it writable or any of its subfolders and then refresh this page.');
define('AAS_DIALOG_TEXT_NO_WRITABLE', 'no writable!');
define('AAS_DIALOG_TEXT_ABOUT_TO_CHANGE_THE_IMAGE_OF',
    'You are about to change the image of: ');
define('AAS_DIALOG_TEXT_DRAG_N_DROP_NEW_IMAGE',
    'Drag &amp; Drop new image here!');
define('AAS_DIALOG_TEXT_IMAGES_DIR', 'Images dir: ');
define('AAS_DIALOG_ALL_EDIT_MESSAGE',
    'Press the "Enable" button to make all cells editable!<br />Edit values as you wish and press the "Submit Changes" button.');
define('AAS_DIALOG_ALL_EDIT_MESSAGE_NOTE_1', 'Gross price editing is disabled.');
define('AAS_DIALOG_ALL_EDIT_MESSAGE_NOTE_2',
    'Closing this dialog causes no data change.');

define('AAS_DIALOG_TEXT_SELECT_FOLDER_TO_SAVE_NEW_IMAGE',
    'Select a folder to save new image:');
define('AAS_DIALOG_TEXT_OR', 'or');

define('AAS_DIALOG_TITLE_REMOVE_LINKED_PRODUCT', 'Unlink selected Product?');
define('AAS_DIALOG_TEXT_REMOVE_LINKED_PRODUCT_TEXT',
    'Are you sure you want to unlink the selected product from this category?');
define('AAS_DIALOG_TEXT_REMOVE_LINKED_PRODUCT_TEXT_NOTE',
    'Note: this action will not delete the product but it will just remove it from this category.');
define('AAS_DIALOG_TEXT_LINKED_PRODUCT_SUCCESSFULLY_REMOVED',
    'Successfully unlinked product from selected category.');
define('AAS_DIALOG_TEXT_LINKED_PRODUCT_NOT_REMOVED',
    'Cannot unlink product from the selected category. Please try again!');

define('AAS_DIALOG_TITLE_REMOVE_LINKED_PRODUCT_FROM_PARENT',
    'Unlink this Product from selected category?');
define('AAS_DIALOG_TEXT_REMOVE_LINKED_PRODUCT_FROM_PARENT_TEXT',
    'Are you sure you want to unlink the selected product from selected category?');
define('AAS_DIALOG_TEXT_REMOVE_LINKED_PRODUCT_FROM_PARENT_TEXT_NOTE',
    'Note: this action will not delete the product but it will just remove it from selected category.');

define('AAS_DIALOG_TITLE_DOWNLOADABLE_ATTRIBUTES_CONTENT_MANAGER',
    'Downloadable Attributes Content Manager');
define('AAS_DIALOG_TITLE_DOWNLOADABLE_ATTRIBUTES_CONTENT_MANAGER_MESSAGE',
    'Select a file and press the Select button:');
define('AAS_DIALOG_TITLE_DOWNLOADABLE_ATTRIBUTES_CONTENT_MANAGER_SEARCH',
    'Start typing...');
define('AAS_DIALOG_TITLE_DOWNLOADABLE_ATTRIBUTES_CONTENT_MANAGER_YOU_DID_NOT_SELECT_A_FILE',
    'You did not select a file');

define('AAS_DIALOG_ATTRIBUTES_DOWNLOADABLE_PRODUCTS', 'Downloadable products:');
define('AAS_DIALOG_ATTRIBUTES_DOWNLOADABLE_PRODUCTS_SUBHEADERS',
    'Filename | Expiry days | Maximum download count');
define('AAS_DIALOG_ATTRIBUTES_ORDERED_BY_OPTION_PRICE',
    'Ordered by Option Price');
define('AAS_DIALOG_ATTRIBUTES_ORDERED_BY_OPTION_NAME', 'Ordered by Option Name');
define('AAS_DIALOG_ATTRIBUTES_ORDERED_BY_OPTION_ID_PRICE',
    'Ordered by Option Id, Price');
...
define('AAS_DIALOG_ATTRIBUTES_NO_SELECTED_ATTRIBUTES_FOUND',
    'No selected attributes found!');

define('AAS_DIALOG_ATTRIBUTES_ICON_TITLE_RELOAD_ATTRIBUTES_LIST',
    'Reload Attributes List');
define('AAS_DIALOG_ATTRIBUTES_ICON_TITLE_ATTRIBUTES_MANAGER',
    'Attributes Manager');
define('AAS_DIALOG_ATTRIBUTES_ICON_TITLE_PRODUCTS_ATTRIBUTES_VISUALIZER',
    'Products Attributes Visualizer');

//ext/aas/ja/dialogs.js

define('AAS_DIALOG_ATTRIBUTES_NO_ATTRIBUTES_FOUND',
    'No attributes found. Please add attributes by clicking on the [ Add new Attribute ] button.');
define('AAS_DIALOG_ATTRIBUTES_FOUND_OPTION_NAME_WITHOUT_OPTION_VALUES_ASSIGNED_TO_IT',
    'Found Option Name that has not Option Values assigned to it.<br>Please use the AAS attributes manager to assign or select another Option Name that already has Option Values.');

define('AAS_DIALOG_ATTRIBUTES_FOUND_DUPLICATE_ATTRIBUTES_ON_EXISTING_ENTRIES',
    'Found duplicate attributes on existing entries.<br>Are you sure you want to proceed Submitting Changes?');
define('AAS_DIALOG_ATTRIBUTES_FOUND_DUPLICATE_ATTRIBUTES_ON_ABOUT_TO_ADD_ENTRIES',
    'Found duplicate attributes on entries you are about to add.<br>Are you sure you want to proceed adding the new attributes?');
define('AAS_DIALOG_ATTRIBUTES_FOUND_DUPLICATE_ATTRIBUTES_BETWEEN_EXISTING_AND_ABOUT_TO_ADD_ENTRIES',
    'Found duplicate attributes between existing entries and those about to add.<br>Are you sure you want to proceed?');

define('AAS_DIALOG_ATTRIBUTES_NO_ATTRIBUTES_FOUND_FOR_SMART_COPY',
    'No attributes found available to add.');

define('AAS_DIALOG_ATTRIBUTES_COULD_NOT_UPDATE_OPTION_NAMES',
    'Something went wrong. Could not update option names!');
define('AAS_DIALOG_ATTRIBUTES_COULD_NOT_INSERT_OPTION_NAMES',
    'Something went wrong. Could not insert option names!');
define('AAS_DIALOG_ATTRIBUTES_SUCCESSFULLY_INSERTED_OPTION_NAMES',
    'Successfully inserted option names.');
define('AAS_DIALOG_ATTRIBUTES_SUCCESSFULLY_CHANGED_OPTION_NAMES',
    'Successfully changed option names.');
define('AAS_DIALOG_ATTRIBUTES_SUCCESSFULLY_DELETED_OPTION_NAME',
    'Successfully deleted option name.');
define('AAS_DIALOG_ATTRIBUTES_COULD_NOT_DELETE_OPTION_NAME',
    'Something went wrong. Could not delete option name');

define('AAS_DIALOG_ATTRIBUTES_COULD_NOT_DELETE_OPTION_VALUE_NAME',
    'Something went wrong. Could not delete option value!');
define('AAS_DIALOG_ATTRIBUTES_COULD_NOT_UPDATE_OPTION_VALUES_NAMES',
    'Something went wrong. Could not update option values names!');
define('AAS_DIALOG_ATTRIBUTES_COULD_NOT_INSERT_OPTION_VALUES_NAMES',
    'Something went wrong. Could not insert option values names!');
define('AAS_DIALOG_ATTRIBUTES_SUCCESSFULLY_INSERTED_OPTION_VALUES',
    'Successfully inserted option values.');
define('AAS_DIALOG_ATTRIBUTES_SUCCESSFULLY_CHANGED_OPTION_VALUES_NAMES',
    'Successfully changed option values names.');
define('AAS_DIALOG_ATTRIBUTES_SUCCESSFULLY_DELETED_OPTION_VALUE_NAME',
    'Successfully deleted option value name.');


define('AAS_DIALOG_TEXT_COLUMNS_PANEL_INFORMATION',
    'Check the column fields you need to display and press the Apply button.<br />You can also reorder the column fields via drag n drop.');

define('AAS_DIALOG_TEXT_DELETE_SELECTED_IMAGE',
    'Are you sure you want to delete selected Large Image?');
...
define('AAS_DIALOG_TEXT_MASS_EDIT_SELECTED_PRODUCTS_FROM_TEMP_LIST',
    'selected products from temp list');
define('AAS_DIALOG_TEXT_MASS_EDIT_PRODUCTS_FROM', 'products from');
define('AAS_DIALOG_TEXT_MASS_EDIT_RECURSIVELY_OPTION_EXPLAIN',
    'Recursively option will apply changes to all the products found within a category and its subcategories.');

define('AAS_DIALOG_TEXT_APPLIES_TO_SELECTED_PRODUCTS_ONLY',
    'Applies at Selected Products Only.');
...
define('AAS_DIALOG_TEXT_FIELDS_DISABLE_ACTIONS_NOTE',
    'In order to disable a column action for a certain admin just click on the apropriate checkbox and save.');
...
define('AAS_DIALOG_ATTRIBUTES_SMART_COPY_CHOOSEN_ATTRIBUTE',
    'Choosen attribute to Smart Copy from:');
define('AAS_DIALOG_ATTRIBUTES_SMART_COPY_ALREADY_EXIST',
    'List of Attributes that already exist minus the choosen one');
define('AAS_DIALOG_ATTRIBUTES_SMART_COPY_AVAILABLE_FOR_ADDING',
    'List of Attributes available for Smart Coping:');
define('AAS_DIALOG_ATTRIBUTES_SMART_COPY_SUCCESS_ADD',
    'Successfully added attributes via Smart Copy method.');
...
define('AAS_SETTINGS_DISPLAY_ALERTS_MESSAGE',
...
define('AAS_SETTINGS_RESET_COLUMNS_ORDER_SUCCESS',
    'Successfully reset the columns order.<br>Changes will be visible after you reload the page.');

/* ext/aas/dialogs.php */

define('AAS_STATUS_ICON_SET_CATEGORY_HIDDEN',
    'Make Category and its subcategories hidden');
define('AAS_STATUS_ICON_SET_CATEGORY_VISIBLE',
    'Make Category and its subcategories visible');
...
define('AAS_TEXT_CANNOT_FETCH_PRODUCTS_DESCRIPTION',
    'Cannot fetch product\'s description for selected language');
define('AAS_TEXT_NO_PRODUCT_ID_FOUND', 'No product Id found');
define('AAS_TEXT_NO_CATEGORY_ID_FOUND', 'No category Id found');

define('AAS_BUTTON_TOOLTIP_EDIT_PREVIOUS_PRODUCT_DESCRIPTION',
    'Edit previous product\'s description');
define('AAS_BUTTON_TEXT_PREVIOUS', '&laquo; Previous');
define('AAS_BUTTON_TOOLTIP_SAVE_ALL_DESC_CHANGES',
    'Save all description changes');
define('AAS_BUTTON_TEXT_SUBMIT_CHANGES', 'Submit Changes');
define('AAS_BUTTON_TOOLTIP_PREVIEW_DESC_CHANGES',
    'Preview changes before submit');
define('AAS_BUTTON_TEXT_PREVIEW_CHANGES', 'Preview Changes');
define('AAS_BUTTON_TOOLTIP_RELOAD_ALL_PREVIEWS',
    'Reloads all visible preview screens');
define('AAS_BUTTON_TEXT_RELOAD_PREVIEW', 'Reload Preview');
define('AAS_BUTTON_TOOLTIP_CLOSE_DESC_EDITING',
    'Any changes not applied will be lost!');
define('AAS_BUTTON_TEXT_CLOSE', 'Close');
define('AAS_BUTTON_TOOLTIP_EDIT_NEXT_PORDUCTS_DESC',
    'Edit next product\'s description');
...
define('AAS_TEXT_AND_GO_TO_SELECTED_CATEGORY',
    'and go to selected category page');
...
define('AAS_TEXT_TO_SELECTED_PRODUCTS_FROM_TEMP_LIST',
    'into selected products from temp list');
define('AAS_TEXT_TO_ALL_PRODUCTS_IN', 'into all products in');
define('AAS_TEXT_FROM_SELECTED_PRODUCTS', 'from selected products');
define('AAS_TEXT_FROM_SELECTED_PRODUCTS_FROM_TEMP_LIST',
    'from selected products from temp list');
...
define('AAS_TEXT_DISALLOW_DUPLICATE_ATTRIBUTES',
    ', disallow duplicate attributes');
define('AAS_TEXT_MASS_PRODUCTS_ACTIONS_HELP',
    '<div style=font-size:14px;color:#800>on Copy, all product\'s attributes are copied as well.<br>on Move, a duplicate check is performed because you may want <br>to move a product from the temp list to a category that already exists in.</div>');
define('AAS_TEXT_ATTRIBUTES_ACTIONS_HELP',
    '<div style=font-size:14px;color:#800>Recursively means copy or delete (depending on action) all products that are in the subcategories.<br>Non Recursively copies or deletes attributes from selected category only.<br><br>Delete existing attributes means that AAS will delete found attributes and then apply the new ones from the selected product.</div>');
define('AAS_TEXT_APPLY_TO_ALL_OPTION_PRICES', 'Apply to all option prices');
define('AAS_TEXT_APPLY_TO_SELECTED_ATTRIBUTES_OPTION_PRICES',
    'Apply to selected option prices');
...
define('AAS_SPECIALS_DIALOG_TITLE_CONFIRM_SPECIAL_DELETION',
    'Confirm Special deletion?');
define('AAS_SPECIALS_DIALOG_TEXT_STATUS_SUCCESSFULLY_CHANGED',
    'Status successfully changed');
define('AAS_SPECIALS_DIALOG_TEXT_SUCCESSFULLY_SET_EXPIRE_DATE',
    'Successfully set expire date');
define('AAS_SPECIALS_DIALOG_TEXT_DELETE_SPECIAL',
    'Are you sure you want to delete Special?');
define('AAS_SPECIALS_DIALOG_TEXT_CANNOT_UPDATE_STATUS',
    'Something went wrong, cannot update special status');
define('AAS_SPECIALS_DIALOG_TEXT_COULD_NOT_SET_AVAILABLE_DATE_TO_NULL',
    'Could not set products available date to null!');
define('AAS_SPECIALS_DIALOG_TEXT_CANNOT_UPDATE_SPECIALS_PRICE',
    'Something went wrong, cannot update specials price!');
define('AAS_SPECIALS_DIALOG_TEXT_SUCCESSFULLY_UPDATED_VALUES',
    'Successfully updated special values!');
define('AAS_SPECIALS_DIALOG_TEXT_SUCCESSFULLY_DELETED',
    'Special successfully deleted!');
define('AAS_SPECIALS_DIALOG_TEXT_CANNOT_DELETE_SPECIAL',
    'Something went wrong, cannot delete special!');
define('AAS_SPECIALS_DIALOG_TEXT_EMPTY_SPECIAL_PRICE_FOUND',
    'Empty special price found!');
define('AAS_SPECIALS_DIALOG_TEXT_ADDED_NEW_SPECIAL_LOADING_SPECIALS_TABLE',
    'Successfully added new Special.<br>Please wait while loading Specials table');
define('AAS_SPECIALS_DIALOG_TEXT_ERROR_FETCHING_CELL_DATA',
    'Error fetching cell Data. please reload page!');
define('AAS_SPECIALS_DIALOG_TEXT_CANNOT_ADD_SPECIAL_TRY_AGAIN',
    'Cannot add special. Please try again!');
define('AAS_SPECIALS_DIALOG_TEXT_CANNOT_ADD_SPECIAL_NO_VALID_PRODUCT_SELECTION',
    'Cannot add special. No valid product selection!');
define('AAS_SPECIALS_DIALOG_TEXT_SOMETHING_WENT_WRONG_TRY_AGAIN',
    'Something went wrong. Please try again!');
...
define('AAS_SPECIALS_DIALOG_TEXT_SPECIAL_NOTES',
    '<strong>Specials Notes:</strong><ul><li>You can enter a percentage to deduct in the Specials Price field, for example: <strong>20%</strong></li><li>If you enter a new price, the decimal separator must be a '.' (decimal-point), example: <strong>49.99</strong></li><li>Leave the expiry date empty for no expiration</li></ul>');
...
define('AAS_PRODUCTS_EXPECTED_DIALOG_TEXT_SUCCESSFULLY_ALTERED_EXPECTED_DATE',
    'Successfully altered expected date!');
define('AAS_PRODUCTS_EXPECTED_DIALOG_TEXT_COULD_NOT_ALTER_AVAILABLE_DATE',
    'Could not alter expected date!');
...
define('AAS_TEXT_AM_WARNING_OPTION_HAS_PRODUCTS_AND_VALUES',
    'This option is assigned to products therefore it is not safe to delete it. If you delete it then this attribute option will be deleted from all products in all languages. If you delete it then this attribute option will be deleted from the products in all languages.<br> Note: any option values assigned to that option name will also be deleted!');

define('AAS_TEXT_AM_WARNING_HAS_NO_PRODUCTS_AND_VALUES',
    'This option name is not assigned to any products therefore it is safe to delete it.<br> Note: any option values assigned to that option name will also be deleted!');

define('AAS_TEXT_AM_WARNING_OPTION_VALUE_HAS_PRODUCTS_AND_VALUES',
    'This option value is assigned to an option name that is linked to products therefore it is not safe to delete it.<br>If you delete it then this attribute option value will be deleted from the products in all languages.');

define('AAS_TEXT_AM_WARNING_OPTION_VALUE_SAFE_TO_DELETE',
    'This option value is assigned to an option name that is not linked to any products therefore it is safe to delete it.');

define('AAS_TEXT_IN_TABLE_SEARCH', 'In Table Search');

define('AAS_TEXT_AM_DIALOG_TITLE_EDITING_OPTION_NAME',
    'Editing products option name');
define('AAS_TEXT_AM_DIALOG_TITLE_DELETE_OPTION_NAME',
    'Delete products option name: ');
...
define('AAS_TEXT_OU_SUBTITLE',
    'Alternative Administration System: Online Users Viewer');

//IMPORT

define('AAS_TEXT_IMPORT_TITLE', 'Products\' Changes File Importer');
define('AAS_TEXT_IMPORT_VERSION', 'version: 0.1 beta');
define('AAS_TEXT_IMPORT_WARNING',
    'Warning: Upload only files that are first created by the Alternative Administration System export method!');
define('AAS_TEXT_IMPORT_DRAG_N_DROP', 'Drag & Drop files here!');
define('AAS_TEXT_IMPORT_SUPPORTED_FILES',
    'Supported files: csv, txt, supported delimeters: , ; * and tab character');
define('AAS_TEXT_IMPORT_WARNING_MESSAGE',
    'Any product\'s changes from the Imported File will not be automatically applied.<br /> After uploading you will have the oportunity to double check the changes and then apply!');
define('AAS_TEXT_IMPORT_WARNING_MESSAGE_1',
    'Uploaded file is not saved on server. After parsing the data the uploaded file is auto deleted!');
define('AAS_TEXT_IMPORT_TOOLTIP_SUBMIT_CHANGES',
    'Submit changes from file to associated products!');
define('AAS_TEXT_IMPORT_SUBMIT_CHANGES', 'Submit Product\'s Changes');
define('AAS_TEXT_IMPORT_TOOLTIP_UPLOAD_NEW_FILE',
    'Upload new file, any changes not submitted will be lost!');
...
define('AAS_TEXT_IMPORT_BROWSER_NOT_SUPPORTED',
    'Your browser does not support HTML5 file uploads!');
define('AAS_TEXT_IMPORT_TOO_MANY_FILES',
    'Too many files! Please select only one!');
define('AAS_TEXT_IMPORT_FILE_TOO_LARGE',
    'is too large! Please upload files up to 6mb.');
define('AAS_TEXT_IMPORT_FILETYPE_NOT_ALLOWED', 'File type is not allowed.');
define('AAS_TEXT_IMPORT_FILE_EXTENSION_NOT_ALLOWED',
    'File extension not allowed.');
define('AAS_TEXT_IMPORT_ERROR_PARSING_DATA',
    'Error parsing data. File is corrupted or not recognized!<br>Please make sure you are importing a file<br>that has first been exported by AAS Export products method!');
define('AAS_TEXT_IMPORT_PLEASE_WAIT_WHILE_UPDATING',
    'Please wait while updating products values!');
define('AAS_TEXT_IMPORT_SUCCESSFULLY_UPDATED',
    'Product\'s values successfully updated.<br>In order to view the updates please reload the page.');
define('AAS_TEXT_IMPORT_RELOAD_NOW', 'Reload Now');
define('AAS_TEXT_IMPORT_SOMETHING_WENT_WRONG',
    'Something went wrong. Product\'s values did not updated. Please try again!');
define('AAS_TEXT_IMPORT_COULD_NOT_UPDATE_PRODUCTS_DATA',
    'Could not update products data!<br>Make sure the imported file is correct.');
define('AAS_TEXT_IMPORT_EMPTY_DATA', 'Empty Data!');

//GENERAL
define('AAS_TEXT_SELECTED_PRODUCTS_LINKED_SUCCESSFULLY',
    'Selected products linked with selected category successfully.');
define('AAS_TEXT_SELECTED_PRODUCTS_LINKED_FAILED',
    'Selected products failed to be linked with selected category.');
define('AAS_TEXT_SELECTED_PRODUCTS_LINKED_FAILED_NOCOLUMN_LINKED',
    'Selected products failed to be linked with selected category<br>because the column [ <b>linked</b> ] does not exist in [ <b>'.TABLE_PRODUCTS_TO_CATEGORIES.'</b> ] table.');
define('AAS_TEXT_SELECTED_PRODUCTS_LINKED_ABORTED_NO_PRODUCTS_TO_LINK',
    'Selected products failed to be linked with selected category because they may already be linked to this category.');

define('AAS_TEXT_CANNOT_OPEN_DIALOG', 'Cannot open dialog!');
define('AAS_TEXT_CANNOT_CLOSE_DIALOG',
    'Cannot close dialog. Dialog does not exist!');
define('AAS_TEXT_CANNOT_MOVE_SELECTED_PRODUCTS',
    'Cannot move selected products to same category!');
define('AAS_TEXT_SELECTED_PRODUCTS_HAVE_BEEN_MOVED_TO_SELECTED_CATEGORY',
    'Selected products have been moved to selected category!');
define('AAS_TEXT_SELECTED_PRODUCTS_HAVE_NOT_BEEN_MOVED_TO_SELECTED_CATEGORY',
    'Selected products have not been moved to selected category!');
define('AAS_TEXT_SELECTED_PRODUCTS_HAVE_BEEN_COPIED_TO_SELECTED_CATEGORY',
    'Selected products have been copied to selected category!');
define('AAS_TEXT_SELECTED_PRODUCTS_HAVE_NOT_BEEN_COPIED_TO_SELECTED_CATEGORY',
    'Selected products have not been copied to selected category!');
...
define('AAS_TEXT_NO_PRODUCTS_FOUND_TO_DELETE_THEIR_ATTRIBUTES',
    'No products found to delete their attributes');
define('AAS_TEXT_SELECTED_PRODUCT_HAS_NOT_ATTRIBUTES_TO_COPY',
    'Selected product has not Attributes to copy from!');
define('AAS_TEXT_NOT_FOUND_PRODUCTS_TO_COPY_ATTRIBUTES',
    'Not found products to copy Attributes to!');
define('AAS_TEXT_ATTRIBUTES_HAVE_NOT_BEEN_COPIED',
    'Something went wrong. Attributes have not been copied!');
define('AAS_TEXT_SELECTED_PRODUCTS_SUCCESSFULLY_ADDED_TO_TEMP_LIST',
    'Selected Products successfully added to temp List!');
define('AAS_TEXT_WAIT_WHILE_UPDATING_VALUES',
    'Please wait while updating values!');
define('AAS_TEXT_SUCCESSFULLY_UPDATED_VALUES', 'Successfully Updated values');
define('AAS_TEXT_VALUES_HAVE_NOT_BENN_UPDATED',
    'Something went wrong, Values have not been updated');
define('AAS_TEXT_SUCCESSFULLY_CHANGED_SETTING', 'Successfully changed setting!');
define('AAS_TEXT_IN_ORDER_TO_CHANGE_SETTING_RELOAD_PAGE',
    'In order to change the setting you must reload the page.');
define('AAS_TEXT_RELOAD_NOW', 'Reload Now');
define('AAS_TEXT_ARE_YOU_SURE_TO_DELETE_ATTRIBUTE',
    'Are you sure you want to delete the attribute:');
define('AAS_TEXT_ARE_YOU_SURE_TO_DELETE_SELECTED_ATTRIBUTES',
    'Are you sure you want to delete the selected attributes:');
define('AAS_TEXT_SUCCESSFULLY_CHANGED_AVAILABLE_DATE',
    'Successfully changed Available Date!');
...
define('AAS_TEXT_PRINT_CATEGORIES_AND_PRODUCTS_TABLE',
    'Print Categories & Products table');
...
define('AAS_TEXT_ADD_LINKED_COLUMN_QUERY_SUCCESS',
    'Successfully executed query.<br>New column named [ linked ] has been  added into '.TABLE_PRODUCTS_TO_CATEGORIES.'.<br>Please reload this page.');
define('AAS_TEXT_ADD_LINKED_COLUMN_QUERY_FAIL',
    'Something went wrong.<br>Could not execute query.<br>Please try again or do it manually.');
...
define('AAS_DONATIONS_TEXT_1',
    'If you like <span style="font-weight:bold">Alternative Administration System</span> (AAS) please make a donation.');
define('AAS_DONATIONS_TEXT_2',
    'I\'ve spent lots of my free time developing AAS for you.<br>It is absolutely free but in order for me to be happy and able to continue developing it, fixing bugs e.t.c. you have to make a donation.');
define('AAS_DONATIONS_TEXT_3',
    'By donating even one penny you\'ll have free support!');
define('AAS_DONATIONS_TEXT_4',
    'I can provide support through Skype or by email any time thats best for you!');
...
define('AAS_CALENDAR_EVENT_NOT_UPDATED',
    'Something went wrong. Event has not been updated!');
define('AAS_CALENDAR_EVENT_NOT_DELETED',
    'Something went wrong. Event has not been deleted!');
define('AAS_CALENDAR_EVENT_NOT_ADDED',
    'Something went wrong. Cannot add Event. Please try again!');
...
define('AAS_CONTACTME_MESSAGE_COULD_NOT_BE_SENT',
    'Something went wrong. Message could not be sent. Please try again!');
define('AAS_CONTACTME_MESSAGE_SUCCESSFULLY_SENT',
    'Your message successfully sent. I will contact you as soon as possible.');
...
define('AAS_CONTACTME_TEXT_1',
    'If you have any questions or need some help or want me to to develop something special to be');
define('AAS_CONTACTME_TEXT_2',
    'included in AAS just send me a message using the form below or at ');
define('AAS_CONTACTME_BUTTON_SEND_MESSAGE', 'Send Message');
define('AAS_CONTACTME_TEXT_NOTE',
    'Note: by pressing the Send Message button you\'ll send me an email<br> at jbqwerty@gmail.com using the default osc mail function.');
...
define('AAS_PRODUCT_IMAGES_DRAG_N_DROP_NEW_IMAGE_HERE',
    'Drag n Drop new Image Here');
define('AAS_PRODUCT_IMAGES_DRAG_N_DROP_NEW_IMAGE_HERE_OR', 'or');
define('AAS_PRODUCT_IMAGES_SELECT_FOLDER_TO_SAVE_NEW_IMAGE',
    'select folder to save new image');
define('AAS_PRODUCT_IMAGES_IMAGES', 'images&nbsp;');
define('AAS_PRODUCT_IMAGES_NO_WRITABLE', 'no writable!');
define('AAS_PRODUCT_IMAGES_NO_WRITABLE_FOLDERS_WARNING',
    'No writable image folders found!');
...
define('AAS_PRODUCT_IMAGES_CHANGE_NEW_IMAGE_LOCATION',
    'Change new Image location:');

define('AAS_PRODUCT_IMAGES_IF_IMAGE_EXISTS_THEN',
    'If an image with same filename already exists then: ');
define('AAS_PRODUCT_IMAGES_OVERWRITE_IT', 'Overwrite it');
define('AAS_PRODUCT_IMAGES_AUTO_RENAME_THE_NEW_IMAGE',
    'Auto rename the new image');
...
define('AAS_PRODUCT_IMAGES_HTML_CONTENT_NOT_UPDATED',
    'Could not update HTML Content. Please try again.');
define('AAS_PRODUCT_IMAGES_HTML_CONTENT_UPDATED',
    'Successfully updated HTML Content.');
define('AAS_PRODUCT_IMAGES_COULD_NOT_DELETE_LARGE_IMAGE',
    'Could not delete Large Image. Please try again.');
define('AAS_PRODUCT_IMAGES_SOMETHING_WENT_WRONG_PLEASE_TRY_AGAIN',
    'Something went wrong. Please try again.');
...
define('AAS_CATEGORY_IMAGES_DRAG_N_DROP_NEW_IMAGE_HERE',
    'Drag n Drop new Image Here');
define('AAS_CATEGORY_IMAGES_DRAG_N_DROP_NEW_IMAGE_HERE_OR', 'or');
define('AAS_CATEGORY_IMAGES_SELECT_FOLDER_TO_SAVE_NEW_IMAGE',
    'select folder to save new image');
define('AAS_CATEGORY_IMAGES_IMAGES', 'images&nbsp;');
define('AAS_CATEGORY_IMAGES_NO_WRITABLE', 'no writable!');
define('AAS_CATEGORY_IMAGES_NO_WRITABLE_FOLDERS_WARNING',
    'No writable image folders found!');
define('AAS_CATEGORY_IMAGES_CHANGE_NEW_IMAGE_LOCATION',
    'Change new Image location:');

//MODULES
define('AAS_MODULES_TITLE', 'Modules');
define('AAS_MODULES_SELECT_TITLE', 'Modules');
define('AAS_MODULES_ADDITIONAL_FEATURES',
    'Modules provide additional features to A.A.S');
...
define('AAS_UPLOAD_MODULE_STATUS_INSTALLED_AND_UPDATED',
    'Latest version Installed');
define('AAS_UPLOAD_MODULE_STATUS_INSTALLED_BUT_OUTDATED',
...
define('AAS_UPLOAD_MODULE_TEXT_TO_GET_NEWEST_VERSION',
...
define('AAS_UPLOAD_MODULE_TEXT_WRONG_VERSION_INSTALLED',
...
define('AAS_DIALOG_UPLOAD_MODULE_SUCCESS',
    'Module Uploaded successfully.<br />In order to be activated you must reload the page.<br /><br />Reload now?');
...
define('AAS_DIALOG_UPLOAD_MODULE_TEXT_VISIT_CREATION_REQUEST_PAGE',
    'to visit the modules creation request page.');
define('AAS_DIALOG_UPLOAD_MODULE_TEXT_VISIT_MODIFICATION_REQUEST_PAGE',
    'to visit the modules modification request page.');
...
define('AAS_AAC_TAB_TITLE_FIELDS_DISABLE_ACTIONS',
    'Column Fields Disable Actions');
...
define('AAS_AAC_TEXT_ADMIN_OPTIONS_SAVED',
    'Successfully saved. Changes will take effect upon page refresh.');

define('AAS_AAC_TAB_TITLE_DEFAULT_COLUMNS_DISPLAY', 'Default Columns Display');
define('AAS_AAC_TAB_TITLE_DEFAULT_COLUMNS_DISPLAY_PER_ADMIN',
    'Columns Display per Admin');


//Descriptions
define('AAS_AAC_DISPLAY_FIELDS_PANEL', 'Hide the columns selection panel from:');
define('AAS_AAC_DISPLAY_LANGUAGE_SELECTION',
    'Hide the language selection dropdown for:');
define('AAS_AAC_DISPLAY_BOTTOM_INFORMATION',
    'Hide the bottom Information, such as Credits and AAS version.');
define('AAS_AAC_DISPLAYCOUNTPRODUCTS',
    'Hide the Count Products and Count Subcategories checkboxes (applies to categories).');
define('AAS_AAC_DISABLE_ATTRIBUTES_MANAGER',
    'Disable the attributes manager. Add options, option values e.t.c.');
define('AAS_AAC_DISABLE_TEMP_PRODUCTS_LIST',
    'Disable temporary products list. Ability to store there various products from diferrent categories in order to mass edit them later.');
define('AAS_AAC_DISABLE_TOOLBOX',
    'Disable toolbox panel. (Copy, Move or Link products || Copy or Delete products attributes)');
...
define('AAS_AAC_DISABLE_CONTACT_ME',
    'Disable contact me dialog (ability to contact the creator of AAS via submitting a form).');
define('AAS_AAC_DISABLE_DONATIONS',
    'Disable donations dialog. You can DONATE any amount to AAS creator so he can continue developing this great addon.');
define('AAS_AAC_DISABLE_MODULES_MANAGER_DIALOG',
    'Disable Modules Upload Manager. ');
...
define('AAS_AAC_DISPLAY_PRODUCTS_PRICE_GROSS',
    'Display product price (GROSS) column.');
...
define('AAS_AAC_DISPLAY_PRODUCTS_DATE_AVAILABLE',
    'Display product date available column.');
define('AAS_AAC_DISPLAY_PRODUCTS_DESCRIPTION',
    'Display product description column.');
...
define('AAS_AAC_DISPLAY_PRODUCTS_ORDER_STATUS',
    'Display product order status column');

define('AAS_AAC_DISABLE_ACTION_FOR_PRODUCTS_IMAGE',
    'Disable products image edit.');
define('AAS_AAC_DISABLE_ACTION_FOR_PRODUCTS_MODEL',
    'Disable products model edit.');
define('AAS_AAC_DISABLE_ACTION_PRODUCTS_QUANTITY',
    'Disable products quantity edit.');
define('AAS_AAC_DISABLE_ACTION_PRODUCTS_PRICE',
    'Disable products price net edit.');
define('AAS_AAC_DISABLE_ACTION_PRODUCTS_PRICE_GROSS',
    'Disable products price gross edit.');
...
define('AAS_AAC_DISABLE_ACTION_PRODUCTS_STATUS',
    'Disable products status change.');
define('AAS_AAC_DISABLE_ACTION_PRODUCTS_DATE_AVAILABLE',
    'Disable products available date change.');
define('AAS_AAC_DISABLE_ACTION_PRODUCTS_DESCRIPTION',
    'Disable products description edit.');
define('AAS_AAC_DISABLE_ACTION_PRODUCTS_URL', 'Disable products url edit.');
define('AAS_AAC_DISABLE_ACTION_MANUFACTURERS_NAME',
    'Disable products manufacturer change.');
