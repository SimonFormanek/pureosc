...
$fieldsArray = array(
    'attributes' => array('visible' => false, 'lockVisibility' => false, 'sortable' => true,
        'cellEditable' => false, 'exportable' => false, 'massEdit' => false, 'theadText' => AAS_HEADING_ATTRIBUTES),
    'date_added' => array('visible' => false, 'lockVisibility' => false, 'sortable' => true,
        'cellEditable' => false, 'exportable' => true, 'massEdit' => true, 'theadText' => AAS_HEADING_DATE_ADDED),
    'products_date_available' => array('visible' => false, 'lockVisibility' => false,
        'sortable' => false, 'cellEditable' => false, 'exportable' => true, 'massEdit' => true,
        'theadText' => AAS_HEADING_PRODUCTS_DATE_AVAILABLE),
    'products_description' => array('visible' => false, 'lockVisibility' => false,
        'sortable' => false, 'cellEditable' => false, 'exportable' => true, 'massEdit' => false,
        'theadText' => AAS_HEADING_PRODUCTS_DESCRIPTION),
    'id' => array('visible' => false, 'lockVisibility' => false, 'sortable' => true,
        'cellEditable' => false, 'exportable' => false, 'massEdit' => false, 'theadText' => AAS_HEADING_ID),
    'products_image' => array('visible' => false, 'lockVisibility' => false, 'sortable' => false,
        'cellEditable' => false, 'exportable' => false, 'massEdit' => false, 'theadText' => AAS_HEADING_PRODUCTS_IMAGE),
    //products_linked is a custom implementation. There is no such field in products table
    'products_linked' => array('visible' => false, 'lockVisibility' => false, 'sortable' => true,
        'cellEditable' => false, 'exportable' => false, 'massEdit' => false, 'theadText' => AAS_HEADING_PRODUCTS_LINKED),
    'last_modified' => array('visible' => false, 'lockVisibility' => false, 'sortable' => true,
        'cellEditable' => false, 'exportable' => true, 'massEdit' => false, 'theadText' => AAS_HEADING_LAST_MODIFIED),
    'manufacturers_name' => array('visible' => false, 'lockVisibility' => false,
        'sortable' => false, 'cellEditable' => false, 'exportable' => true, 'massEdit' => true,
        'theadText' => AAS_HEADING_MANUFACTURERS_NAME),
    'products_model' => array('visible' => false, 'lockVisibility' => false, 'sortable' => true,
        'cellEditable' => true, 'exportable' => true, 'massEdit' => false, 'theadText' => AAS_HEADING_PRODUCTS_MODEL),
    'products_ordered' => array('visible' => false, 'lockVisibility' => false, 'sortable' => true,
        'cellEditable' => false, 'exportable' => true, 'massEdit' => false, 'theadText' => AAS_HEADING_PRODUCTS_ORDERED),
    'products_price' => array('visible' => false, 'lockVisibility' => false, 'sortable' => true,
        'cellEditable' => true, 'exportable' => true, 'massEdit' => true, 'theadText' => AAS_HEADING_PRODUCTS_PRICE),
    //products_price_gross is a custom implementation. There is no products_price_gross field in products table
    'products_price_gross' => array('visible' => false, 'lockVisibility' => false,
        'sortable' => true, 'cellEditable' => true, 'exportable' => true, 'massEdit' => true,
        'theadText' => AAS_HEADING_PRODUCTS_PRICE_GROSS),
    //products_order_status is a custom implementation. There is no such field in products table
    'products_order_status' => array('visible' => false, 'lockVisibility' => false,
        'sortable' => true, 'cellEditable' => false, 'exportable' => true, 'massEdit' => false,
        'theadText' => AAS_HEADING_PRODUCTS_ORDER_STATUS),
    'products_quantity' => array('visible' => false, 'lockVisibility' => false, 'sortable' => true,
        'cellEditable' => true, 'exportable' => true, 'massEdit' => 'int', 'theadText' => AAS_HEADING_PRODUCTS_QUANTITY),
    ...
    'sort_order' => array('visible' => false, 'lockVisibility' => false, 'sortable' => true,
        'cellEditable' => true, 'exportable' => false, 'massEdit' => false, 'theadText' => AAS_HEADING_SORT_ORDER),
    'special' => array('visible' => false, 'lockVisibility' => false, 'sortable' => false,
        'cellEditable' => false, 'exportable' => false, 'massEdit' => false, 'theadText' => AAS_HEADING_SPECIAL),
    'products_status' => array('visible' => false, 'lockVisibility' => false, 'sortable' => false,
        'cellEditable' => false, 'exportable' => true, 'massEdit' => true, 'theadText' => AAS_HEADING_PRODUCTS_STATUS),
    'tax_class_title' => array('visible' => false, 'lockVisibility' => false, 'sortable' => false,
        'cellEditable' => false, 'exportable' => true, 'massEdit' => true, 'theadText' => AAS_HEADING_TAX_CLASS_TITLE),
    'products_url' => array('visible' => false, 'lockVisibility' => false, 'sortable' => true,
        'cellEditable' => true, 'exportable' => true, 'massEdit' => false, 'theadText' => AAS_HEADING_PRODUCTS_URL),
    'products_viewed' => array('visible' => false, 'lockVisibility' => false, 'sortable' => true,
        'cellEditable' => false, 'exportable' => true, 'massEdit' => false, 'theadText' => AAS_HEADING_PRODUCTS_VIEWED),
    'products_weight' => array('visible' => false, 'lockVisibility' => false, 'sortable' => true,
        'cellEditable' => true, 'exportable' => true, 'massEdit' => 'decimal', 'theadText' => AAS_HEADING_PRODUCTS_WEIGHT),
...
$_table_td_rules = array(
    ...
    'products_image' => array('style' => 'width:'.SMALL_IMAGE_WIDTH.'px;height:'.SMALL_IMAGE_HEIGHT.'px;',
        'class' => ''),
