    ...
    function shipping($module = '')
    {
        ...
        if (defined('MODULE_SHIPPING_INSTALLED') && tep_not_null(MODULE_SHIPPING_INSTALLED)) {
            ...
            if ((tep_not_null($module)) && (in_array(substr($module['id'], 0,
                        strpos($module['id'], '_')).'.'.substr($_SERVER['PHP_SELF'],
                        (strrpos($_SERVER['PHP_SELF'], '.') + 1)), $this->modules))) {
                $include_modules[] = array('class' => substr($module['id'], 0,
                        strpos($module['id'], '_')), 'file' => substr($module['id'],
                        0, strpos($module['id'], '_')).'.'.substr($_SERVER['PHP_SELF'],
    ...
    function quote($method = '', $module = '')
    {
        ...
        if (is_array($this->modules)) {
            ...
            if (SHIPPING_BOX_WEIGHT >= $shipping_weight * SHIPPING_BOX_PADDING / 100) {
                ...
                $shipping_weight = $shipping_weight + ($shipping_weight * SHIPPING_BOX_PADDING
                    / 100);
            }
