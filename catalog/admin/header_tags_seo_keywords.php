...
if (isset($_POST['sortgroup'])) {
    ...
    switch ($_POST['display_type']) {
        case TEXT_DISPLAY_TYPE_FOUND: $sortWhere = ' where found=1 ';
            $type      = 'found DESC, ';
            break;
        case TEXT_DISPLAY_TYPE_NOT_FOUND: $sortWhere = ' where found=0 ';
            $type      = 'found, ';
            break;
        default: break;
    }
    switch ($_POST['sortgroup']) {
        case TEXT_SORT_ON_DATE: $sortBy['date']                 = 'checked';
            $sortBy['current']              = $type.' last_search DESC';
            break;
        case TEXT_SORT_ON_KEYWORD: $sortBy['keyword']              = 'checked';
            $sortBy['current']              = $type.' keyword ASC';
            break;
        case TEXT_SORT_ON_GOOGLE: $sortBy['google_last_position'] = 'checked';
            $sortBy['current']              = $type.' google_last_position DESC, keyword ASC';
            break;
        case TEXT_SORT_ON_KEYWORD_NONHTS: $sortBy['nonhts_keyword']       = 'checked';
            $sortBy['current']              = $type.' keyword ASC';
            break;
        case TEXT_SORT_ON_SEARCHES: $sortBy['searches']             = 'checked';
            $sortBy['current']              = $type.' counter DESC';
            break;
    ...
    if ($deleted)
            $messageStack->add(sprintf(TEXT_DELETE_SUCCESSFUL, $deleted),
            'success');
    ...
    if ($updated)
            $messageStack->add(sprintf(TEXT_KEYWORD_SEARCH_SITE_SUCCESSFUL,
                $updated), 'success');
}
