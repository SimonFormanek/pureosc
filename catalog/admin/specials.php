    ...
    switch ($action) {
        case 'setflag':
            ...
            tep_redirect(tep_href_link(FILENAME_SPECIALS,
                    (isset($_GET['page']) ? 'page='.$_GET['page'].'&' : '').'sID='.$_GET['id']));
            break;
        case 'insert':
...
// (when creating a new product on special)
    ...
    ?>
        ...
        tep_get_all_get_params(array('action', 'info', 'sID')).'action='.$form_action).'"';
    ?> method="post"><?php
            ...
            <td><br /><table border="0" cellspacing="0" cellpadding="2">
                    <tr>
                        ...
                        <td class="main"><?php
                            echo (isset($sInfo->products_name)) ? $sInfo->products_name.' <small>('.$currencies->format($sInfo->products_price).')</small>'
                    ...
                    <tr>
                        ...
                        <td class="main"><?php
                        echo tep_draw_input_field('specials_price',
                    ...
                    <tr>
                        ...
                        <td class="main"><?php
                        echo tep_draw_input_field('expdate',
                            (tep_not_null($sInfo->expires_date) ? substr($sInfo->expires_date,
                                    0, 4).'-'.substr($sInfo->expires_date, 5, 2).'-'.substr($sInfo->expires_date,
                                    8, 2) : ''), 'id="expdate"').' <small>(YYYY-MM-DD)</small>';
                        ?></td>
                    </tr>
                </table>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                        ...
                        echo tep_draw_button(IMAGE_SAVE, 'disk', null, 'primary').tep_draw_button(IMAGE_CANCEL,
                            ...
                            tep_href_link(FILENAME_SPECIALS,
                                'page='.$_GET['page'].(isset($_GET['sID']) ? '&sID='.$_GET['sID']
                                        : '')));
                        ?></td>
                        </tr>
                    </table></td>
    ...
    <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                            ...
                            $specials_split     = new AdminSplitPageResults($_GET['page'],
                            ...
                            while ($specials           = tep_db_fetch_array($specials_query)) {
                                if ((!isset($_GET['sID']) || (isset($_GET['sID'])
                                    ...
                                    $sInfo_array    = array_merge($specials,
                                        $products);
                    ...
                    <td colspan="4"><table border="0" width="100%" cellpadding="0"cellspacing="2">
                            <tr>
                                <td class="smallText" valign="top"><?php
                                    echo $specials_split->display_count($specials_query_numrows,
                                        MAX_DISPLAY_SEARCH_RESULTS,
                                        $_GET['page'],
                                        TEXT_DISPLAY_NUMBER_OF_SPECIALS);
                                    ?></td>
                                <td class="smallText" align="right"><?php
                        echo $specials_split->display_links($specials_query_numrows,
        ...
        if (empty($action)) {
            ...
            echo tep_draw_button(IMAGE_NEW_PRODUCT, 'plus',
                tep_href_link(FILENAME_SPECIALS,
