...
<?php echo tep_draw_form('header_tags_logotext',
    'header_tags_seo_popup_logotext.php', '', 'post').tep_draw_hidden_field('action',
    'add_logotext'); ?>
            <tr>
            ...
            <tr>
                <td><table border="0" width="100%">
                        <tr>
                            ...
                            <td><?php echo tep_draw_input_field('extra_logo_1',
    tep_not_null($pageTags['page_logo_1']) ? $pageTags['page_logo_1'] : '',
    'maxlength="255" size="72"', false); ?></td>
                        </tr>
                        <tr>
                            <td class="main"><?php echo TEXT_LOGO_2; ?></td>
                            <td><?php echo tep_draw_input_field('extra_logo_2',
    tep_not_null($pageTags['page_logo_2']) ? $pageTags['page_logo_2'] : '',
    'maxlength="255" size="72"', false); ?></td>
                        </tr>
                        <tr>
                            <td class="main"><?php echo TEXT_LOGO_3; ?></td>
                            <td><?php echo tep_draw_input_field('extra_logo_3',
    tep_not_null($pageTags['page_logo_3']) ? $pageTags['page_logo_3'] : '',
    'maxlength="255" size="72"', false); ?></td>
                        </tr>
                        <tr>
                            <td class="main"><?php echo TEXT_LOGO_4; ?></td>
                            <td><?php echo tep_draw_input_field('extra_logo_4',
    tep_not_null($pageTags['page_logo_4']) ? $pageTags['page_logo_4'] : '',
    'maxlength="255" size="72"', false); ?></td>
                        </tr>
                    </table></td> 
            <tr>
    ...
    '10'); ?></td>
            ...
            <tr>
                <td align="center"><table border="0" width="50%">
                        <tr>
<?php echo tep_draw_hidden_field('pagename', $_GET['pagename']).tep_draw_hidden_field('languageid',
    $_GET['languageid']); ?> 
