...
if (isset($_GET['action']) && ($_GET['action'] == 'new_topic_ACD' || $_GET['action'] == 'edit_topic_ACD')) {
  ...
  ?>
                  ...
                  <tr>
                      <td><?php
                  echo tep_draw_separator('pixel_trans.gif', '1',
                    '10');
                  ?></td>
                  </tr>
                  <tr><?php
                  echo tep_draw_form('new_topic',
                    FILENAME_ARTICLES,
                  ...
                  ?>
                      ...
                      for ($i = 0; $i < sizeof($languages); $i++) {
                        ?>
                            ...
                            echo tep_draw_input_field('topics_name[' . $languages[$i]['id'] . ']',
                              (($topics_name[$languages[$i]['id']]) ? stripslashes($topics_name[$languages[$i]['id']]) : tep_get_topic_name($tInfo->topics_id,
                        ...
                        ?></td>
                              ...
                              ?></td>
                                ...
                                <tr>
                                    ...
                                    <td class="smallText"><?php
                            echo tep_draw_input_field('topics_heading_title[' . $languages[$i]['id'] . ']',
                              (($topics_name[$languages[$i]['id']]) ? stripslashes($topics_name[$languages[$i]['id']]) : tep_get_topic_heading_title($tInfo->topics_id,
                                  $languages[$i]['id']))) . '&nbsp;' . $languages[$i]['name'];
                                        ?></td>
                                </tr>
                                        <?php
    ...
    if (ARTICLE_ENABLE_HTML_EDITOR == 'No Editor')
      echo tep_draw_textarea_field('topics_description[' . $languages[$i]['id'] . ']',
        'soft', '70',
        '15',
        (($topics_description[$languages[$i]['id']]) ? stripslashes($topics_description[$languages[$i]['id']]) : tep_get_topic_description($tInfo->topics_id,
            $languages[$i]['id'])));
    else {
      if (ARTICLE_ENABLE_HTML_EDITOR == 'FCKEditor') {
        echo tep_draw_fckeditor('topics_description[' . $languages[$i]['id'] . ']',
          '700',
          '300',
          (isset($topics_description[$languages[$i]['id']]) ? stripslashes($topics_description[$languages[$i]['id']]) : tep_get_topic_description($tInfo->topics_id,
              $languages[$i]['id'])));
    ...
    ?>
                              ...
                              <tr>
                                  ...
                                  <td class="smallText"><?php
                                                echo tep_draw_input_field('sort_order',
                  ...
                  <tr>
                      <td class="smallText" align="right"><?php
                                      echo tep_draw_hidden_field('topics_date_added',
  ...
  if ($_GET['read'] == 'only') {
    ...
    ?>
                    <tr>
                        <td align="right"><?php
                    echo '<a href="' . tep_href_link($back_url,
                  ...
                  <table border="0" width="100%" cellspacing="0" cellpadding="2">
                      <tr>
                          <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
                                  <tr>
                                      <td class="pageHeading"><?php
                  echo (isset($_GET['aID']) ? sprintf(TEXT_EDIT_ARTICLE,
                      tep_output_generated_topic_path($current_topic_id)) : sprintf(TEXT_NEW_ARTICLE,
                      tep_output_generated_topic_path($current_topic_id)));
                  ?></td>
                                      <td class="pageHeading" align="right"><?php
                echo tep_draw_separator('pixel_trans.gif',
                          ...
                          <td><table border="0" cellspacing="0" cellpadding="2">
                              ...
                              ?></td>
                                  ...
                                  <tr>
                                      ...
                                      <td class="smallText"><?php
                                          echo tep_draw_radio_field('articles_is_blog',
                                            '0', $blog_out_status) . '&nbsp;' . TEXT_ARTICLE_BLOG_NO . '&nbsp;' . tep_draw_radio_field('articles_is_blog',
                                            '1', $blog_in_status) . '&nbsp;' . TEXT_ARTICLE_BLOG_YES;
                                          ?></td>
                                  </tr>
                                  <tr>
                                      <td colspan="2"><?php
                                  ...
                                  <tr>
                                      ...
                                      <td class="smallText"><?php
                                          echo tep_draw_pull_down_menu('authors_id',
                                            $authors_array, $aInfo->authors_id);
                                          ?></td>
                                  </tr>
                                  <tr>
                                      <td colspan="2"><?php
  ...
  for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
    ?>
                                    <tr>
                                        ...
                                        <td class="smallText"><?php
                                    echo tep_draw_input_field('articles_name[' . $languages[$i]['id'] . ']',
                                      (isset($articles_name[$languages[$i]['id']]) ? $articles_name[$languages[$i]['id']] : tep_get_articles_name($aInfo->articles_id,
                                          $languages[$i]['id'])),
                                      'size="35"') . '&nbsp;' . $languages[$i]['name'];
                                    ?></td>
                                    </tr>
                                            <?php
                                          }
                                  ...
                                  //for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                                    ?>
                                    <tr>
                                        <td class="smallText"><?php if ($i == 0) echo TEXT_ARTICLES_IMAGE; ?>IMG TODO</td>
                                        <td class="smallText"><?php
                                       //echo (isset($_GET['aID']) ? tep_draw_input_field('articles_image_name', tep_get_articles_image($aInfo->articles_id, $languages[$i]['id']), 'disabled size="20"') . '&nbsp;&nbsp;' : '')
                                          echo tep_draw_file_field('articles_image');
                                    ?></td>
                                    </tr>
    <?php
  //}
  ?>
                                  ...
                                  for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                                    ...
                                    <tr bgcolor="#ffffcc">
                                        <td class="smallText" valign="top"><?php
                                if ($i == 0)
                                  echo sprintf(TEXT_ARTICLES_HEAD_DESC_TAG,
                                ...
                                ?></td>
                                    ...
                                    if (ARTICLE_ENABLE_HTML_EDITOR == 'No Editor')
                                      echo tep_draw_textarea_field('articles_head_desc_tag[' . $languages[$i]['id'] . ']',
                                        'soft',
                                        '70', '15',
                                        (($articles_head_desc_tag[$languages[$i]['id']]) ? stripslashes($articles_head_desc_tag[$languages[$i]['id']]) : tep_get_articles_head_desc_tag($aInfo->articles_id,
                                            $languages[$i]['id'])));
                                    else {
                                      if (ARTICLE_ENABLE_HTML_EDITOR == 'FCKEditor') {
                                        echo tep_draw_fckeditor('articles_head_desc_tag[' . $languages[$i]['id'] . ']',
                                          '700',
                                          '300',
                                          (isset($articles_head_desc_tag[$languages[$i]['id']]) ? stripslashes($articles_head_desc_tag[$languages[$i]['id']]) : tep_get_articles_head_desc_tag($aInfo->articles_id,
                                              $languages[$i]['id'])));
                                      } else if (ARTICLE_ENABLE_HTML_EDITOR == 'CKEditor') {
                                        echo tep_draw_textarea_field('articles_head_desc_tag[' . $languages[$i]['id'] . ']',
                                          'soft',
                                  ...
                                  <tr>
                                    ...
                                    if (ARTICLE_ENABLE_HTML_EDITOR == 'No Editor')
                                      echo tep_draw_textarea_field('articles_description[' . $languages[$i]['id'] . ']',
                                        'soft', '70', '15',
                                        (($articles_description[$languages[$i]['id']]) ? stripslashes($articles_description[$languages[$i]['id']]) : tep_get_articles_description($aInfo->articles_id,
                                            $languages[$i]['id'])));
                                    else {
                                      if (ARTICLE_ENABLE_HTML_EDITOR == 'FCKEditor') {
                                        echo tep_draw_fckeditor('articles_description[' . $languages[$i]['id'] . ']',
                                          '700', '300',
                                          (isset($articles_description[$languages[$i]['id']]) ? stripslashes($articles_description[$languages[$i]['id']]) : tep_get_articles_description($aInfo->articles_id,
                                              $languages[$i]['id'])));
                                      } else if (ARTICLE_ENABLE_HTML_EDITOR == 'CKEditor') {
                                        echo tep_draw_textarea_field('articles_description[' . $languages[$i]['id'] . ']',
                                          'soft', '70', '15',
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="smallText"><?php
                                                        echo tep_draw_input_field('articles_url[' . $languages[$i]['id'] . ']',
                                                          (isset($articles_url[$languages[$i]['id']]) ? $articles_url[$languages[$i]['id']] : tep_get_articles_url($aInfo->articles_id,
                                                              $languages[$i]['id'])), 'size="35"') . '&nbsp;' . $languages[$i]['name'];
                                                        ?></td>
                                    </tr>
                                                        <?php
                                                      }
                      ...
                      <tr>
                          <td class="smallText" align="right"><?php
                                  echo tep_draw_hidden_field('articles_date_added',
                                    (tep_not_null($aInfo->articles_date_added) ? $aInfo->articles_date_added : date('Y-m-d'))) . tep_image_submit('button_preview.gif',
                                    IMAGE_PREVIEW) . '&nbsp;&nbsp;<a href="' . tep_href_link(FILENAME_ARTICLES,
                                  ...
                                  ?></td>
                                          ...
                                          if (tep_not_null($_POST)) {
                                            ...
                                            $art_image = new upload('articles_image');
                                            $art_image->set_destination(DIR_FS_CATALOG_IMAGES . 'article_manager_uploads/');

                                            if ($art_image->parse() && $art_image->save()) {
                                              tep_db_query("update " . TABLE_ARTICLES . " set articles_image = '" . tep_db_input($art_image->filename) . "' where articles_id = '" . (int) $_GET['aID'] . "'");
                                            }
                                          ...
                                          for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                                            if (isset($_GET['read']) && ($_GET['read'] == 'only')) {
                                              $aInfo->articles_name = tep_get_articles_name($aInfo->articles_id,
                                                $languages[$i]['id']);
                                              $aInfo->articles_description = tep_get_articles_description($aInfo->articles_id,
                                                $languages[$i]['id']);
//                                              $aInfo->articles_image = tep_get_articles_image($aInfo->articles_id,
//                                                $languages[$i]['id']);
                                              $aInfo->articles_url = tep_get_articles_url($aInfo->articles_id,
                                                $languages[$i]['id']);
                                              $aInfo->articles_head_desc_tag = tep_get_articles_head_desc_tag($aInfo->articles_id,
                                                $languages[$i]['id']);
                                            } else {
...
//                                              $aInfo->articles_image = tep_db_prepare_input($articles_image[$languages[$i]['id']]);
                                             ...
                                             $aInfo->articles_image = tep_db_prepare_input($articles_image);
                                            ?>
                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                        <tr>
                            <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
                    ...
                    echo tep_image(DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'],
                      $languages[$i]['name']) . '&nbsp;' . $aInfo->articles_name;
                    ?></td>
                                    </tr>
                                </table></td>
                        </tr>
                    ...
                    if ($aInfo->articles_url) {
                      ...
                      ?></td>
                          ...
                          <tr>
                              <td class="smallText"><?php
                          echo sprintf(TEXT_ARTICLE_MORE_INFORMATION,
                            $aInfo->articles_url);
                          ?></td>
                          </tr>
                                  <?php
                    ...
                    echo sprintf(TEXT_ARTICLE_DATE_AVAILABLE,
                      tep_date_long($aInfo->articles_date_available));
                          ?></td>
                          </tr>
      <?php
    } else {
      ?>
                          <tr>
                              <td align="center" class="smallText"><?php
                          echo sprintf(TEXT_ARTICLE_DATE_ADDED,
                            tep_date_long($aInfo->articles_date_added));
                          ?></td>
                          </tr>
                                  <?php
                                }
                        ...
                        echo '<a href="' . tep_href_link($back_url,
                          $back_url_params,
                          'NONSSL') . '">' . tep_image_button('button_back.gif',
                          IMAGE_BACK) . '</a>';
                        ?></td>
                        </tr>
                        <?php
...
// Get parent_id for subtopics if search
                                                        ...
                                                        if ((!isset($_GET['tID']) && !isset($_GET['aID']) || (isset($_GET['tID']) && ($_GET['tID'] == $topics['topics_id']))) && !isset($tInfo) && (substr($action, 0, 3) != 'new')) {
                                                          ...
                                                          $tInfo_array = array_merge($topics,
                                                            $topic_childs,
                                                            $topic_articles);
                                                ...
                                                echo '<a href="' . tep_href_link(FILENAME_ARTICLES,
                                                  ...
                                                  ICON_FOLDER) . '</a>&nbsp;<b>' . $topics['topics_name'] . '</b>';
                                                ?></td>
...
// find out the rating average from customer reviews
                                    ...
                                    echo '<a href="' . tep_href_link(FILENAME_ARTICLES,
                                      ...
                                      ICON_PREVIEW) . '</a>&nbsp;' . $articles['articles_name'];
                                    ?></td>
                      ...
                      switch ($action) {
                        case 'new_topic':
                          ...
                          $contents = array('form' => tep_draw_form('newtopic',
                              FILENAME_ARTICLES,
                              'action=insert_topic&tPath=' . $tPath, 'post',
                              'enctype="multipart/form-data"'));
                        ...
                        case 'edit_topic':
                          ...
                          $contents = array('form' => tep_draw_form('topics',
                              FILENAME_ARTICLES,
                              'action=update_topic&tPath=' . $tPath, 'post',
                              'enctype="multipart/form-data"') . tep_draw_hidden_field('topics_id',
                              $tInfo->topics_id));
                        ...
                        case 'delete_article':
                          ...
                          $article_topics_string = substr($article_topics_string, 0,
                            -4);
                        ...
                        case 'copy_to':
                          ...
                          $contents = array('form' => tep_draw_form('copy_to',
                              FILENAME_ARTICLES,
                              'action=copy_to_confirm&tPath=' . $tPath) . tep_draw_hidden_field('articles_id',
                              $aInfo->articles_id));
