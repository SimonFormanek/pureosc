...
//----- new_topic / edit_topic  -----
                if (isset($_GET['action']) && ($_GET['action'] == 'new_topic_ACD'
                    || $_GET['action'] == 'edit_topic_ACD')) {
                    if (($_GET['tID']) && (!$_POST)) {
    ...
    -->
                                            ...
                                            echo tep_draw_form('new_article',
                                                ...
                                                'tPath='.$tPath.(isset($_GET['aID'])
                                                        ? '&aID='.$_GET['aID'] : '').'&action=article_preview',
                                                'post',
                                        ...
                                        <tr>
                                            ...
                                            <td class="smallText"><?php
                                                            echo tep_draw_input_field('articles_name['.$languages[$i]['id'].']',
                                                                (isset($articles_name[$languages[$i]['id']])
                                            ...
                                            <td class="smallText"><?php
                                                            echo (isset($_GET['aID'])
                                                                    ...
                                                                    tep_get_articles_image($aInfo->articles_id,
                                                                        $languages[$i]['id']),
                                                                    'disabled size="20"').'&nbsp;&nbsp;'
                                                                    : '').tep_draw_file_field('articles_image_'.$languages[$i]['id']).'&nbsp;'.$languages[$i]['name'];
                                                            ?></td>
                                        </tr>
                                        <?php
                                    }
                                                            ...
                                                            if (ARTICLE_ENABLE_HTML_EDITOR
                                                                == 'No Editor')
                                                                    ...
                                                                    (($articles_head_desc_tag[$languages[$i]['id']])
                                                                            ? stripslashes($articles_head_desc_tag[$languages[$i]['id']])
                                                                ...
                                                                if (ARTICLE_ENABLE_HTML_EDITOR
                                                                    ...
                                                                    echo tep_draw_fckeditor('articles_head_desc_tag['.$languages[$i]['id'].']',
                                                                        '700',
                                                                        '300',
                                                                        (isset($articles_head_desc_tag[$languages[$i]['id']])
                                                                                ? stripslashes($articles_head_desc_tag[$languages[$i]['id']])
                                                                                : tep_get_articles_head_desc_tag($aInfo->articles_id,
                                                                                $languages[$i]['id'])));
                                                                } else if (ARTICLE_ENABLE_HTML_EDITOR
    ...
    ?></td>
                                ...
                                for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                                    ?>
                                        <tr>
                                            <td class="smallText" valign="top"><?php if ($i
                                == 0) echo TEXT_ARTICLES_DESCRIPTION;
                                    ?></td>
                                            <td><table border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="smallText">
                        ...
                        if (ARTICLE_ENABLE_HTML_EDITOR == 'No Editor')
                                ...
                                'soft', '70', '15',
                                (($articles_description[$languages[$i]['id']]) ? stripslashes($articles_description[$languages[$i]['id']])
                                    ...
                                    <tr>
                                        ...
                                        <td><table border="0" width="100%">
                                                ...
                                                if (function_exists('AnnounceVersion')) {
                                                    ...
                                                    $id = $idParts[count($idParts)
                                                        - 1];
                                                    if (ARTICLE_ENABLE_VERSION_CHECKER
                                                        == 'true') {
                                                        ?>
                                                        <tr>
...
// Get parent_id for subtopics if search
                                            ...
                                            if (isset($tInfo) && is_object($tInfo)
                                                && ($topics['topics_id'] == $tInfo->topics_id)) {
                            ...
                            if (isset($tInfo) && is_object($tInfo) && ($topics['topics_id']
                                == $tInfo->topics_id)) {
...
// Get topics_id for article if search
                                                ...
                                                if ((!isset($_GET['aID']) && !isset($_GET['tID'])
                                                    || (isset($_GET['aID']) && ($_GET['aID']
                                                    == $articles['articles_id'])))
                                                    && !isset($aInfo) && !isset($tInfo)
                                                    && (substr($action, 0, 3) != 'new')) {
// find out the rating average from customer reviews
                ...
                ?></td>
                                        ...
                                        <td class="dataTableContent" align="right"><?php
                if (isset($aInfo) && is_object($aInfo) && ($articles['articles_id']
                    == $aInfo->articles_id)) {
                    echo tep_image(DIR_WS_IMAGES.'icon_arrow_right.gif', '');
                } else {
                    echo '<a href="'.tep_href_link(FILENAME_ARTICLES,
