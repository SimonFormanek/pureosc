...
if (SESSION_FORCE_COOKIE_USE == 'True') {
  tep_setcookie('cookie_test', 'please_accept_for_session', 0, $cookie_path, $cookie_domain); //TODO: 2th check for long session to store settings (?) PURE:BUGFIX privacy - session expires: 0 = only session cookies
