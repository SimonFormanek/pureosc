                                  ...
                                  $parameters = '')
{
    ...
    if (($checked == true) || (isset($_GET[$name]) && is_string($_GET[$name]) && (($_GET[$name]
        == 'on') || (stripslashes($_GET[$name]) == $value))) || (isset($HTTP_POST_VARS[$name])
        && is_string($HTTP_POST_VARS[$name]) && (($HTTP_POST_VARS[$name] == 'on')
...
function tep_draw_hidden_field($name, $value = '', $parameters = '')
{
    ...
    if (tep_not_null($value)) {
        $field .= ' value="'.tep_output_string($value).'"';
    } elseif ((isset($_GET[$name]) && is_string($_GET[$name])) || (isset($HTTP_POST_VARS[$name])
                                 ...
                                 $parameters = '', $required = false)
{
    ...
    if (empty($default) && ( (isset($_GET[$name]) && is_string($_GET[$name])) || (isset($HTTP_POST_VARS[$name])
        && is_string($HTTP_POST_VARS[$name])) )) {
        if (isset($_GET[$name]) && is_string($_GET[$name])) {
