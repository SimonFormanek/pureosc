...
class SEO_DataBase
{
    ...
    {
        $this->SEO_DataBase($host, $user, $db, $pass);
    }
...
//ojp USE_SEO_CACHE_LINKS
        $this->attributes = array('PHP_VERSION' => PHP_VERSION,
            ...
            'SEO_ADD_CID_TO_PRODUCT_URLS' => defined('SEO_ADD_CID_TO_PRODUCT_URLS')
                ? SEO_ADD_CID_TO_PRODUCT_URLS : 'false',
            'SEO_ADD_CPATH_TO_PRODUCT_URLS' => defined('SEO_ADD_CPATH_TO_PRODUCT_URLS')
                ? SEO_ADD_CPATH_TO_PRODUCT_URLS : 'false',
            'SEO_ADD_CAT_PARENT' => defined('SEO_ADD_CAT_PARENT') ? SEO_ADD_CAT_PARENT
                : 'true',
            'SEO_URLS_USE_W3C_VALID' => defined('SEO_URLS_USE_W3C_VALID') ? SEO_URLS_USE_W3C_VALID
                : 'true',
            'USE_SEO_CACHE_GLOBAL' => defined('USE_SEO_CACHE_GLOBAL') ? USE_SEO_CACHE_GLOBAL
                : 'false',
            'USE_SEO_CACHE_PRODUCTS' => defined('USE_SEO_CACHE_PRODUCTS') ? USE_SEO_CACHE_PRODUCTS
                : 'false',
            'USE_SEO_CACHE_CATEGORIES' => defined('USE_SEO_CACHE_CATEGORIES') ? USE_SEO_CACHE_CATEGORIES
                : 'false',
            'USE_SEO_CACHE_MANUFACTURERS' => defined('USE_SEO_CACHE_MANUFACTURERS')
                ? USE_SEO_CACHE_MANUFACTURERS : 'false',
            'USE_SEO_CACHE_ARTICLES' => defined('USE_SEO_CACHE_ARTICLES') ? USE_SEO_CACHE_ARTICLES
                : 'false',
            'USE_SEO_CACHE_ARTICLES_AUTHORS' => defined('USE_SEO_CACHE_ARTICLES_AUTHORS')
                ? USE_SEO_CACHE_ARTICLES_AUTHORS : 'false',
            'USE_SEO_CACHE_TOPICS' => defined('USE_SEO_CACHE_TOPICS') ? USE_SEO_CACHE_TOPICS
                : 'false',
            'USE_SEO_CACHE_FAQDESK_CATEGORIES' => defined('USE_SEO_CACHE_FAQDESK_CATEGORIES')
                ? USE_SEO_CACHE_FAQDESK_CATEGORIES : 'false',
            'USE_SEO_CACHE_INFO_PAGES' => defined('USE_SEO_CACHE_INFO_PAGES') ? USE_SEO_CACHE_INFO_PAGES
                : 'false',
            'USE_SEO_CACHE_LINKS' => defined('USE_SEO_CACHE_LINKS') ? USE_SEO_CACHE_LINKS
                : 'false',
            'USE_SEO_CACHE_NEWSDESK_ARTICLES' => defined('USE_SEO_CACHE_NEWSDESK_ARTICLES')
                ? USE_SEO_CACHE_NEWSDESK_ARTICLES : 'false',
            'USE_SEO_CACHE_NEWSDESK_CATEGORIES' => defined('USE_SEO_CACHE_NEWSDESK_CATEGORIES')
                ? USE_SEO_CACHE_NEWSDESK_CATEGORIES : 'false',
            'USE_SEO_CACHE_POLLBOOTH' => defined('USE_SEO_CACHE_POLLBOOTH') ? USE_SEO_CACHE_POLLBOOTH
                : 'false',
            'USE_SEO_CACHE_PAGE_EDITOR' => defined('USE_SEO_CACHE_PAGE_EDITOR') ? USE_SEO_CACHE_PAGE_EDITOR
                : 'false',
            'USE_SEO_REDIRECT' => defined('USE_SEO_REDIRECT') ? USE_SEO_REDIRECT
                : 'false',
            'USE_SEO_HEADER_TAGS' => defined('USE_SEO_HEADER_TAGS') ? USE_SEO_HEADER_TAGS
                : 'false',
            'USE_SEO_PERFORMANCE_CHECK' => defined('USE_SEO_PERFORMANCE_CHECK') ? USE_SEO_PERFORMANCE_CHECK
                : 'false',
            'SEO_REWRITE_TYPE' => defined('SEO_REWRITE_TYPE') ? SEO_REWRITE_TYPE
                : 'false',
            'SEO_URLS_FILTER_SHORT_WORDS' => defined('SEO_URLS_FILTER_SHORT_WORDS')
                ? SEO_URLS_FILTER_SHORT_WORDS : 'false',
            'SEO_CHAR_CONVERT_SET' => defined('SEO_CHAR_CONVERT_SET') ? $this->expand(SEO_CHAR_CONVERT_SET)
                : 'false',
            'SEO_REMOVE_ALL_SPEC_CHARS' => defined('SEO_REMOVE_ALL_SPEC_CHARS') ? SEO_REMOVE_ALL_SPEC_CHARS
                : 'false',
            'SEO_PAGES' => $seo_pages,
...
//ojp generate_link_cache
        ...
        if ($this->attributes['USE_SEO_CACHE_GLOBAL'] == 'true') {
            ...
            if ($this->attributes['USE_SEO_CACHE_ARTICLES_AUTHORS'] == 'true' && defined('TABLE_AUTHORS'))
            ...
            if ($this->attributes['USE_SEO_CACHE_INFO_PAGES'] == 'true' && defined('TABLE_INFORMATION'))
            ...
            if ($this->attributes['USE_SEO_CACHE_NEWSDESK_CATEGORIES'] == 'true'
                && defined('TABLE_NEWSDESK'))
        ...
        if ($this->attributes['SEO_ENABLED'] == 'true' && $this->attributes['USE_SEO_REDIRECT']
            == 'true') {
            $this->check_redirect();
        } # end if
    }
# end constructor
                       ...
                       $add_session_id = true)
    {
        ...
        if (!in_array($page, $this->attributes['SEO_PAGES']) || $this->attributes['SEO_ENABLED']
            == 'false') {
        ...
        switch ($this->attributes['SEO_URLS_USE_W3C_VALID']) {
            case ('true'):
                if (!isset($_SESSION['customer_id']) && defined('ENABLE_PAGE_CACHE')
                    && ENABLE_PAGE_CACHE == 'true' && class_exists('page_cache')) {
                    return $link;
                } else {
...
# end function
     ...
     */
    function stock_href_link($page = '', $parameters = '',
                             ...
                             $search_engine_safe = true)
    {
        ...
        switch (true) {
            case (!isset($_SESSION['customer_id']) && defined('ENABLE_PAGE_CACHE')
            && ENABLE_PAGE_CACHE == 'true' && class_exists('page_cache')):
                $page_cache = true;
...
# end default tep_href function
    ...
    function add_sid($link, $add_session_id, $connection, $separator)
    {
        ...
        if (($add_session_id) && ($this->attributes['SESSION_STARTED']) && (SESSION_FORCE_COOKIE_USE
            == 'False')) {
            ...
            switch ($p2[0]) {
                    ...
                    switch (true) {
                        case ( $page == 'product_info.php' && !$this->is_attribute_string($p2[1]) ):
                            $url               = $this->make_url($page,
                                $this->get_product_name($p2[1]), $p2[0], $p2[1],
                                '.html');
                            break;
                        case ( $page == 'product_reviews.php' ):
                            $url               = $this->make_url($page,
                                $this->get_product_name($p2[1]),
                                'products_id_review', $p2[1], '.html');
                            break;
                        case ( $page == 'product_reviews_info.php' ):
                            $url               = $this->make_url($page,
                                $this->get_product_name($p2[1]),
                                'products_id_review_info', $p2[1], '.html');
                            break;
                        default:
                            $container[$p2[0]] = $p2[1];
                            break;
                ...
                case 'cPath':
                    switch (true) {
                        case ($page == 'index.php'):
                            $url = $this->make_url($page,
                                $this->get_category_name($p2[1]), $p2[0],
                                $p2[1], '.html');
                            break;
                        case (!$this->is_product_string($params) ):

                            if ($this->attributes['SEO_ADD_CID_TO_PRODUCT_URLS']
                                == 'true') {
                                $container[$p2[0]] = $p2[1];
                            }
                            break;
                ...
                case 'manufacturers_id':
                    switch (true) {
                        case ($page == 'index.php' && !$this->is_cPath_string($params)
                        && !$this->is_product_string($params) ):
                            $url               = $this->make_url($page,
                                $this->get_manufacturer_name($p2[1]), $p2[0],
                                $p2[1], '.html');
                            break;
                ...
                case 'tPath':
                    switch (true) {
                        case ($page == 'articles.php'):
                            $url               = $this->make_url($page,
                                $this->get_topic_name($p2[1]), $p2[0], $p2[1],
                                '.html');
                            break;
                        default:
                            $container[$p2[0]] = $p2[1];
                ...
                case 'lPath':  //Links Manager II
                    switch (true) {
                        case ($page == 'links.php'):
                            $url               = $this->make_url($page,
                                $this->get_link_name($p2[1]), $p2[0], $p2[1],
                                '.html');
                            break;
                        default:
                            $container[$p2[0]] = $p2[1];
                ...
                case 'fl':  //All Products SEO
                    switch (true) {
                        case ($page == 'all-products.php'):
                            $url               = $this->make_url($page,
                                'all-products.php', $p2[0], $p2[1], '.html');
                            break;
                        default:
                            $container[$p2[0]] = $p2[1];
                            break;
                ...
                case 'articles_id':
                    switch (true) {
                        case ($page == 'article_info.php'):
                            $url               = $this->make_url($page,
                                $this->get_article_name($p2[1]), $p2[0], $p2[1],
                                '.html');
                            break;
                        default:
                            $container[$p2[0]] = $p2[1];
                ...
                case 'authors_id':
                    switch (true) {
                        case ($page == 'articles.php'):
                            $url               = $this->make_url($page,
                                $this->get_authors_name($p2[1]), $p2[0], $p2[1],
                                '.html');
                            break;
                        default:
                            $container[$p2[0]] = $p2[1];
                ...
                case 'info_id': //Information Pages
                    switch (true) {
                        case ($page == 'information.php'):
                            $url               = $this->make_url($page,
                                $this->get_information_name($p2[1]), $p2[0],
                                $p2[1], '.html');
                            break;
                        default:
                            $container[$p2[0]] = $p2[1];
                ...
                case 'pages_id': // Page Editor
                    switch (true) {
                        case ($page == 'pages.php'):
                            $url               = $this->make_url($page,
                                $this->get_page_editor_name($p2[1]), $p2[0],
                                $p2[1], '.html');
                            break;
                        default:
                            $container[$p2[0]] = $p2[1];
                ...
                case 'faqdesk_id':
                    switch (true) {
                        case ($page == 'faqdesk_info.php'):
                            $url               = $this->make_url($page,
                                $this->get_faqdesk_name($p2[1]), $p2[0], $p2[1],
                                '.html');
                            break;
                        case ($page == 'faqdesk_reviews_info.php'):
                            $url               = $this->make_url($page,
                                $this->get_faqdesk_name($p2[1]),
                                'faqdesk_reviews_id', $p2[1], '.html');
                            break;
                        case ($page == 'faqdesk_reviews_article.php'):
                            $url               = $this->make_url($page,
                                $this->get_faqdesk_name($p2[1]),
                                'faqdesk_article_id', $p2[1], '.html');
                            break;
                        default:
                            $container[$p2[0]] = $p2[1];
                            break;
                ...
                case 'faqPath':
                    switch (true) {
                        case ($page == 'faqdesk_index.php'):
                            $url               = $this->make_url($page,
                                $this->get_faqdesk_categories_name($p2[1]),
                                $p2[0], $p2[1], '.html');
                            break;
                        default:
                            $container[$p2[0]] = $p2[1];
                ...
                case 'pollid':
                    switch (true) {
                        case ($page == 'pollbooth.php'):
                            $url               = $this->make_url($page,
                                $this->get_pollbooth($p2[1]), $p2[0], $p2[1],
                                '.html');
                            break;
                        default:
                            $container[$p2[0]] = $p2[1];
                ...
                case 'newsdesk_id':
                    switch (true) {
                        case ($page == 'newsdesk_info.php'):
                            $url               = $this->make_url($page,
                                $this->get_newsdesk_name($p2[1]), $p2[0],
                                $p2[1], '.html');
                            break;
                        case ($page == 'newsdesk_reviews.php'):
                            $url               = $this->make_url($page,
                                $this->get_newsdesk_name($p2[1]),
                                'newsdesk_reviews_id', $p2[1], '.html');
                            break;
                        case ($page == 'newsdesk_reviews_article.php'):
                            $url               = $this->make_url($page,
                                $this->get_newsdesk_name($p2[1]),
                                'newsdesk_article_id', $p2[1], '.html');
                            break;
                        default:
                            $container[$p2[0]] = $p2[1];
                            break;
                ...
                case 'newsPath':
                    switch (true) {
                        case ($page == 'newsdesk_index.php'):
                            $url               = $this->make_url($page,
                                $this->get_newsdesk_categories_name($p2[1]),
                                $p2[0], $p2[1], '.html');
                            break;
                        default:
                            $container[$p2[0]] = $p2[1];
    ...
    function get_product_name($pID)
    {
        ...
        switch (true) {
            ...
            case ($this->attributes['USE_SEO_CACHE_GLOBAL'] == 'true' && isset($this->cache['PRODUCTS'][$pID])):
                if ($this->attributes['USE_SEO_PERFORMANCE_CHECK'] == 'true')
                        $this->performance['CACHE_QUERY_SAVINGS'] ++;
                $return                        = (tep_not_null($cName) ? $cName.'-'.$this->cache['PRODUCTS'][$pID]
                        : $this->cache['PRODUCTS'][$pID]);
                break;
            default:
                if ($this->attributes['USE_SEO_PERFORMANCE_CHECK'] == 'true')
                        $this->performance['NUMBER_QUERIES'] ++;
                $sqlCmd                        = $this->attributes['USE_SEO_HEADER_TAGS']
                    == 'true' ? 'IF(products_head_title_tag_url !="",products_head_title_tag_url, products_head_title_tag) as pName'
                        : 'products_url as pName';
                $sql                           = "SELECT ".$sqlCmd."
...
# end function
    ...
    {
        $sqlCmd = $this->attributes['USE_SEO_HEADER_TAGS'] == 'true' ? 'IF(cd.categories_htc_title_tag_url !="",cd.categories_htc_title_tag_url,cd.categories_htc_title_tag) ) as cName'
                : 'cd.categories_url ) as cName';
            ...
            default:
                ...
                switch (true) {
                    case ($this->attributes['SEO_ADD_CAT_PARENT'] == 'true'):
                        $sqlCmd = $this->attributes['USE_SEO_HEADER_TAGS'] == 'true'
                                ? 'LOWER(IF(cd.categories_htc_title_tag_url !="",cd.categories_htc_title_tag_url, cd.categories_htc_title_tag)) as cName'
                                : 'LOWER(cd.categories_name) as cName';
                        ...
                        $cName  = $this->get_all_category_names($single_cID,
                            $cName);
                        break;
                    default:
                        $sqlCmd = $this->attributes['USE_SEO_HEADER_TAGS'] == 'true'
                                ? 'IF(categories_htc_title_tag_url !="",categories_htc_title_tag_url,categories_htc_title_tag) as cName'
                                : 'categories_name as cName';
                        $sql    = "SELECT ".$sqlCmd."
        ...
        switch (true) {
            ...
            default:
                if ($this->attributes['USE_SEO_PERFORMANCE_CHECK'] == 'true')
                        $this->performance['NUMBER_QUERIES'] ++;
                $sqlCmd                                          = $this->attributes['USE_SEO_HEADER_TAGS']
                    == 'true' ? 'IF(md.manufacturers_htc_title_tag_url !="",md.manufacturers_htc_title_tag_url,m.manufacturers_name) as mName'
    ...
    function GetParentCategories(&$categories, $categories_id)
    {
        ...
        while ($parent_categories       = $this->DB->FetchArray($parent_categories_query)) {
            ...
            if ($parent_categories['parent_id'] != $categories_id) {
                $this->GetParentCategories($categories,
...
# end function
    ...
    function strip($string)
    {
        ...
        if (is_array($this->attributes['SEO_CHAR_CONVERT_SET']))
                $string = strtr($string,
                $this->attributes['SEO_CHAR_CONVERT_SET']);

        $pattern = $this->attributes['SEO_REMOVE_ALL_SPEC_CHARS'] == 'true' ? "([^[:alnum:]])"
                : "/[^a-z0-9- ]/i";
...
# end function
    ...
    function short_name($str, $limit = 3)
    {
        ...
        $container = ( sizeof($container) > 1 ? implode('-', $container) : (sizeof($container)
            > 0 ? $container[0] : $str ));
        return $container;
    }
...
# end function
    ...
    function generate_products_cache()
    {
        ...
        if (!$is_cached || $is_expired) {
            $sqlCmd        = $this->attributes['USE_SEO_HEADER_TAGS'] == 'true' ? 'IF(pd.products_head_title_tag_url !="",pd.products_head_title_tag_url,pd.products_name) as name'
                    : 'pd.products_url as name';
...
//pure:orig                        $define = 'define(\'PRODUCT_NAME_' . $product['id'] . '\', \'' . $this->strip($product['name']) . '\');';
            ...
            $this->save_cache($this->cache_file.'PRODUCTS', $prod_cache, 'EVAL',
                1, 1);
            unset($prod_cache);
        } else {
...
# end function
    ...
    {
        $this->is_cached($this->cache_file.'MANUFACTURERS', $is_cached,
            $is_expired);
        if (!$is_cached || $is_expired) { // it's not cached so create it
            $sqlCmd              = $this->attributes['USE_SEO_HEADER_TAGS'] == 'true'
                    ? 'IF(md.manufacturers_htc_title_tag_url !="",md.manufacturers_htc_title_tag_url,m.manufacturers_name) as name'
            ...
            $this->save_cache($this->cache_file.'MANUFACTURERS', $man_cache,
                'EVAL', 1, 1);
            unset($man_cache);
        } else {
    ...
    function generate_categories_cache()
    {
        ...
        if (!$is_cached || $is_expired) { // it's not cached so create it
            switch (true) {
                case ($this->attributes['SEO_ADD_CAT_PARENT'] == 'true'):
                    $sqlCmd = $this->attributes['USE_SEO_HEADER_TAGS'] == 'true'
                            ? 'IF(cd.categories_htc_title_tag_url !="",cd.categories_htc_title_tag_url, cd.categories_htc_title_tag) as cName, cd2.categories_htc_title_tag AS pName'
                            : 'cd.categories_name as cName, cd2.categories_name AS pName';
                    $sql    = "SELECT c.categories_id as id, c.parent_id, ".$sqlCmd."
                                                        FROM `categories` c,
                                                        `categories_description` cd
            ...
            while ($category       = $this->DB->FetchArray($category_query)) {
                ...
                $name      = $this->not_null($category['pName']) ? $category['pName'].' '.$category['cName']
                        : $category['cName'];
            ...
            $this->save_cache($this->cache_file.'CATEGORIES', $cat_cache,
                'EVAL', 1, 1);
            unset($cat_cache);
        } else {
...
# end function
    ...
    function generate_articles_cache()
    {
        ...
        if (!$is_cached || $is_expired) { // it's not cached so create it
            $sqlCmd        = $this->attributes['USE_SEO_HEADER_TAGS'] == 'true' ? 'articles_head_title_tag as name'
                    : 'articles_url as name';
            ...
            $this->save_cache($this->cache_file.'ARTICLES', $article_cache,
                'EVAL', 1, 1);
            unset($article_cache);
        } else {
...
# end function
    ...
    function generate_articles_authors_cache()
    {
        ...
        if (!$is_cached || $is_expired) { // it's not cached so create it
            ...
            $this->save_cache($this->cache_file.'AUTHORS', $authors_cache,
                'EVAL', 1, 1);
            unset($authors_cache);
        } else {
...
# end function
    ...
    function generate_topics_cache()
    {
        ...
        if (!$is_cached || $is_expired) { // it's not cached so create it
            ...
            $this->save_cache($this->cache_file.'TOPICS', $topic_cache, 'EVAL',
                1, 1);
            unset($topic_cache);
        } else {
...
# end function
    ...
    {
        $this->is_cached($this->cache_file.'FAQDESK_CATEGORIES', $is_cached,
            $is_expired);
        if (!$is_cached || $is_expired) { // it's not cached so create it
            $sql           = "SELECT categories_name as fcName
                                   FROM ".TABLE_FAQDESK_CATEGORIES_DESCRIPTION."
            ...
            $this->save_cache($this->cache_file.'FAQDESK_CATEGORIES',
                $faqdesk_cache, 'EVAL', 1, 1);
            unset($faqdesk_cache);
        } else {
...
# end function
    ...
    function generate_links_cache()
    {
        ...
        if (!$is_cached || $is_expired) { // it's not cached so create it
            ...
            $this->save_cache($this->cache_file.'LINKS', $link_cache, 'EVAL', 1,
                1);
            unset($link_cache);
        } else {
...
# end function
    ...
    function generate_information_cache()
    {
        ...
        if (!$is_cached || $is_expired) { // it's not cached so create it
            ...
            $this->save_cache($this->cache_file.'INFO', $information_cache,
                'EVAL', 1, 1);
...
# end function
    ...
    function generate_newsdesk_name_cache()
    {
        ...
        if (!$is_cached || $is_expired) { // it's not cached so create it
            ...
            $this->save_cache($this->cache_file.'NEWSDESK', $newsdesk_cache,
                'EVAL', 1, 1);
...
# end function
    ...
    {
        $this->is_cached($this->cache_file.'NEWSDESK_CATEGORIES', $is_cached,
            $is_expired);
        if (!$is_cached || $is_expired) { // it's not cached so create it
            $sql            = "SELECT categories_name as ncName
                                   FROM ".TABLE_NEWSDESK_CATEGORIES_DESCRIPTION."
            ...
            $this->DB->Free($newsdesk_query);
            $this->save_cache($this->cache_file.'NEWSDESK_CATEGORIES',
                $newsdesk_cache, 'EVAL', 1, 1);
            unset($newsdesk_cache);
        } else {
...
# end function
    ...
    function generate_page_editor_cache()
    {
        ...
        if (!$is_cached || $is_expired) { // it's not cached so create it
            ...
            $this->save_cache($this->cache_file.'PAGES', $pages_cache, 'EVAL',
                1, 1);
            unset($pages_cache);
        } else {
...
# end function
    ...
    function generate_pollbooth_cache()
    {
        ...
        if (!$is_cached || $is_expired) { // it's not cached so create it
            ...
            $this->save_cache($this->cache_file.'POLLBOOTH', $pollbooth_cache,
                'EVAL', 1, 1);
...
# end function
     ...
     */
    function save_cache($name, $value, $method = 'RETURN', $gzip = 1,
                        $global = 0, $expires = '30/days')
    {
        ...
        switch ($cache_check) {
            case 'true':
                $this->DB->DBPerform('cache', $sql_data_array, 'update',
                    "cache_id='".md5($name)."'");
                break;
            case 'false':
        ...
        if ($num_rows) {
            ...
            while ($cache     = $this->DB->FetchArray($this->cache_query)) {
                ...
                if ($cache['cache_expires'] > @date("Y-m-d H:i:s")) {
                    $cache_data = ( $cache['cache_gzip'] == 1 ? gzinflate(base64_decode($cache['cache_data']))
                            : stripslashes($cache['cache_data']) );
...
# end function get_cache()
    ...
    {
        $data = ( isset($this->data['GLOBAL'][$name]) ? $this->data['GLOBAL'][$name]
                : $this->data[$name] );
...
# end function get_cache_memory()
    ...
    { //expires date interval must be spelled out and NOT abbreviated !!
        ...
        switch (strtolower($expires[1])) {
            case 'seconds':
                $expires = mktime(@date("H"), @date("i"),
                    @date("s") + (int) $expires[0], @date("m"), @date("d"),
                    @date("Y"));
                break;
            case 'minutes':
                $expires = mktime(@date("H"), @date("i") + (int) $expires[0],
                    @date("s"), @date("m"), @date("d"), @date("Y"));
                break;
            case 'hours':
                $expires = mktime(@date("H") + (int) $expires[0], @date("i"),
                    @date("s"), @date("m"), @date("d"), @date("Y"));
                break;
            case 'days':
                $expires = mktime(@date("H"), @date("i"), @date("s"),
                    @date("m"), @date("d") + (int) $expires[0], @date("Y"));
                break;
            case 'months':
                $expires = mktime(@date("H"), @date("i"), @date("s"),
                    @date("m") + (int) $expires[0], @date("d"), @date("Y"));
                break;
            case 'years':
                $expires = mktime(@date("H"), @date("i"), @date("s"),
                    @date("m"), @date("d"), @date("Y") + (int) $expires[0]);
                break;
...
# end function convert_time()
    ...
    { // NOTE: $is_cached and $is_expired is passed by reference !!
        ...
        $is_cached         = ( $this->DB->NumRows($this->cache_query) > 0 ? true
                : false );
        if ($is_cached) {
            $check      = $this->DB->FetchArray($this->cache_query);
            $is_expired = ( $check['cache_expires'] <= @date("Y-m-d H:i:s") ? true
                    : false );
            unset($check);
        }
        $this->DB->Free($this->cache_query);
...
# end function is_cached()
    ...
    function check_redirect()
    {
        ...
        $this->path_info                                = is_numeric(strpos(ltrim(getenv('PATH_INFO'),
                        '/'), '/')) ? ltrim(getenv('PATH_INFO'), '/') : NULL;
        ...
        if (strpos($this->attributes['SEO_REDIRECT']['URI_PARSED']['path'],
                '.html') !== FALSE) {
                ...
                if (($pStop = strpos($u1, ".html")) !== FALSE) {
                    ...
                    if (($pStart = strpos($path, "-")) !== FALSE) {   //isolate to the number
                        if (($pStop = strpos($path, ".html")) !== FALSE) {
                            ...
                            $fullID     = $this->get_full_cPath($actualID,
                                $actualID); //will be something like 34 or 34_35
                            $actualPath = $actualID.'.html';        //save a few instructions

                            /*                             * ** REPLACE THE PARTIAL ID IN THE URL's WITH THE FULL ONE *** */
                            $idPos                                        = strpos($this->attributes['SEO_REDIRECT']['REAL_URI'],
                                $actualID);
                            $this->attributes['SEO_REDIRECT']['REAL_URI'] = substr_replace($this->attributes['SEO_REDIRECT']['REAL_URI'],
                                $fullID, $idPos, strlen($idPos));
                            $idPos                                        = strpos($this->attributes['SEO_REDIRECT']['URI'],
                                $actualID);
                            $this->attributes['SEO_REDIRECT']['URI']      = substr_replace($this->attributes['SEO_REDIRECT']['URI'],
                                $fullID, $idPos, strlen($idPos));

                            if (strpos($this->attributes['SEO_REDIRECT']['URI_PARSED']['path'],
                                    '-c-'.$actualPath) !== FALSE) { //this is the actual url
                                if ($fullID != $actualID && strpos($fullID.'.html',
                                    ...
                                    if ($this->need_redirect && $this->is_seopage
                                        && $this->attributes['USE_SEO_REDIRECT']
                                        == 'true') $this->do_redirect();
                                }
                            }
                        }
                    }
                    ...
                    if (($pStart = strpos($path, "-")) !== FALSE) {   //isolate to the number
                        if (($pStop = strpos($path, ".html")) !== FALSE) {
                            ...
                            if ($actualID == 0) {
                                ...
                                if (strpos($this->attributes['SEO_REDIRECT']['URI_PARSED']['path'],
                                        '-c-'.$actualPath) !== FALSE) { //this is the actual url
                                    if (0 == $actualID && strpos($actualID.'.html',
                                            $actualPath) !== FALSE) { //enteed url is child of full path
                                        $url                      = 'index.php';
                                        $this->uri_parsed['path'] = $url; //reset the url
                                        $this->need_redirect      = true;
        ...
        $this->need_redirect();
        $this->check_seo_page();
        if ($this->need_redirect && $this->is_seopage && $this->attributes['USE_SEO_REDIRECT']
            == 'true') $this->do_redirect();
    }
# end function
    ...
    {
        if (defined('SEARCH_ENGINE_FRIENDLY_URLS') && SEARCH_ENGINE_FRIENDLY_URLS
            == 'true') {
            $sql = "
    ...
    function need_redirect()
    {
        ...
        switch (true) {
            ...
            case ($this->uri != $this->real_uri && !$this->not_null($this->path_info)):
                if (($pStart              = strpos($this->uri_parsed['path'],
                    "-p-")) !== FALSE) {
                    if (($pStop = strpos($this->uri_parsed['path'], ".html")) !== FALSE) {
                        ...
                        if ($this->attributes['USE_SEO_PERFORMANCE_CHECK'] == 'true')
                                $this->performance['NUMBER_QUERIES'] ++;
                        $pID    = substr($this->uri_parsed['path'], $pStart + 3,
                            -(strlen($this->uri_parsed['path']) - $pStop));
                        $sqlCmd = $this->attributes['USE_SEO_HEADER_TAGS'] == 'true'
                                ? 'IF(products_head_title_tag_url !="",products_head_title_tag_url,products_name) as pName'
                                : 'products_url as pName';
                        $sql    = "SELECT ".$sqlCmd."
                        ...
                        $cName = '';
                        if ($this->attributes['SEO_ADD_CPATH_TO_PRODUCT_URLS'] == 'true') {
                            $cName = $this->get_all_category_parents($pID,
                                $cName);
                    ...
                    if (($pStop = strpos($this->uri_parsed['path'], ".html")) !== FALSE) {
                        ...
                        $forceRedirect = $this->VerifyLink($pStop, $pStart); //remove things that shouldn't be there
                        $cID           = substr($this->uri_parsed['path'],
                            $pStart + 3,
                            -(strlen($this->uri_parsed['path']) - $pStop));
                        ...
                        if ($this->attributes['SEO_ADD_CAT_PARENT'] != 'true') {
                            ...
                            if ($this->attributes['USE_SEO_PERFORMANCE_CHECK'] == 'true')
                                    $this->performance['NUMBER_QUERIES'] ++;
                            $sqlCmd = $this->attributes['USE_SEO_HEADER_TAGS'] == 'true'
                                    ? 'LOWER(IF(categories_htc_title_tag_url !="",categories_htc_title_tag_url,categories_htc_title_tag)) as cName'
                                    : 'LOWER(categories_name) as cName';
                            $sql    = "SELECT ".$sqlCmd."
                                              FROM `categories_description`
            ...
            case (@preg_match("/(".@implode('|', $pattern).")/i", $this->uri)):
                $this->need_redirect = true;
                break;
            case (@preg_match("/(".@implode('|', $pattern).")/i",
                $this->path_info)):
                $this->need_redirect = true;
                break;
            default:
        ...
        $this->attributes['SEO_REDIRECT']['NEED_REDIRECT'] = $this->need_redirect
                ? 'true' : 'false';
    }
# end function set_seopage
    ...
    function VerifyLink(&$pStop, $pStart)
    {
        ...
        $p1 = strpos($_SERVER['REQUEST_URI'],
            $this->attributes['SEO_REDIRECT']['URI_PARSED']['path']);
        ...
        $endStr = substr($this->uri_parsed['path'], $pStart + 3,
            $pStop - $pStart - 3);
        if (!preg_match("/^([0-9_]+)$/", $endStr)) {
            ...
            $this->uri_parsed['path'] = str_replace($endStr, $newStr,
                $this->uri_parsed['path']);
            $pStop                    = strpos($this->uri_parsed['path'],
                ".html"); //recalculate the end
            return true;
        }
    ...
    {
        switch (true) {
            case (@in_array($this->uri_parsed['path'],
                $this->attributes['SEO_PAGES'])):
                $this->is_seopage = true;
                break;
        ...
        $this->attributes['SEO_REDIRECT']['IS_SEOPAGE'] = $this->is_seopage ? 'true'
                : 'false';
    }
...
# end function parse_path
    ...
    function do_redirect()
    {
        ...
        $url    = $this->href_link($this->uri_parsed['path'], $params, 'NONSSL',
            false);
