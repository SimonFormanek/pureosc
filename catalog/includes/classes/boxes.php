...
class tableBox
{
    ...
    {
        $this->tableBox($contents, $direct_output);
    }
...
class infoBox extends tableBox
{
    ...
    function infoBoxContents($contents)
    {
        ...
        $info_box_contents       = array();
        $info_box_contents[]     = array(array('text' => tep_draw_separator('pixel_trans.gif',
                    '100%', '1')));
        for ($i = 0, $n = sizeof($contents); $i < $n; $i++) {
...
class infoBoxHeading extends tableBox
{
    ...
    public function __construct($contents, $left_corner, $right_corner,
                                $right_arrow)
    {
        $this->infoBoxHeading($contents, $left_corner, $right_corner,
            $right_arrow);
    }
...
class contentBoxHeading extends tableBox
{
    ...
    public function __construct($contents)
    {
        $this->contentBoxHeading($contents);
    }
...
class productListingBox extends tableBox
{
    ...
    public function __construct($contents)
    {
        $this->productListingBox($contents);
    }
