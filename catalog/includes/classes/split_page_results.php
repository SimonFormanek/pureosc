...
class splitPageResults
{
                                ...
                                $page_holder = 'page')
    {
        ...
        if (strpos($this->sql_query, 'distinct') || strpos($this->sql_query,
                'group by')) {
        ...
        $count_query = tep_db_query("select count(".$count_string.") as total ".substr($this->sql_query,
...
// display number of total products found
    function display_count($text_output)
    {
        ...
        $from_num = ($this->number_of_rows_per_page * ($this->current_page_number
            - 1));
