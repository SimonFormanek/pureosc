...
class Fwr_Media_Security_Pro
{
    ...
    function Fwr_Media_Security_Pro($cleanse_keys = false)
    {
        ...
        $this->addExclusions(array(defined('FILENAME_PROTX_PROCESS') ? FILENAME_PROTX_PROCESS
                    : 'protx_process.php'));
    }
// end constructor
...
// end method
    ...
    function cleanseKeyString($string)
    {
        ...
        // Apply the whitelist dirtyHack TODO generated whitelist or exclude ext-moules...content_searches.php
        $cleansed              = preg_replace("/[^\s{}a-z0-9_\.\-]/iáÁčČďĎéÉěĚÍňŇóÓřŘšŠťŤúÚůźŽ", "",
            urldecode($string));
        // Remove banned words
