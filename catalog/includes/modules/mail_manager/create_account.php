...
//define placeholders
    $placeholders        = array('$storeurl', '$storename', '$storeemail', '$customername',
        '$mmgreet', '$mmwelcome', '$mmtext', '$mmcontact', '$mmwarning');
    $values              = array(HTTP_SERVER, STORE_NAME, STORE_OWNER_EMAIL_ADDRESS,
        $name, $mmgreet, EMAIL_WELCOME, EMAIL_TEXT, EMAIL_CONTACT, EMAIL_WARNING);
...
//send email      
    tep_mm_sendmail($name, $email_address, STORE_NAME,
...
//if mail manager status update email is 'inactive' process normally via oscommerce
    ...
    tep_mail($name, $email_address, EMAIL_SUBJECT, $email_text, STORE_OWNER,
