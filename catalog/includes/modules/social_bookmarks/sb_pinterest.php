...
// add the js in the footer
        $oscTemplate->addBlock('<script src="//assets.pinterest.com/js/pinit.js"></script>',
            'footer_scripts');
...
// and image (used for media)
        ...
        if (tep_not_null($image['products_image'])) {
            ...
            $params['media'] = tep_href_link(DIR_WS_IMAGES.$image_file, '',
                'NONSSL', false);
        }

// url
        $params['url'] = tep_href_link(FILENAME_PRODUCT_INFO,
    ...
    function keys()
    {
        return array('MODULE_SOCIAL_BOOKMARKS_PINTEREST_STATUS', 'MODULE_SOCIAL_BOOKMARKS_PINTEREST_BUTTON_COUNT_POSITION',
