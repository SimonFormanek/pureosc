...
class sb_google_plus_share
{
    ...
    function sb_google_plus_share()
    {
        ...
        if (defined('MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_SHARE_STATUS')) {
            ...
            $this->enabled    = (MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_SHARE_STATUS
                == 'True');
        }
    }
    ...
    function getOutput()
    {
        ...
        $output = '<div class="g-plus" data-action="share" data-href="'.tep_href_link(FILENAME_PRODUCT_INFO,
                'products_id='.$_GET['products_id'], 'NONSSL', false).'" data-annotation="'.strtolower(MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_SHARE_ANNOTATION).'"';
  ...
  (function() {
    ...
    function keys()
    {
        return array('MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_SHARE_STATUS', 'MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_SHARE_ANNOTATION',
            'MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_SHARE_WIDTH', 'MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_SHARE_HEIGHT',
            'MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_SHARE_ALIGN', 'MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_SHARE_SORT_ORDER');
    }
}
