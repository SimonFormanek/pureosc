...
class ht_robot_control {
    ...
    public function __construct() {
        $this->ht_robot_control();
    }

    function ht_robot_control() {
        $this->title = _('Robot Control');
        $this->description = _('Take control of your pages abstracts in the Search Engine Result Pages.') .
                '<div style="text-align: center; margin-top: 10px;">' . tep_draw_button(_('Helper Page'), 'extlink', 'http://en.wikipedia.org/wiki/Meta_element#NOODP', NULL, array('newwindow' => true)) . '</div>';
