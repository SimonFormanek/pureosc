...
class ht_robot_noindex
{
    ...
    function keys()
    {
        return array('MODULE_HEADER_TAGS_ROBOT_NOINDEX_STATUS', 'MODULE_HEADER_TAGS_ROBOT_NOINDEX_PAGES',
...
function ht_robot_noindex_edit_pages($values, $key)
{
    ...
    foreach ($files_array as $file) {
        $output .= tep_draw_checkbox_field('ht_robot_noindex_file[]', $file,
