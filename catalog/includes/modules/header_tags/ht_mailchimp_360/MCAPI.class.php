...
class MCAPI
{
    ...
    function MCAPI($username_or_apikey, $password = null, $secure = false)
    {
        ...
        if (isset($GLOBALS["mc_api_key"]) && $GLOBALS["mc_api_key"] != "") {
            ...
            $this->api_key         = $this->callServer("login",
     ...
     */
    function campaignCreate($type, $options, $content, $segment_opts = NULL,
                            $type_opts = NULL)
    {
        $params                 = array();
        $params["type"]         = $type;
     ...
     * @return boolean true on success, false on failure. When using MCAPI.class.php, the value can be tested and error messages pulled from the MCAPI object (see below)
     */
    function listUnsubscribe($id, $email_address, $delete_member = false,
     ...
     */
    function listBatchSubscribe($id, $batch, $double_optin = true,
     ...
     */
    function listBatchUnsubscribe($id, $emails, $delete_member = false,
     ...
     */
    function listMembers($id, $status = 'subscribed', $since = NULL, $start = 0,
                         $limit = 100)
    {
        $params           = array();
        $params["id"]     = $id;
