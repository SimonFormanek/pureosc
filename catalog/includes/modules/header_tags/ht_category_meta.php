...
class ht_category_meta
{
    ...
    function execute()
    {
        ...
        if (basename($PHP_SELF) == FILENAME_DEFAULT) {
            if ($current_category_id > 0) {
                ...
                if ((tep_not_null($meta_info['categories_seo_keywords'])) && (MODULE_HEADER_TAGS_CATEGORY_META_KEYWORDS_STATUS
                    == 'True')) {
    ...
    function keys()
    {
        return array('MODULE_HEADER_TAGS_CATEGORY_META_STATUS', 'MODULE_HEADER_TAGS_CATEGORY_META_DESCRIPTION_STATUS',
