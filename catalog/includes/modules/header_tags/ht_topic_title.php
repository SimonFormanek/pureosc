...
class ht_topic_title {
    ...
    function ht_topic_title() {
        $this->title = _('Topic Title');
        $this->description = _('Add the title of the current topic to the page title');
    ...
    function execute() {
        global $oscTemplate, $topics, $current_topic_id, $languages_id;

        if (basename($_SERVER['PHP_SELF']) == FILENAME_ARTICLES) {
