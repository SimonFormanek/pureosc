...
*/
  ...
  class ht_noscript {
    ...
    function ht_noscript() {
      $this->title = _('No Script Message');
      $this->description = _('Shows a message to the user if they are browsing with javascript off.');
    ...
    function execute() {
      global $oscTemplate;
      $oscTemplate->addBlock('<noscript><div class="no-script"><div class="no-script-inner"><p><strong>' . tep_output_string(_('JavaScript seems to be disabled in your browser.')) . '</strong></p><p> '._('You must have JavaScript enabled in your browser to utilize the functionality of this website.').'<a href="http://www.enable-javascript.com/" target="_blank" rel="nofollow">'._('Click here for instructions on enabling javascript in your browser').'</a>.  </div></div></noscript>', $this->group);
