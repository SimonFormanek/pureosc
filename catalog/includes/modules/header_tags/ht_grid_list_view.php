...
*/
  ...
  class ht_grid_list_view {
    ...
    public function __construct() {
            $this->ht_grid_list_view();
    }

    function ht_grid_list_view() {
      $this->title = _('Grid List Javascript (jQuery)');
      $this->description = _('Add Grid List javascript to specified pages, which invokes a Grid/List view for product lists');
