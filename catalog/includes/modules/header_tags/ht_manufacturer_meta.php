...
class ht_manufacturer_meta
{
        ...
        if (basename($PHP_SELF) == FILENAME_DEFAULT) {
            if (isset($_GET['manufacturers_id']) && is_numeric($_GET['manufacturers_id'])) {
                ...
                if (tep_not_null($meta_info['manufacturers_seo_description'])) {
                    $oscTemplate->addBlock('<meta name="description" content="'.tep_output_string($meta_info['manufacturers_seo_description']).'" />',
                        $this->group);
                }
                if ((tep_not_null($meta_info['manufacturers_seo_keywords'])) && (MODULE_HEADER_TAGS_MANUFACTURERS_META_KEYWORDS_STATUS
                    == 'True')) {
    ...
    function keys()
    {
        return array('MODULE_HEADER_TAGS_MANUFACTURERS_META_STATUS', 'MODULE_HEADER_TAGS_MANUFACTURERS_META_DESCRIPTION_STATUS',
            'MODULE_HEADER_TAGS_MANUFACTURERS_META_KEYWORDS_STATUS', 'MODULE_HEADER_TAGS_MANUFACTURERS_META_SORT_ORDER');
    }
}
