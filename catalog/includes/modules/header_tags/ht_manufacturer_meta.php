...
class ht_manufacturer_meta {
    ...
    public function __construct() {
        $this->ht_manufacturer_meta();
    }

    function ht_manufacturer_meta() {
        $this->title = _('Manufacturer Meta');
        $this->description = _('Add the META elements defined when setting up the manufacturer, to the header of the manufacturer page');
