...
class ht_mailchimp_360 {
    ...
    public function __construct() {
        $this->ht_mailchimp_360();
    }

    function ht_mailchimp_360() {
        $this->title = _('MailChimp E-Commerce 360');
        $this->description = '<img src="images/icon_popup.gif" border="0">&nbsp;<a href="http://eepurl.com/bxza1" target="_blank" style="text-decoration: underline; font-weight: bold;">' . _('Visit MailChimp Website') . ''
                . '</a>&nbsp;<a href="javascript:toggleDivBlock(\'mailchimpInfo\',true);">(info)</a><span id="mailchimpInfo" style="display: none;"><br /><i>' . _('Using the above link to signup at MailChimp grants osCommerce a small financial bonus for referring a customer.') . '</i></span><br /><br />'
                . _('The MailChimp E-Commerce 360 module measures the ROI of your MailChimp e-mail campaigns');
