...
<div class="contentText">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            echo tep_draw_input_field('firstname', NULL,
                'id="inputFirstName" aria-describedby="atFirstName" placeholder="'.ENTRY_FIRST_NAME.'"');
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            echo tep_draw_input_field('lastname', NULL,
                'id="inputLastName" aria-describedby="atLastName" placeholder="'.ENTRY_LAST_NAME.'"');
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            echo tep_draw_input_field('street_address', NULL,
                'id="inputStreet" aria-describedby="atStreetAddress" placeholder="'.ENTRY_STREET_ADDRESS.'"');
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            echo tep_draw_input_field('city', NULL,
                'id="inputCity" aria-describedby="atCity" placeholder="'.ENTRY_CITY.'"');
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            echo tep_draw_input_field('postcode', NULL,
                'id="inputZip" aria-describedby="atZip" placeholder="'.ENTRY_POST_CODE.'"');
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <?php
            echo tep_get_country_list('country', STORE_COUNTRY, 0,
                'id="inputCountry" aria-describedby="atCountry"');
