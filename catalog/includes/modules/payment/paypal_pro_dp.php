...
*/
  ...
  class paypal_pro_dp {
    ...
    function paypal_pro_dp() {
      ...
      if ( defined('FILENAME_MODULES') && ($_SERVER['PHP_SELF'] == FILENAME_MODULES) && isset($_GET['action']) && ($_GET['action'] == 'install') && isset($_GET['subaction']) && ($_GET['subaction'] == 'conntest') ) {
...
// format prices without currency formatting
    ...
    function isCardAccepted($card) {
      return (isset($this->cc_types[$card]) && defined('MODULE_PAYMENT_PAYPAL_PRO_DP_CARDTYPE_' . $card) && (cfg('MODULE_PAYMENT_PAYPAL_PRO_DP_CARDTYPE_' . $card) == 'True'));
    }
