...
*/
  ...
  class sage_pay_direct {
    ...
    function before_process() {
      global $_GET, $HTTP_POST_VARS, $customer_id, $order, $currency, $order_totals, $cartID, $sage_pay_response;
      ...
      if ( isset($_GET['check']) ) {
        if ( ($_GET['check'] == '3D') && isset($HTTP_POST_VARS['MD']) && tep_not_null($HTTP_POST_VARS['MD']) && isset($HTTP_POST_VARS['PaRes']) && tep_not_null($HTTP_POST_VARS['PaRes']) ) {
        ...
        } elseif ( ($_GET['check'] == 'PAYPAL') && isset($HTTP_POST_VARS['Status']) ) {
    ...
    function after_process() {
      global $_GET, $HTTP_POST_VARS, $customer_id, $insert_id, $sage_pay_response;
      ...
      if ( isset($_GET['check']) && ($_GET['check'] == 'PAYPAL') && isset($HTTP_POST_VARS['Status']) && ($HTTP_POST_VARS['Status'] == 'PAYPALOK') && isset($HTTP_POST_VARS['VPSTxId']) && isset($sage_pay_response['VPSTxId']) && ($HTTP_POST_VARS['VPSTxId'] == $sage_pay_response['VPSTxId']) ) {
