...
class phgpwebpay
{
    ...
    public function __construct()
    {
        ...
        $this->code         = 'phgpwebpay';
        $this->title        = _('PureOSC\'s GP WebPay');
        $this->icon         = (defined('DIR_WS_CATALOG_IMAGES') ? constant('DIR_WS_CATALOG_IMAGES')
                : constant('DIR_WS_IMAGES')).'gpwebpay.png';
    ...
    {
        return cfg('MODULE_PAYMENT_GPWEBPAY_GATEWAY_SERVER') == 'Production'
