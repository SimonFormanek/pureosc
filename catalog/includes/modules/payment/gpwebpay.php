...
class gpwebpay
{
    ...
    public function __construct()
    {
        ...
        $this->icon         = (defined('DIR_WS_CATALOG_IMAGES') ? constant('DIR_WS_CATALOG_IMAGES') : constant('DIR_WS_IMAGES'))  . 'gpwebpay.png';
...
//                }
    ...
    function process_button()
    {
        ...
        $successUrl   = constant('HTTPS_SERVER').tep_href_link(constant('FILENAME_CHECKOUT_PROCESS'),
                'payment=done', 'SSL');
