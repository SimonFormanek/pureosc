...
class gpwebpay {
    ...
    function gpwebpay() {
        ...
        $this->enabled = ((MODULE_PAYMENT_GPWEBPAY_STATUS == 'True') ? true : false);
    ...
    public static function getServerURL() {
        return constant('MODULE_PAYMENT_GPWEBPAY_GATEWAY_SERVER') == 'Production' ? 'https://3dsecure.gpwebpay.com/pgw/order.do' : 'https://test.3dsecure.gpwebpay.com/pgw/order.do';
    }
