...
// remove headers from the encrypted result
	...
	/* ** Altered for CCGV **
      ...
      $result = false;
	*/
	global $customer_id, $order, $order_totals, $sendto, $billto, $languages_id, $payment, $currencies, $cart, $cart_PayPal_Standard_ID, $$payment, $_GET, $HTTP_POST_VARS, $messageStack, $order_total_modules;
