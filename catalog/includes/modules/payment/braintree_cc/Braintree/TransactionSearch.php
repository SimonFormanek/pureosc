...
class Braintree_TransactionSearch
{
    ...
    {
        return new Braintree_MultipleValueNode("created_using",
            array(
    ...
    {
        return new Braintree_MultipleValueNode("credit_card_customer_location",
            array(
    ...
    {
        return new Braintree_MultipleValueNode("source",
            array(
    ...
    {
        return new Braintree_MultipleValueNode("type",
            array(
