...
class bm_shopping_cart
{
    ...
    function bm_shopping_cart()
    {
        ...
        if (defined('MODULE_BOXES_SHOPPING_CART_STATUS')) {
            ...
            $this->group = ((MODULE_BOXES_SHOPPING_CART_CONTENT_PLACEMENT == 'Left Column')
    ...
    function execute()
    {
        ...
        if ($cart->count_contents() > 0) {
            ...
            for ($i = 0, $n = sizeof($products); $i < $n; $i++) {
                ...
                if ((tep_session_is_registered('new_products_id_in_cart')) && ($new_products_id_in_cart
                    == $products[$i]['id'])) {
                ...
                $cart_contents_string .= '<a href="'.tep_href_link(FILENAME_PRODUCT_INFO,
