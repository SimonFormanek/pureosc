...
class bm_manufacturers
{
    ...
    function bm_manufacturers()
    {
        ...
        if (defined('MODULE_BOXES_MANUFACTURERS_STATUS')) {
            ...
            $this->group = ((MODULE_BOXES_MANUFACTURERS_CONTENT_PLACEMENT == 'Left Column')
...
// Display a list
                ...
                while ($manufacturers      = tep_db_fetch_array($manufacturers_query)) {
                    $manufacturers_name = ((strlen($manufacturers['manufacturers_name'])
                        > MAX_DISPLAY_MANUFACTURER_NAME_LEN) ? substr($manufacturers['manufacturers_name'],
                    ...
                    $manufacturers_list .= '<li><a href="'.tep_href_link(FILENAME_DEFAULT,
                            'manufacturers_id='.$manufacturers['manufacturers_id']).'">'.$manufacturers_name.'</a></li>';
                }
...
// Display a drop-down
                ...
                $data = tep_draw_form('manufacturers',
                        tep_href_link(FILENAME_DEFAULT, '', $request_type, false),
                        'get').
    ...
    function keys()
    {
        return array('MODULE_BOXES_MANUFACTURERS_STATUS', 'MODULE_BOXES_MANUFACTURERS_CONTENT_PLACEMENT',
