...
class bm_product_social_bookmarks
{
    ...
    {
        $this->bm_product_social_bookmarks();
    }
    ...
    function bm_product_social_bookmarks()
    {
        ...
        if (defined('MODULE_BOXES_PRODUCT_SOCIAL_BOOKMARKS_STATUS')) {
            ...
            $this->group = ((MODULE_BOXES_PRODUCT_SOCIAL_BOOKMARKS_CONTENT_PLACEMENT
                == 'Left Column') ? 'boxes_column_left' : 'boxes_column_right');
        }
    }
    ...
    function execute()
    {
        ...
        if (isset($_GET['products_id']) && defined('MODULE_SOCIAL_BOOKMARKS_INSTALLED')
            && tep_not_null(MODULE_SOCIAL_BOOKMARKS_INSTALLED)) {
    ...
    function keys()
    {
        return array('MODULE_BOXES_PRODUCT_SOCIAL_BOOKMARKS_STATUS', 'MODULE_BOXES_PRODUCT_SOCIAL_BOOKMARKS_CONTENT_PLACEMENT',
            'MODULE_BOXES_PRODUCT_SOCIAL_BOOKMARKS_SORT_ORDER');
    }
}
