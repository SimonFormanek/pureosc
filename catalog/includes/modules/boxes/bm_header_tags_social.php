...
class bm_header_tags_social
{
    ...
    function bm_header_tags_social()
    {
        ...
        if (defined('MODULE_BOXES_HEADER_TAGS_SOCIAL_STATUS')) {
            ...
            $this->enabled    = (MODULE_BOXES_HEADER_TAGS_SOCIAL_STATUS == 'True'
                && HEADER_TAGS_DISPLAY_COLUMN_BOX == 'true' && basename($_SERVER['PHP_SELF'])
                == FILENAME_PRODUCT_INFO);

            $this->group = ((MODULE_BOXES_HEADER_TAGS_SOCIAL_CONTENT_PLACEMENT == 'Left Column')
    ...
    function keys()
    {
        return array('MODULE_BOXES_HEADER_TAGS_SOCIAL_STATUS', 'MODULE_BOXES_HEADER_TAGS_SOCIAL_CONTENT_PLACEMENT',
