...
class bm_order_history
{
    ...
    function bm_order_history()
    {
        ...
        if (defined('MODULE_BOXES_ORDER_HISTORY_STATUS')) {
            ...
            $this->group = ((MODULE_BOXES_ORDER_HISTORY_CONTENT_PLACEMENT == 'Left Column')
...
// retreive the last x products purchased
    ...
    function keys()
    {
        return array('MODULE_BOXES_ORDER_HISTORY_STATUS', 'MODULE_BOXES_ORDER_HISTORY_CONTENT_PLACEMENT',
