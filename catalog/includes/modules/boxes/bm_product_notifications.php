...
class bm_product_notifications
{
    ...
    function bm_product_notifications()
    {
        ...
        if (defined('MODULE_BOXES_PRODUCT_NOTIFICATIONS_STATUS')) {
            ...
            $this->group = ((MODULE_BOXES_PRODUCT_NOTIFICATIONS_CONTENT_PLACEMENT
    ...
    function keys()
    {
        return array('MODULE_BOXES_PRODUCT_NOTIFICATIONS_STATUS', 'MODULE_BOXES_PRODUCT_NOTIFICATIONS_CONTENT_PLACEMENT',
