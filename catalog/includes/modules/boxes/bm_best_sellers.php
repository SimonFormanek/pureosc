...
class bm_best_sellers
{
    ...
    function bm_best_sellers()
    {
        ...
        if (defined('MODULE_BOXES_BEST_SELLERS_STATUS')) {
            ...
            $this->group = ((MODULE_BOXES_BEST_SELLERS_CONTENT_PLACEMENT == 'Left Column')
    ...
    function execute()
    {
        ...
        if (tep_db_num_rows($best_sellers_query) >= MIN_DISPLAY_BESTSELLERS) {
            ...
            while ($best_sellers = tep_db_fetch_array($best_sellers_query)) {
                $bestsellers_list .= '<li><a href="'.tep_href_link(FILENAME_PRODUCT_INFO,
                        'products_id='.$best_sellers['products_id']).'">'.$best_sellers['products_name'].'</a></li>';
            }
    ...
    function keys()
    {
        return array('MODULE_BOXES_BEST_SELLERS_STATUS', 'MODULE_BOXES_BEST_SELLERS_CONTENT_PLACEMENT',
