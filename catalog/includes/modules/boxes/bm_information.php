...
class bm_information
{
    ...
    function bm_information()
    {
        ...
        if (defined('MODULE_BOXES_INFORMATION_STATUS')) {
            ...
            $this->group = ((MODULE_BOXES_INFORMATION_CONTENT_PLACEMENT == 'Left Column')
...
// EOF: Information Pages Unlimited
    ...
    function keys()
    {
        return array('MODULE_BOXES_INFORMATION_STATUS', 'MODULE_BOXES_INFORMATION_CONTENT_PLACEMENT',
