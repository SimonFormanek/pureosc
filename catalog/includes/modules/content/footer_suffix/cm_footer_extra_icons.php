...
class cm_footer_extra_icons
{
    ...
    public function __construct()
    {
        ...
        $this->title = _('Payment Icons');
        $this->description = _('Adds a Payment Icons Block to the Extra Footer Area of your site');
    ...
    function keys()
    {
        return array('MODULE_CONTENT_FOOTER_EXTRA_ICONS_STATUS', 'MODULE_CONTENT_FOOTER_EXTRA_ICONS_CONTENT_WIDTH',
