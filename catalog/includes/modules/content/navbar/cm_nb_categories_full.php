...
class cm_nb_categories_full
{
    ...
    public function getOutput()
    {
        ...
        $full_category_tree->set_root_group_string('<ul class="dropdown-menu multi-level nav">',
            '</ul>');
        $full_category_tree->set_child_with_subcats_string('<li class="dropdown-submenu">',
            '</li>');
        $full_category_tree->setFollowCategoryPath(false);
        $full_category_tree->setParentGroupString('<ul class="dropdown-menu nav">',
            '</ul>', false);
