...
class cm_nb_account
{
    ...
    function __construct()
    {
        ...
        if (defined('MODULE_CONTENT_NAVBAR_ACCOUNT_STATUS')) {
            ...
            $this->side       = ((MODULE_CONTENT_NAVBAR_ACCOUNT_CONTENT_PLACEMENT
                === 'left') ? 'left' : 'right');
        }
    }
    ...
    public function install()
    {
        ...
        tep_db_query("insert into ".TABLE_CONFIGURATION." (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_CONTENT_NAVBAR_ACCOUNT_SORT_ORDER', '9220', 'Sort order of display. Lowest is displayed first.', '6', '2', now())");
