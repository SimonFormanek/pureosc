...
class cm_nb_home
{
    ...
    function __construct()
    {
        ...
        if (defined('MODULE_CONTENT_NAVBAR_HOME_STATUS')) {
            ...
            $this->side       = ((MODULE_CONTENT_NAVBAR_HOME_CONTENT_PLACEMENT === 'left')
                    ? 'left' : 'right');
        }
    }
    ...
    public function install()
    {
        ...
        tep_db_query("insert into ".TABLE_CONFIGURATION." (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_CONTENT_NAVBAR_HOME_SORT_ORDER', '9100', 'Sort order of display. Lowest is displayed first.', '6', '2', now())");
