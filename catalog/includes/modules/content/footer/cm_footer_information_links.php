...
class cm_footer_information_links
{
    ...
    function cm_footer_information_links()
    {
        ...
        $this->title       = _('Information Links Block');
        $this->description = _('Adds Information Links Block to the Footer Area of your site');
    ...
    function execute()
    {
        ...
        $aLinks = GetArticleLinsByTopic('Information');
        /*         * * End Article Manager *** */
    ...
    function keys()
    {
        return array('MODULE_CONTENT_FOOTER_INFORMATION_STATUS', 'MODULE_CONTENT_FOOTER_INFORMATION_CONTENT_WIDTH',
