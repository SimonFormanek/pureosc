...
class cm_header_breadcrumb
{
    ...
    function cm_header_breadcrumb()
    {
        ...
        $this->title       = _('Breadrcumb');
        $this->description = _('Adds a Breadrcumb Trail into the Header Area of your site.');
    ...
    function keys()
    {
        return array('MODULE_CONTENT_HEADER_BREADCRUMB_STATUS', 'MODULE_CONTENT_HEADER_BREADCRUMB_CONTENT_WIDTH',
