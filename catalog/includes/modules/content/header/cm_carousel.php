...
// Set the banner rotator code to display on the front page
        ...
        if (tep_db_num_rows($banner_query) > 0) {
          ...
          $background = $this->createImage(MODULE_FRONT_PAGE_BANNER_ROTATOR_IMG_WIDTH, MODULE_FRONT_PAGE_BANNER_ROTATOR_IMG_HEIGHT, 255, 255, 255);
          ...
          while ($banner = tep_db_fetch_array($banner_query)) {
            ...
            if ($banner['banners_image'] !== '') {
              //$wrapper_slides .= tep_image(DIR_WS_IMAGES . $banner['banners_image'], $banner['banners_html_text']);
              $wrapper_slides .= tep_image(DIR_WS_IMAGES . $banner['banners_image'], '', MODULE_FRONT_PAGE_BANNER_ROTATOR_IMG_WIDTH, MODULE_FRONT_PAGE_BANNER_ROTATOR_IMG_HEIGHT);
