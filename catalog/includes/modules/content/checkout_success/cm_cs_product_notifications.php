...
class cm_cs_product_notifications
{
    ...
    function cm_cs_product_notifications()
    {
        ...
        if (defined('MODULE_CONTENT_CHECKOUT_SUCCESS_PRODUCT_NOTIFICATIONS_STATUS')) {
            ...
            $this->enabled    = (MODULE_CONTENT_CHECKOUT_SUCCESS_PRODUCT_NOTIFICATIONS_STATUS
                == 'True');
        }
    }
            ...
            if ($global['global_product_notifications'] != '1') {
                ...
                while ($products       = tep_db_fetch_array($products_query)) {
                    if (!isset($products_displayed[$products['products_id']])) {
                        $products_displayed[$products['products_id']] = '<div class="checkbox"><label> '.tep_draw_checkbox_field('notify[]',
                                $products['products_id']).' '.$products['products_name'].'</label></div>';
                    }
                }
    ...
    function keys()
    {
        return array('MODULE_CONTENT_CHECKOUT_SUCCESS_PRODUCT_NOTIFICATIONS_STATUS',
