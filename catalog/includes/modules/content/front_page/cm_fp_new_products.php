...
class cm_fp_new_products
{
    ...
    function __construct()
    {
        ...
        $this->title       = _('Front Page New Products');
        $this->description = _('Show the new products block on the front page.');
    ...
    private function get_data()
    {
        ...
        if ((!isset($current_category_id)) || ($current_category_id == '0')) {
            ...
            $new_products_query_raw = $this->query_string_single_category($languages_id,
                $current_category_id);
        }
    ...
    private function query_string_single_category($languages_id,
                                                  $current_category_id)
    {
        $new_products_query_raw = "
        select 
