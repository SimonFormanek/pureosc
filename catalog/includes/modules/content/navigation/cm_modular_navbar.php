            ...
            foreach ($navbar_array as $navbar_element) {
                ...
                if ($dir === 'navbar') {
                    ...
                    if (!class_exists($class)) {
                        $localizator = cfg('DIR_WS_LANGUAGES') . $language . '/modules/content/navbar/' . $class . '.php';
                        if (file_exists($localizator)) {
                            include_once $localizator;
                        }
                    }
                    ...
                    if (class_exists($class)) {
                        ...
                        \Ease\Shared::singleton()->addStatusMessage( sprintf( _('Class %s not found'), $class ),'error') ;
                    }
                }
            }
