...
// javascript messages
define('JS_ERROR',
    'Los errores se han producido durante el proceso de su formulario.\n\nPor favor realice las siguientes correcciones:\n\n',
    true);

define('JS_REVIEW_TEXT',
    '* Su \'Comentario\' debe tener al menos '.REVIEW_TEXT_MIN_LENGTH.' caracteres.\n',
    true);
define('JS_REVIEW_RATING', '* Debe evaluar el producto sobre el que opina.\n',
    true);

define('JS_ERROR_NO_PAYMENT_MODULE_SELECTED',
    '* Por favor seleccione un m&eacute;todo de pago para su pedido.\n', true);

define('JS_ERROR_SUBMITTED',
    'Ya se ha enviado el formulario. Pulse Aceptar y espere a que termine el proceso.',
    true);

define('ERROR_NO_PAYMENT_MODULE_SELECTED',
    'Por favor seleccione un m&eacute;todo de pago para su pedido.', true);
...
define('ENTRY_FIRST_NAME_ERROR',
    'Su Nombre debe contener un mínimo de '.ENTRY_FIRST_NAME_MIN_LENGTH.' caracteres.',
    true);
define('ENTRY_FIRST_NAME_TEXT', '', true);
define('ENTRY_LAST_NAME', 'Apellido:', true);
define('ENTRY_LAST_NAME_ERROR',
    'Su Apellido debe contener un m&iacute;nimo de '.ENTRY_LAST_NAME_MIN_LENGTH.' caracteres.',
    true);
...
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR',
    'Su Correo Electr&oacute;nico no parece ser v&aacute;lido - por favor realice los cambios necesarios.',
    true);
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS',
    'Su direcci&oacute;n de correo electr&oacute;nico ya existe en nuestros registros - Por favor, inicie sesi&oacute;n con la direcci&oacute;n de correo electr&oacute;nico o cree una cuenta con una direcci&oacute;n de correo diferente.',
    true);
define('ENTRY_EMAIL_ADDRESS_TEXT', '', true);
define('ENTRY_STREET_ADDRESS', 'Direcci&oacute;n:', true);
define('ENTRY_STREET_ADDRESS_ERROR',
    'Su direcci&oacute;n debe contener un m&iacute;nimo de '.ENTRY_STREET_ADDRESS_MIN_LENGTH.' caracteres.',
    true);
...
define('ENTRY_POST_CODE_ERROR',
    'Su C&oacute;digo postal debe contener un m&iacute;nimo de '.ENTRY_POSTCODE_MIN_LENGTH.' caracteres.',
    true);
define('ENTRY_POST_CODE_TEXT', '', true);
define('ENTRY_CITY', 'Ciudad:', true);
define('ENTRY_CITY_ERROR',
    'Su Ciudad debe contener un m&iacute;nimo de '.ENTRY_CITY_MIN_LENGTH.' caracteres.',
    true);
define('ENTRY_CITY_TEXT', '', true);
define('ENTRY_STATE', 'Estado/Provincia:', true);
define('ENTRY_STATE_ERROR',
    'Su Estado/provincia debe contener un m&iacute;nimo de '.ENTRY_STATE_MIN_LENGTH.' caracteres.',
    true);
define('ENTRY_STATE_ERROR_SELECT',
    'Por favor, elija un estado/provincia de los Estados en el men&uacute; desplegable.',
    true);
define('ENTRY_STATE_TEXT', '', true);
define('ENTRY_COUNTRY', 'Pa&iacute;s:', true);
define('ENTRY_COUNTRY_ERROR',
    'Debe seleccionar un pa&iacute;s de la lista de Pa&iacute;ses del men&uacute; desplegable.',
    true);
...
define('ENTRY_TELEPHONE_NUMBER_ERROR',
    'Su n&uacute;mero de tel&eacute;fono debe contener un m&iacute;nimo de '.ENTRY_TELEPHONE_MIN_LENGTH.' caracteres.',
    true);
...
define('ENTRY_PASSWORD_ERROR',
    'Su contrase&ntilde;a debe contener un m&iacute;nimo de '.ENTRY_PASSWORD_MIN_LENGTH.' caracteres.',
    true);
define('ENTRY_PASSWORD_ERROR_NOT_MATCHING',
    'La confirmaci&oacute;n de la contrase&ntilde;a debe ser igual a su contrase&ntilde;a.',
    true);
define('ENTRY_PASSWORD_TEXT', '', true);
define('ENTRY_PASSWORD_CONFIRMATION',
    'Confirmaci&oacute;n de Contrase&ntilde;a:', true);
...
define('ENTRY_PASSWORD_NEW_ERROR',
    'Su nueva contrase&ntilde;a debe contener un m&iacute;nimo de '.ENTRY_PASSWORD_MIN_LENGTH.' caracteres.',
    true);
define('ENTRY_PASSWORD_NEW_ERROR_NOT_MATCHING',
    'La confirmaci&oacute;n de la contrase&ntilde;a debe ser igual a su nueva contrase&ntilde;a.',
    true);
...
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> productos)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_ORDERS',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> pedidos)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_REVIEWS',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> comentarios)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> productos nuevos)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_SPECIALS',
    'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> ofertas)',
    true);
...
define('PREVNEXT_TITLE_PREV_SET_OF_NO_PAGE',
    'Grupo anterior de P&aacute;ginas %d', true);
define('PREVNEXT_TITLE_NEXT_SET_OF_NO_PAGE',
    'Grupo siguiente de P&aacute;ginas %d', true);
...
define('TEXT_GREETING_PERSONAL',
    'Bienvenido de nuevo <span class="greetUser">%s!</span> Le gustar&iacute;a ver que <a href="%s"><u>nuevos productos</u></a> hay disponibles para comprar ?',
    true);
define('TEXT_GREETING_PERSONAL_RELOGON',
    '<small>Si no es %s, por favor <a href="%s"><u>ingrese aqu&iacute;</u></a> con su cuenta e introduzca sus datos.</small>',
    true);
...
define('ERROR_TEP_MAIL',
    '<font face="Verdana, Arial" size="2" color="#ff0000"><strong><small>TEP ERROR:</small> No se puede enviar el correo electr&oacute;nico a trav&eacute;s del servidor SMTP especificado. Por favor, compruebe la configuraci&oacute;n del archivo php.ini y corregir el servidor SMTP si es necesario.</strong></font>',
    true);

define('TEXT_CCVAL_ERROR_INVALID_DATE',
    'La fecha de caducidad de la tarjeta de cr&eacute;dito no es v&aacute;lida. Por favor, compruebe la fecha y vuelva a intentarlo.',
    true);
define('TEXT_CCVAL_ERROR_INVALID_NUMBER',
    'El n&uacute;mero de tarjeta de cr&eacute;dito no es v&aacute;lida. Por favor, compruebe el n&uacute;mero y vuelva a intentarlo.',
    true);
define('TEXT_CCVAL_ERROR_UNKNOWN_CARD',
    'Los primeros cuatro d&iacute;gitos del n&uacute;mero de introducir son: %s. Si ese n&uacute;mero es correcto, no aceptamos este tipo de tarjetas de cr&eacute;dito. Si es incorrecto, por favor, int&eacute;ntelo de nuevo.',
    true);
define('FOOTER_TEXT_BODY',
    'Copyright &copy; '.date('Y').' <a href="'.tep_href_link(FILENAME_DEFAULT).'">'.STORE_NAME.'</a><br />Powered by <a href="http://www.oscommerce.com" target="_blank">osCommerce</a>',
    true);
