...
define('ERROR_NO_PAYMENT_MODULE_SELECTED',
    'Bitte wählen Sie eine Zahlungsweise für Ihre Bestellung.', true);
...
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR',
    'Die eMail Adresse scheint nicht gültig zu sein - bitte korrigieren.', true);
...
define('ENTRY_STATE_ERROR_SELECT',
    'Bitte wählen Sie ein Bundesland aus der Liste.', true);
...
define('ENTRY_PASSWORD_ERROR_NOT_MATCHING',
    'Beide eingegebenen Passwörter müssen identisch sein.', true);
