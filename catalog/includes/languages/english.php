...
define('HEADER_TITLE_TOP',
    '<i class="fa fa-home"><span class="sr-only">Home</span></i>', true);
...
define('JS_REVIEW_TEXT',
    '* The \'Review Text\' must have at least '.REVIEW_TEXT_MIN_LENGTH.' characters.\n',
    true);
...
define('ENTRY_FIRST_NAME_ERROR',
    'Your First Name must contain a minimum of '.ENTRY_FIRST_NAME_MIN_LENGTH.' characters.',
    true);
define('ENTRY_FIRST_NAME_TEXT', '', true);
define('ENTRY_LAST_NAME', 'Last Name', true);
define('ENTRY_LAST_NAME_ERROR',
    'Your Last Name must contain a minimum of '.ENTRY_LAST_NAME_MIN_LENGTH.' characters.',
    true);
...
define('ENTRY_EMAIL_ADDRESS_ERROR',
    'Your E-Mail Address must contain a minimum of '.ENTRY_EMAIL_ADDRESS_MIN_LENGTH.' characters.',
    true);
...
define('ENTRY_STREET_ADDRESS_ERROR',
    'Your Street Address must contain a minimum of '.ENTRY_STREET_ADDRESS_MIN_LENGTH.' characters.',
    true);
...
define('ENTRY_POST_CODE_ERROR',
    'Your Post Code must contain a minimum of '.ENTRY_POSTCODE_MIN_LENGTH.' characters.',
    true);
define('ENTRY_POST_CODE_TEXT', '', true);
define('ENTRY_CITY', 'City', true);
define('ENTRY_CITY_ERROR',
    'Your City must contain a minimum of '.ENTRY_CITY_MIN_LENGTH.' characters.',
    true);
...
define('ENTRY_TELEPHONE_NUMBER_ERROR',
    'Your Telephone Number must contain a minimum of '.ENTRY_TELEPHONE_MIN_LENGTH.' characters.',
    true);
...
define('ENTRY_PASSWORD_ERROR',
    'Your Password must contain a minimum of '.ENTRY_PASSWORD_MIN_LENGTH.' characters.',
    true);
define('ENTRY_PASSWORD_ERROR_NOT_MATCHING',
    'The Password Confirmation must match your Password.', true);
...
define('ENTRY_PASSWORD_NEW_ERROR',
    'Your new Password must contain a minimum of '.ENTRY_PASSWORD_MIN_LENGTH.' characters.',
    true);
define('ENTRY_PASSWORD_NEW_ERROR_NOT_MATCHING',
    'The Password Confirmation must match your new Password.', true);
...
define('TEXT_DISPLAY_NUMBER_OF_REVIEWS',
    'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> reviews)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW',
    'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> new products)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_SPECIALS',
    'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> specials)',
    true);
...
define('TEXT_GREETING_PERSONAL',
    'Welcome back <span class="greetUser">%s!</span> Would you like to see which <a href="%s"><u>new products</u></a> are available to purchase?',
    true);
define('TEXT_GREETING_PERSONAL_RELOGON',
    '<small>If you are not %s, please <a href="%s"><u>log yourself in</u></a> with your account information.</small>',
    true);
...
define('FORM_REQUIRED_INFORMATION',
    '<span class="fa fa-asterisk inputRequirement"></span> Required information',
    true);
define('FORM_REQUIRED_INPUT',
    '<span><span class="fa fa-asterisk form-control-feedback inputRequirement"></span></span>',
    true);

// reviews
define('REVIEWS_TEXT_RATED',
    'Rated %s by <cite title="%s" itemprop="reviewer">%s</cite>', true);
define('REVIEWS_TEXT_AVERAGE',
    'Average rating based on <span itemprop="count">%s</span> review(s) %s',
    true);
...
define('PRODUCT_UNSUBSCRIBED',
    '%s has been removed from your Notification List', true);
...
define('HEADER_CART_CONTENTS',
    '<i class="glyphicon glyphicon-shopping-cart"></i> %s item(s) <span class="caret"></span>',
    true);
define('HEADER_CART_NO_CONTENTS',
    '<i class="glyphicon glyphicon-shopping-cart"></i> 0 items', true); //pure:static version needed clickable statc cart if you go back to generated page - no idea about cart contents
define('HEADER_ACCOUNT_LOGGED_OUT',
    '<i class="glyphicon glyphicon-user"></i><span class="hidden-sm"> My Account</span> <span class="caret"></span>',
    true);
...
define('HEADER_WHATS_NEW',
    '<i class="glyphicon glyphicon-certificate"></i><span class="hidden-sm">  New Products</span>',
    true);
define('HEADER_SPECIALS',
    '<i class="glyphicon glyphicon-fire"></i><span class="hidden-sm"> Special Offers</span>',
    true);
define('HEADER_REVIEWS',
    '<i class="glyphicon glyphicon-comment"></i><span class="hidden-sm"> Reviews</span>',
    true);
// header dropdowns
define('HEADER_ACCOUNT_LOGIN',
    '<i class="glyphicon glyphicon-log-in"></i> Log In', true);
define('HEADER_ACCOUNT_LOGOFF',
    '<i class="glyphicon glyphicon-log-out"></i> Log Off', true);
...
define('GV_HAS_VOUCHERA',
    'You have funds in your Gift Voucher Account. If you want <br>                           you can send those funds by <a class="pageResults" href="',
    true);
define('GV_HAS_VOUCHERB', '"><b>email</b></a> to someone', true);
define('ENTRY_AMOUNT_CHECK_ERROR',
    'You do not have enough funds to send this amount.', true);
