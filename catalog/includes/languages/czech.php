...
define('HEADER_TITLE_TOP',
    '<i class="glyphicon glyphicon-home"><span class="sr-only">shop-name.domain</span></i>',
    true);
...
define('JS_REVIEW_TEXT',
    '* The \'Review Text\' musí mít nejméně '.REVIEW_TEXT_MIN_LENGTH.' znaků.\n',
    true);
...
define('JS_ERROR_SUBMITTED',
    'Formulář může být odeslán. Zmáčkněte Ok a vyčkejte.', true);

define('ERROR_NO_PAYMENT_MODULE_SELECTED',
    'Vyberte způsob platby Vaší objednávky.', true);
...
define('ENTRY_EMAIL_ADDRESS_ERROR',
    'E-Mail musí mít nejméně '.ENTRY_EMAIL_ADDRESS_MIN_LENGTH.' znaků.', true);
...
define('ENTRY_STREET_ADDRESS_ERROR',
    'Ulice musí mít nejméně '.ENTRY_STREET_ADDRESS_MIN_LENGTH.' znaků.', true);
...
define('ENTRY_POST_CODE_ERROR',
    'PSČ musí mít nejméně '.ENTRY_POSTCODE_MIN_LENGTH.' znaků.', true);
define('ENTRY_POST_CODE_TEXT', '', true);
define('ENTRY_CITY', 'Město:', true);
define('ENTRY_CITY_ERROR',
    'Město musí mít nejméně '.ENTRY_CITY_MIN_LENGTH.' znaků.', true);
define('ENTRY_CITY_TEXT', '', true);
define('ENTRY_STATE', 'Stát:', true);
define('ENTRY_STATE_ERROR',
    'Stát musí mít nejméně '.ENTRY_STATE_MIN_LENGTH.' znaků.', true);
define('ENTRY_STATE_ERROR_SELECT',
    'Please select a state from the States pull down menu.', true);
...
define('ENTRY_TELEPHONE_NUMBER_ERROR',
    'Telefonní číslo musí mít nejméně '.ENTRY_TELEPHONE_MIN_LENGTH.' znaků.',
    true);
...
define('ENTRY_PASSWORD_ERROR',
    'Vaše heslo musí mít nejméně '.ENTRY_PASSWORD_MIN_LENGTH.' znaků.', true);
...
define('ENTRY_PASSWORD_NEW_ERROR',
    'Vaše nové heslo musí mít nejméně '.ENTRY_PASSWORD_MIN_LENGTH.' znaků.',
    true);
...
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS',
    'Zobrazeno <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> produktů)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_ORDERS',
    'Zobrazeno <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> objednávek)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_REVIEWS',
    'Zobrazeno <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> hodnocení)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW',
    'Zobrazeno <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> novinek)',
    true);
define('TEXT_DISPLAY_NUMBER_OF_SPECIALS',
    'Zobrazeno <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> slev)',
    true);
...
define('IMAGE_BUTTON_IN_CART', 'přidat do košíku', true);
...
define('TEXT_GREETING_PERSONAL',
    'Vítejte zpět <span class="greetUser">%s!</span> Chcete se podívat jaké máme <a href="%s"><u>novinky</u></a> od Vašeho posledního nákupu?',
    true);
define('TEXT_GREETING_PERSONAL_RELOGON',
    '<small>Pokud ne, %s, prosíme <a href="%s"><u>přihlaste se</u></a> na váš účet.</small>',
    true);
define('TEXT_GREETING_GUEST',
    'Vítejte <span class="greetUser">návštěvníku!</span> Chcete se  <a href="%s"><u>přihlásit</u></a>? nebo teprve <a href="%s"><u>zaregistrovat</u></a>?',
    true);
...
define('ERROR_TEP_MAIL',
    '<font face="Verdana, Arial" size="2" color="#ff0000"><strong><small>TEP ERROR:</small> Cannot send the email through the specified SMTP server. Please check your php.ini setting and correct the SMTP server if necessary.</strong></font>',
    true);
...
define('TEXT_CCVAL_ERROR_UNKNOWN_CARD',
    'The first four digits of the number entered are: %s. If that number is correct, we do not accept that type of credit card. If it is wrong, please try again.',
    true);
...
define('FORM_REQUIRED_INFORMATION',
    '<span class="glyphicon glyphicon-asterisk inputRequirement"></span> Nutno vyplnit',
    true);
...
// reviews
define('REVIEWS_TEXT_RATED',
    'Hodnoceno %s s <cite title="%s" itemprop="recenzent">%s</cite>', true);
define('REVIEWS_TEXT_AVERAGE',
    'Hodnocení <span itemprop="počet">%s</span> recenzí %s', true);
define('REVIEWS_TEXT_TITLE', 'Co říkají naši zákazníci...', true);

// grid/list
define('TEXT_SORT_BY', 'Třídit podle ', true);
// moved from index
...
//header titles
define('HEADER_CART_CONTENTS',
    '<i class="glyphicon glyphicon-shopping-cart"></i> %s kusů<span class="caret"></span>',
    true);
define('HEADER_CART_NO_CONTENTS',
    '<i class="glyphicon glyphicon-shopping-cart"></i><span class="hidden-lg hidden-md hidden-sm"> košík</span><span class="caret"></span>',
    true); //pure:static version needed clickable statc cart if you go back to generated page - no idea about cart contents
define('HEADER_ACCOUNT_LOGGED_OUT',
    '<i class="glyphicon glyphicon-user"></i><span class="hidden-sm"> Můj účet</span> <span class="caret"></span>',
    true);
define('HEADER_ACCOUNT_LOGGED_IN',
    '<i class="glyphicon glyphicon-user"></i> %s <span class="caret"></span>',
    true);
define('HEADER_SITE_SETTINGS',
    '<i class="glyphicon glyphicon-cog"></i><span class="hidden-sm"> Site Settings</span> <span class="caret"></span>',
    true);
define('HEADER_TOGGLE_NAV', 'Toggle Navigation', true);
define('HEADER_HOME',
    '<i class="glyphicon glyphicon-home"></i><span class="hidden-sm"> Home</span>',
    true);
define('HEADER_WHATS_NEW',
    '<i class="glyphicon glyphicon-certificate"></i><span class="hidden-sm">  Nové zboží</span>',
    true);
define('HEADER_SPECIALS',
    '<i class="glyphicon glyphicon-fire"></i><span class="hidden-sm"> Speciální nabídky</span>',
    true);
define('HEADER_REVIEWS',
    '<i class="glyphicon glyphicon-comment"></i><span class="hidden-sm"> Hodnocení</span>',
    true);
// header dropdowns
define('HEADER_ACCOUNT_LOGIN',
    '<i class="glyphicon glyphicon-log-in"></i> Přihlásit', true);
define('HEADER_ACCOUNT_LOGOFF',
    '<i class="glyphicon glyphicon-log-out"></i> Odhlásit', true);
...
define('HEADER_ACCOUNT_REGISTER',
    '<i class="glyphicon glyphicon-pencil"></i> Registrace', true);
define('HEADER_CART_HAS_CONTENTS', '%s item(s), %s', true);
define('HEADER_CART_VIEW_CART', 'Košík', true);
define('HEADER_CART_CHECKOUT',
    '<i class="glyphicon glyphicon-chevron-right"></i> Pokladna', true);
define('USER_LOCALIZATION',
    '<abbr title="Vybraný jazyk">L:</abbr> %s <abbr title="Vybraná měna">C:</abbr> %s',
    true);
...
define('GV_HAS_VOUCHERA',
    'Máte finanční prostředky na vašem účtu dárkového poukazu. If you want <br>                           you can send those funds by <a class="pageResults" href="',
    true);
...
define('TEXT_DISPLAY_NUMBER_OF_ARTICLES',
    'Zobrazuji <b>%d</b> až <b>%d</b> (z <b>%d</b> článků)');
define('TEXT_DISPLAY_NUMBER_OF_ARTICLES_NEW',
    'Zobrazuji <b>%d</b> až <b>%d</b> (z <b>%d</b> nových článků)');
define('TEXT_ARTICLES',
    'Níže je seznam všech článků od nejnovějších k nejstarším.');
