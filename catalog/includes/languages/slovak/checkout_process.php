...
define('EMAIL_HEADER_TXT',
    'Vážený(á) zákazníku, děkujeme za Váš nákup.
...
define('EMAIL_WARNING',
    'POZNÁMKA: Vaše emailová adresa byla zadána návštěvníkem našeho online obchodu. Pokud jste u nás neobjednával(a), napšte nám prosím na tuto adresu:  '.STORE_OWNER_EMAIL_ADDRESS,
    true);
?>