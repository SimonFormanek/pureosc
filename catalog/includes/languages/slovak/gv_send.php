...
define('HEADING_TEXT',
    '<br>Vyžádejte si podrobnosti o dárkovém poukazu, který chcete poslat. Další informace naleznete na našich stránkách <a href="'.tep_href_link(FILENAME_GV_FAQ,
...
define('ERROR_ENTRY_AMOUNT_CHECK',
    '&nbsp;&nbsp;<span class="errorText">Neplatná částka</span>', true);
define('ERROR_ENTRY_EMAIL_ADDRESS_CHECK',
    '&nbsp;&nbsp;<span class="errorText">Neplatná emailová adresa</span>', true);
define('MAIN_MESSAGE',
    'Nyní můžete zaslat dárkový poukaz % na % tuto emailovou adresu %<br><br>Doplněný text<br><br>Vážený, Vážená %<br><br>
                        Bude vám zaslán dárkový poukaz % dle %');

define('PERSONAL_MESSAGE', '%s říká', true);
define('TEXT_SUCCESS', 'Blahopřejeme, Váš dárkový poukaz byl úspěšně odeslán.',
    true);
...
define('EMAIL_SEPARATOR',
    '----------------------------------------------------------------------------------------',
    true);
define('EMAIL_GV_TEXT_HEADER', 'Gratulujeme, obdrželi jste dárkový poukaz %',
    true);
...
define('EMAIL_GV_REDEEM',
    'Chcete-li uplatnit tento dárkový poukaz, klikněte na níže uvedený odkaz. Napište prosím i kód nákupu, který je %. V případě, že máte problémy,',
    true);
