...
define('TEXT_NO_ARTICLES', 'V tomto tématu nejsou momentálně žádné články.',
    true);
define('TEXT_NO_ARTICLES2',
    'Momentálně nejsou k dispozici žádné články od tohoto autora.', true);
define('TEXT_NO_ARTICLES_BLOG',
    'V současné době nejsou k dispozici žádné blogové články.', true);
...
if (($topic_depth == 'articles') || (isset($_GET['authors_id']))) {
    ...
    define('TEXT_MORE_INFORMATION',
        'Pro další informace navštivte tyto autory <a href="http://%s" target="_blank">web stránka</a>.',
        true);
    ...
    define('TEXT_ALL_ARTICLES',
        'Níže je seznam všech článků, nejnovější jsou uvedeny jako první.', true);
    ...
    define('TEXT_NO_ARTICLES', 'V současné době nejsou uvedeny žádné články.',
        true);
    define('TEXT_DATE_ADDED', 'Publikováno:', true);
