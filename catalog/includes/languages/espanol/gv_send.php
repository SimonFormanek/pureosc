...
define('HEADING_TEXT',
    '<br>Please enter below the details of the Gift Voucher you wish to send. For more information, please see our <a href="'.tep_href_link(FILENAME_GV_FAQ,
        '', 'NONSSL').'">'.GV_FAQ.'.</a><br>', true);
...
define('ERROR_ENTRY_AMOUNT_CHECK',
    '&nbsp;&nbsp;<span class="errorText">Invalid Amount</span>', true);
define('ERROR_ENTRY_EMAIL_ADDRESS_CHECK',
    '&nbsp;&nbsp;<span class="errorText">Invalid Email Address</span>', true);
define('MAIN_MESSAGE',
    'You have decided to post a gift voucher worth %s to %s who\'s email address is %s<br><br>The text accompanying the email will read<br><br>Dear %s<br><br>
                        You have been sent a Gift Voucher worth %s by %s');

define('PERSONAL_MESSAGE', '%s says', true);
define('TEXT_SUCCESS',
    'Congratulations, your Gift Voucher has successfully been sent', true);


define('EMAIL_SEPARATOR',
    '----------------------------------------------------------------------------------------',
    true);
define('EMAIL_GV_TEXT_HEADER',
    'Congratulations, You have received a gift voucher worth %s', true);
...
define('EMAIL_GV_REDEEM',
    'To redeem this Gift Voucher, please click on the link below. Please also write down the redemption code which is %s. In case you have problems.',
    true);
...
define('EMAIL_GV_FIXED_FOOTER',
    'If you are have problems redeeming the Gift Voucher using the automated link above, '."\n".
