...
*/
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_CC_SIM_TEXT_TITLE', 'Authorize.net Tarjeta de Cr&eacute;dito SIM',true);
  define('MODULE_PAYMENT_AUTHORIZENET_CC_SIM_TEXT_PUBLIC_TITLE', 'Tarjeta de Cr&eacute;dito (Procesado por Authorize.net)',true);
  define('MODULE_PAYMENT_AUTHORIZENET_CC_SIM_TEXT_DESCRIPTION', '<img src="images/icon_popup.gif" border="0">&nbsp;<a href="https://www.authorize.net" target="_blank" style="text-decoration: underline; font-weight: bold;">Visite el Sitio Wev de Authorize.net</a>',true);
  define('MODULE_PAYMENT_AUTHORIZENET_CC_SIM_ERROR_TITLE', 'Se ha producido un error al procesar su tarjeta de cr&eacute;dito',true);
