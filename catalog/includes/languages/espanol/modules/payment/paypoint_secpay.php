...
*/
  ...
  define('MODULE_PAYMENT_PAYPOINT_SECPAY_TEXT_TITLE', 'PayPoint.net SECPay',true);
  define('MODULE_PAYMENT_PAYPOINT_SECPAY_TEXT_PUBLIC_TITLE', 'Tarjeta de Cr&eacute;dito',true);
  define('MODULE_PAYMENT_PAYPOINT_SECPAY_TEXT_DESCRIPTION', 'Informaci&oacute;n de Prueba de la Tarjeta de Cr&eacute;dito:<br /><br />CC#: 4444333322221111<br />Caducidad: Cualquiera',true);
  define('MODULE_PAYMENT_PAYPOINT_SECPAY_TEXT_ERROR', 'Error en la Tarjeta de Cr&eacute;dito!',true);
