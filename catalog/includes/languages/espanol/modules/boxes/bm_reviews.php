...
*/
  ...
  define('MODULE_BOXES_REVIEWS_TITLE', 'Comentarios',true);
  define('MODULE_BOXES_REVIEWS_DESCRIPTION', 'Mostrar comentarios',true);
  define('MODULE_BOXES_REVIEWS_BOX_TITLE', 'Comentarios',true);
