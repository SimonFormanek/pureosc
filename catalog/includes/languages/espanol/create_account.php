...
define('NAVBAR_TITLE', 'Crear una Cuenta', true);

define('HEADING_TITLE', 'Información de Mi Cuenta', true);

define('TEXT_ORIGIN_LOGIN',
    '<font color="#FF0000"><small><strong>NOTA:</strong></font></small> Si ya tiene una cuenta con nosotros, por favor use esta página para <a href="%s"><u>Ingresar</u></a>.',
    true);
