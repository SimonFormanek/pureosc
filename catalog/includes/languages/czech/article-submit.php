...
define('TEXT_ARTICLE_SUBMIT', 'Odešlete svůj článek zde. Bude zhodnocen, a pokud bude schválen, bude do 48 hodin publikován.');
define('TEXT_MAIN', '');
define('TEXT_ARTICLE_NAME', 'Název článku:');
define('TEXT_ARTICLE_PLACEMENT', 'Umístění:');
define('TEXT_ARTICLE_SUBMITTED', 'Blahopřejeme! Váš příspěvek byl úspěšně odeslán.');
...
define('ARTICLES_EMAIL_TEXT_BODY', 'Článek byl odeslán %s s názvem %s v %s kategorii.');
...
define('ERROR_FAILED_IMAGE_INVALID', 'Špatný typ obrázku. Pouze gif\'s, jpg\'s a png\ je správně.');
