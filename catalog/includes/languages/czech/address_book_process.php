...
define('DELETE_ADDRESS_DESCRIPTION', 'Chcete opravdu smazat vybranou adresu?',true);
...
define('SUCCESS_ADDRESS_BOOK_ENTRY_DELETED', 'Vybraná adresa byla vymazána.',true);
define('SUCCESS_ADDRESS_BOOK_ENTRY_UPDATED', 'Váš adresář byl úspěšně aktualizován.',true);

define('WARNING_PRIMARY_ADDRESS_DELETION', 'Hlavní adresu nelze smazat. Nastavte jinou jako výchozí a pokračujte.',true);

define('ERROR_NONEXISTING_ADDRESS_BOOK_ENTRY', 'Tato adresa v adresáři není.',true);
define('ERROR_ADDRESS_BOOK_FULL', 'Váš adresář je plný. Smažte některou nepoužívanou adresu a potom přidejte novou.',true);
?>
