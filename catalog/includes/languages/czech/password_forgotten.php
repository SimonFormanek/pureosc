...
define('TEXT_MAIN', 'Zapomněl(a) jste heslo? Vložte svou e-mailovou adresu, která byla zadána při registraci a my Vám pošleme nové.',true);

define('TEXT_PASSWORD_RESET_INITIATED', 'Ve vaší e-mailové schránce naleznete pokyny, jak změnit heslo. V mailu naleznete odkaz, který je platný pouze po dobu 24 hodin nebo dokud nebude vaše heslo aktualizováno.',true);
