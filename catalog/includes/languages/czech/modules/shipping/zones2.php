...
define('MODULE_SHIPPING_ZONES2_TEXT_TITLE', 'Zone Based Express Shipping Rates');
define('MODULE_SHIPPING_ZONES2_TEXT_DESCRIPTION', 'Zone Based Rates Express');
define('MODULE_SHIPPING_ZONES2_TEXT_WAY', 'Air'); //no longer used
