...
*/
  ...
  define('MODULE_PAYMENT_SAGE_PAY_FORM_TEXT_PUBLIC_TITLE', 'Credit Card or Bank Card (Processed by Sage Pay)',true);
  ...
  define('MODULE_PAYMENT_SAGE_PAY_FORM_ERROR_ADMIN_MCRYPT', 'This module requires Mcrypt to be enabled in PHP and will not load until it has been enabled on this webserver.',true);
  define('MODULE_PAYMENT_SAGE_PAY_FORM_ERROR_ADMIN_CONFIGURATION', 'This module will not load until the Vendor Login Name and Encryption Password parameters have been configured. Please edit and configure the settings of this module.',true);
