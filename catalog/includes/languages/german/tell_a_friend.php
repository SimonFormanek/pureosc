...
define('FORM_TITLE_FRIEND_MESSAGE', 'Ihre Nachricht (wird mit der Empfehlung versendet)',true);
...
define('TEXT_EMAIL_SUCCESSFUL_SENT', 'Ihre eMail über <b>%s</b> wurde gesendet an <b>%s</b>.',true);

define('TEXT_EMAIL_SUBJECT', 'Ihr Freund %s, hat dieses Produkt gefunden, und zwar hier: %s',true);
define('TEXT_EMAIL_INTRO', 'Hallo %s!' . "\n\n" . 'Ihr Freund, %s, hat dieses Produkt %s bei %s gefunden.',true);
...
define('ERROR_TO_ADDRESS', 'Fehler: Die Empfänger-Email-Adresse darf nicht leer sein.',true);
define('ERROR_FROM_NAME', 'Fehler: Der Absendername (Ihr Name) muss angegeben werden.',true);
define('ERROR_FROM_ADDRESS', 'Fehler: Die Absenderadresse muss eine gültige Mail-Adresse sein.',true);
define('ERROR_ACTION_RECORDER', 'Fehler: Es wurde bereits einen E-Mail verschickt. Versuchen Sie es in %s minuten noch einmal.',true);
?>
