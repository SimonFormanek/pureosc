...
define('TEXT_INFORMATION',
    'For more information regarding Gifr Vouchers, please see our <a href="'.tep_href_link(FILENAME_GV_FAQ,
...
define('TEXT_VALID_GV',
    'Congratulations, you have redeemed a Gift Voucher worth %s', true);
?>