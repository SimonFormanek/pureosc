...
define('TEXT_SEARCH_HELP_LINK', '<span class="fa fa-info-circle"></span> Search Help',true);
...
define('ERROR_PRICE_TO_LESS_THAN_PRICE_FROM', 'Price To must be greater than or equal to Price From.',true);
