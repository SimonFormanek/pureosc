...
if (($category_depth == 'top') && (!isset($_GET['manufacturers_id']))) {
    ...
    define('META_SEO_DESCRIPTION',
        'This is the description of your site to be used in the META Description Element',
        true);
    /*
    ...
    define('META_SEO_KEYWORDS',
        'these, are, the, comma, separated, keywords, used in the META keywords Element',
        true);
}
