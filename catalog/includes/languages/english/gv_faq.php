...
switch ($_GET['faq_item']) {
    case '1':
        ...
        define('SUB_HEADING_TEXT',
            'Gift Vouchers are purchased just like any other item in our store. You can 
  ...
  link to a page where you can send the Gift Voucher to someone via email.');
    ...
    case '2':
        ...
        define('SUB_HEADING_TEXT',
            'To send a Gift Voucher you need to go to our Send Gift Voucher Page. You can 
  ...
  the email is actually sent.');
    ...
    case '3':
        ...
        define('SUB_HEADING_TEXT',
            'If you have funds in your Gift Voucher Account, you can use those funds to 
...
there will be a tick box and button to redeem your Gift Voucher balance against that purchase.');
  ...
  as much information as possible in the email. ');
    ...
    default:
        ...
        define('SUB_HEADING_TEXT',
            'Please choose from one of the questions above.', true);
}
?>