...
*/
  ...
  define('MODULE_BOXES_PRODUCT_NOTIFICATIONS_TITLE', 'Product Notifications',true);
  define('MODULE_BOXES_PRODUCT_NOTIFICATIONS_DESCRIPTION', 'Show product notifications on the product information page',true);
