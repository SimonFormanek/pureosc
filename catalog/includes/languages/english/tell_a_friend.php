...
define('TEXT_EMAIL_SUCCESSFUL_SENT',
    'Your email about <strong>%s</strong> has been successfully sent to <strong>%s</strong>.',
    true);

define('TEXT_EMAIL_SUBJECT',
    'Your friend %s has recommended this great product from %s', true);
...
define('ERROR_TO_ADDRESS',
    'Error: Your friends e-mail address must be a valid e-mail address.', true);
define('ERROR_FROM_NAME', 'Error: Your name must not be empty.', true);
define('ERROR_FROM_ADDRESS',
    'Error: Your e-mail address must be a valid e-mail address.', true);
define('ERROR_ACTION_RECORDER',
    'Error: An e-mail has already been sent. Please try again in %s minutes.',
    true);
/*
 * ***********************************************************************
