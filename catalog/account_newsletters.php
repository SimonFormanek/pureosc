...
if (isset($_POST['action']) && ($_POST['action'] == 'process')
    ...
    if ($newsletter_general != $newsletter['customers_newsletter']) {
        $newsletter_general = (($newsletter['customers_newsletter'] == '1') ? '0'
                : '1');
...
$breadcrumb->add(NAVBAR_TITLE_2,
    tep_href_link(FILENAME_ACCOUNT_NEWSLETTERS, '', 'SSL'));
...
<?php echo tep_draw_form('account_newsletter',
    tep_href_link(FILENAME_ACCOUNT_NEWSLETTERS, '', 'SSL'), 'post',
    ...
    <div class="contentText">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <div class="checkbox">
                    <label>
<?php echo tep_draw_checkbox_field('newsletter_general', '1',
