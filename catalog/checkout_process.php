...
for ($i = 0, $n = sizeof($order_totals); $i < $n; $i++) {
    $sql_data_array = array('orders_id' => $insert_id,
        ...
        'value' => str_replace(',', '.', $order_totals[$i]['value']),
...
if (isset($mail_manager_status['status']) && ($mail_manager_status['status'] == '1')) {
    ...
    $attachArr = array('obchodni-podminky.pdf' => 'pub/obchodni-podminky.pdf', 'navratovy-reklamacni-list.pdf' => 'pub/navratovy-reklamacni-list.pdf',
 ...
 */
tep_session_is_registered('customer_is_guest') ? tep_redirect(tep_href_link('checkout_success_pwa.php',
