...
if (tep_session_is_registered('credit_covers'))
        tep_session_unregister('credit_covers');  //CCGV  
...
<div class="page-header">
    ...
    <?php echo tep_draw_form('checkout_payment',
...
<?php
if (isset($HTTP_GET_VARS['payment_error']) && is_object(${$HTTP_GET_VARS['payment_error']})
...
<?php echo tep_address_label($customer_id, $billto, true, ' ',
    ...
    if (sizeof($selection) > 1) {
        echo tep_draw_radio_field('payment', $selection[$i]['id'],
            ($selection[$i]['id'] == $payment), 'required aria-required="true"');
    } else {
