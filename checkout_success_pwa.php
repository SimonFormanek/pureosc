...
<div class="contentContainer">
  ...
  <div class="panel-body">
    ...
    <p><?php echo sprintf(TEXT_CONTACT_STORE_OWNER, tep_href_link(FILENAME_CONTACT_US)); ?></p>
  </div>
</div>
...
<div class="contentContainer">
  <div class="buttonSet">
    <div class="text-right"><?php echo tep_draw_button(IMAGE_BUTTON_CONTINUE, 'glyphicon glyphicon-chevron-right', tep_href_link(FILENAME_DEFAULT), 'primary', null, 'btn-success'); ?></div>
  </div>
</div>
</div>
