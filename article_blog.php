...
?>
  ...
  <div class="contentText">
    ...
    <div class="articlePadding">
        ...
        <div class="smallText"><?php echo tep_draw_textarea_field('blog_comment', 'soft', 40, 5, '', '', false); ?></div>
        <div class="smallText"><?php echo tep_db_num_rows($comments_query) . ' ' . (tep_db_num_rows($comments_query) > 1 ? TEXT_TOTAL_COMMENTS : TEXT_TOTAL_COMMENT); ?></div>
        <div class="smallText" align="right"><?php echo tep_draw_hidden_field('article_name', $articles_name) . 
        tep_draw_button(IMAGE_BUTTON_SUBMIT, 'arrowreturnthick-1-n', null, 'primary', null, 'btn-success'); //pure:bugfix:articles tep_draw_button ?></div>
    </div>
    </form>
