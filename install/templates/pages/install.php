    ...
    <div class="col-xs-12 col-sm-push-3 col-sm-9">
        ...
        <form name="install" id="installForm" action="install.php?step=2" method="post" class="form-horizontal" role="form">
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-xs-9">
                    <?php echo osc_draw_input_field('DB_SERVER',
                        NULL,
                        'required aria-required="true" id="dbServer" placeholder="localhost"'); ?>
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-xs-9">
<?php echo osc_draw_input_field('DB_SERVER_USERNAME', NULL,
    'required aria-required="true" id="userName" placeholder="Username"'); ?>
                    <span class="fa fa-asterisk form-control-feedback inputRequirement"></span>
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-xs-9">
<?php echo osc_draw_password_field('DB_SERVER_PASSWORD', NULL,
    'required aria-required="true" id="passWord"'); ?>
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-xs-9">
<?php echo osc_draw_input_field('DB_DATABASE', NULL,
    'required aria-required="true" id="dbName" placeholder="Database"'); ?>
                    <span class="fa fa-asterisk form-control-feedback inputRequirement"></span>
                    <span class="help-block">The name of the database to hold the data in.</span>
                </div>
            </div>

            <p><?php echo osc_draw_button('Continue To Step 2', 'triangle-1-e',
    null, 'primary', null, 'btn-success btn-block'); ?></p>
