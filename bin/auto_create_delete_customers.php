...
tep_db_connect(DB_SERVER, DB_SERVER_USERNAME_ROOT, DB_SERVER_PASSWORD_ROOT) or die('Unable to connect: DB_SERVER_USERNAME_ROOT, DB_SERVER_PASSWORD_ROOT(?)');

$configuration_query = tep_db_query('select configuration_key as cfgKey, configuration_value as cfgValue from ' . TABLE_CONFIGURATION);
while ($configuration = tep_db_fetch_array($configuration_query)) {
    define($configuration['cfgKey'], $configuration['cfgValue']);
}
echo 'NEW_CUSTOMERS_ID_RESERVE:' . NEW_CUSTOMERS_ID_RESERVE . "\n";
echo 'NEW_CUSTOMERS_ID_TO_GENERATE:' . NEW_CUSTOMERS_ID_TO_GENERATE . "\n";
...
echo '$last_empty_customer:' . $last_empty_customer ."\n";
