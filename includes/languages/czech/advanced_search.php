...
define('TEXT_SEARCH_HELP_LINK', '<span class="glyphicon glyphicon-info-sign"></span> Pomoc s vyhledáváním');
...
define('ERROR_TO_DATE_LESS_THAN_FROM_DATE', 'Datum Do musí být vyšší než datum Od.');
