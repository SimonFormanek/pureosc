...
define('TEXT_SEARCH_HELP_LINK', '<span class="glyphicon glyphicon-info-sign"></span> Pomoc s vyhledáváním',true);
...
define('TEXT_NO_PRODUCTS', 'Produkt dle zadaných kritérí nebyl nalezen. Zkuste upravit vyhledávací dotaz.',true);
...
define('ERROR_TO_DATE_LESS_THAN_FROM_DATE', 'Datum Do musí být vyšší než datum Od.',true);
...
define('ERROR_PRICE_TO_LESS_THAN_PRICE_FROM', 'cena Do musí být vyšší než cena Od.',true);
