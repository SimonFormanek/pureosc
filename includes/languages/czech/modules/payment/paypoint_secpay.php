...
*/
  ...
  define('MODULE_PAYMENT_PAYPOINT_SECPAY_TEXT_PUBLIC_TITLE', 'Credit Card',true);
  define('MODULE_PAYMENT_PAYPOINT_SECPAY_TEXT_DESCRIPTION', 'Credit Card Test Info:<br /><br />CC#: 4444333322221111<br />Expiry: Any',true);
  define('MODULE_PAYMENT_PAYPOINT_SECPAY_TEXT_ERROR', 'Credit Card Error!',true);
