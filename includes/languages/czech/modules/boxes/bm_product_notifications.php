...
*/
  ...
  define('MODULE_BOXES_PRODUCT_NOTIFICATIONS_TITLE', 'Oznámení o zboží',true);
  define('MODULE_BOXES_PRODUCT_NOTIFICATIONS_DESCRIPTION', 'Ukázat oznámení o zboží',true); //cs?
