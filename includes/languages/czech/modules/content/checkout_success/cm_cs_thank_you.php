...
*/
  ...
  define('MODULE_CONTENT_CHECKOUT_SUCCESS_TEXT_CONTACT_STORE_OWNER', 'Máte-li jakkoli dotazy využijte <a class="btn btn-info" role="button" href="%s">kontaktní formulář</a> stránka.',true);
