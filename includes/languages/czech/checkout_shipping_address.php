...
define('TEXT_SELECT_OTHER_SHIPPING_DESTINATION', 'Vyberte dodací adresu, bude-li dodáno jinam.');
define('TITLE_PLEASE_SELECT', 'vyberte');

define('TABLE_HEADING_NEW_SHIPPING_ADDRESS', 'Nová dodací adresa');
define('TEXT_CREATE_NEW_SHIPPING_ADDRESS', 'Použijte formulář k vytvoření nové dodací adresy.');
