...
define('JQUERY_DATEPICKER_I18N_CODE', '',true); // leave empty for en_US; see http://jqueryui.com/demos/datepicker/#localization pure:todo
...
define('TEXT_GREETING_GUEST', 'Vítejte <span class="greetUser">Neznámý!</span> Chcete se  <a href="%s"><u>přihlásit</u></a>? nebo teprve <a href="%s"><u>zaregistrovat</u></a>?',true);
