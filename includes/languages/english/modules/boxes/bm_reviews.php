...
*/
  ...
  define('MODULE_BOXES_REVIEWS_TITLE', 'Reviews',true);
  define('MODULE_BOXES_REVIEWS_DESCRIPTION', 'Show product reviews',true);
  define('MODULE_BOXES_REVIEWS_BOX_TITLE', 'Reviews',true);
