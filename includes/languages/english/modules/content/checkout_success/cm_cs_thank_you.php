...
*/
  ...
  define('MODULE_CONTENT_CHECKOUT_SUCCESS_TEXT_CONTACT_STORE_OWNER', 'Please forward any questions you may have  <a class="btn btn-info" role="button" href="%s">Contact Us</a>');
