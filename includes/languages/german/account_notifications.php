...
define('MY_NOTIFICATIONS_DESCRIPTION', 'Diese Benachrichtigungen erlauben es Ihnen, über alle änderungen an einem Produkt informiert zu werden.<br><br>Wenn Sie Benachrichtigungen fü unser komplettes Angebot erhalten wollen, sollte Sie die allgemeinen Benachrichtigungen aktivieren.');

define('GLOBAL_NOTIFICATIONS_TITLE', 'Allgemeine Benachrichtungen');
define('GLOBAL_NOTIFICATIONS_DESCRIPTION', 'über alle änderungen informiert werden.');
