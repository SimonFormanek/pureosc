...
*/
  ...
  define('MODULE_CONTENT_CHECKOUT_SUCCESS_THANK_YOU_TITLE', 'Danke',true);
  define('MODULE_CONTENT_CHECKOUT_SUCCESS_THANK_YOU_DESCRIPTION', 'Zeige den DANKE-Block auf der "checkuot sucess" Seite.',true);

  define('MODULE_CONTENT_CHECKOUT_SUCCESS_TEXT_SUCCESS', 'Ihre Bestellung ist bei uns eingelangt! Die bestellten Produkte werden voraussichtlich innerhalb der nächsten 2-5 Arbeitage an der gew&uml;nschten Lieferadresse ankommen.',true);
