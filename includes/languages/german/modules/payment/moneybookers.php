...
*/
  ...
  define('MODULE_PAYMENT_MONEYBOOKERS_LANGUAGE_CODE', 'EN',true);

  define('MB_ACTIVATION_TITLE', 'Moneybookers Account Activation',true);
  define('MB_ACTIVATION_ACCOUNT_TITLE', 'Verify Account',true);
  ...
  define('MB_ACTIVATION_EMAIL_ADDRESS', 'Moneybookers Account E-Mail Address:',true);
  define('MB_ACTIVATION_ACTIVATE_TITLE', 'Account Activation',true);
  define('MB_ACTIVATION_ACTIVATE_TEXT', 'An activation request has been sent to Moneybookers. Please be aware that the verification process to use Moneybookers Quick Checkout could take up to 72 hours. <strong>You will be contacted by Moneybookers when the verification process has been completed.</strong><br /><br /><i>After activation Moneybookers will give you access to a new section in your Moneybookers account called "Merchant Tools". Please choose a secret word (do not use your password for this) and enter it into the merchant tools section and in the configuration of the payment module on the next page.</i>',true);
  define('MB_ACTIVATION_NONEXISTING_ACCOUNT_TITLE', 'Account Error',true);
  define('MB_ACTIVATION_NONEXISTING_ACCOUNT_TEXT', 'The e-mail address is not a registered Moneybookers account. Please <a href="http://www.moneybookers.com/partners/oscommerce" target="_blank">register here</a> to begin selling with Moneybookers.',true);
  define('MB_ACTIVATION_SECRET_WORD_TITLE', 'Secret Word Test',true);
  define('MB_ACTIVATION_SECRET_WORD_SUCCESS_TEXT', 'The secret word has been setup <strong>correctly</strong>! Transactions can now be securely verified with the payment gateway.',true);
  define('MB_ACTIVATION_SECRET_WORD_FAIL_TEXT', 'The secret word configuration has <strong>failed</strong>! Please review the secret word at your Moneybookers "Merchant Tools" account and the configuration of the payment module.',true);
  define('MB_ACTIVATION_SECRET_WORD_ERROR_TITLE', 'Error',true);
  define('MB_ACTIVATION_SECRET_WORD_ERROR_EXCEEDED', 'The maximum number of tries has been exceeded. Please try again in an hour.',true);
  define('MB_ACTIVATION_CORE_REQUIRED_TITLE', 'Core Moneybookers Module Required',true);
  define('MB_ACTIVATION_CORE_REQUIRED_TEXT', 'The core Moneybookers payment module is required to support the Moneybookers Quick Checkout payment options. Please continue to install and configure the core payment module.',true);
  define('MB_ACTIVATION_VERIFY_ACCOUNT_BUTTON', 'Verify Account',true);
  define('MB_ACTIVATION_CONTINUE_BUTTON', 'Continue and configure payment module',true);
  define('MB_ACTIVATION_SUPPORT_TITLE', 'Support',true);
  define('MB_ACTIVATION_SUPPORT_TEXT', 'Do you have questions? Contact Moneybookers by e-mail at <a href="mailto:ecommerce@moneybookers.com">ecommerce@moneybookers.com</a> or by phone +44 (0) 870 383 0762. Your question may also already be answered on the <a href="http://forums.oscommerce.com/forum/78-moneybookers/" target="_blank">osCommerce Community Support forum</a>.',true);
?>
