...
*/
  ...
  define('MODULE_PAYMENT_IPAYMENT_PP_ERROR_HEADING', 'Ein Fehler ist bei der Prüfung Ihrer Prepaidkarte aufgetreten');
  define('MODULE_PAYMENT_IPAYMENT_PP_ERROR_MESSAGE', 'überprüfen Sie bitte Ihre Prepaidkartendetails!');
?>
