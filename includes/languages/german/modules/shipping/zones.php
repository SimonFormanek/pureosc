...
define('MODULE_SHIPPING_ZONES_TEXT_TITLE', 'Zonen Tarif',true);
define('MODULE_SHIPPING_ZONES_TEXT_DESCRIPTION', 'Zonen basierter Tarif',true);
define('MODULE_SHIPPING_ZONES_TEXT_WAY', 'Versand zu',true);
