...
*/
  ...
  define('MB_ACTIVATION_NONEXISTING_ACCOUNT_TITLE', 'Error en la Cuenta');
  define('MB_ACTIVATION_NONEXISTING_ACCOUNT_TEXT', 'La direcci&oacute;n de Correo Electr&oacute;nico no esta registrado en Moneybookers. Por favor <a href="http://www.moneybookers.com/partners/oscommerce" target="_blank">reg&iacute;strese aqu&iacute;</a> para empezar a vender con Moneybookers.');
  define('MB_ACTIVATION_SECRET_WORD_TITLE', 'Prueba de Palabra Secreta');
  define('MB_ACTIVATION_SECRET_WORD_SUCCESS_TEXT', 'La palabra secreta ha sido configurado <strong>correctamente</strong>! Las transacciones pueden ahora ser verificados de forma segura con la pasarela de pago.');
  define('MB_ACTIVATION_SECRET_WORD_FAIL_TEXT', 'La palabra secreta ha sido configurado <strong>incorrectamente</strong>! Por favor revise la palabra secreta en sus "Herramientas de venta" de la cuenta de Moneybookers y la configuraci&oacute;n del m&oacute;dulo de pago.');
  define('MB_ACTIVATION_SECRET_WORD_ERROR_TITLE', 'Error');
  define('MB_ACTIVATION_SECRET_WORD_ERROR_EXCEEDED', 'El n&uacute;mero m&aacute;ximo de intentos se ha excedido. Por favor, vuelva a intentarlo en una hora.');
  define('MB_ACTIVATION_CORE_REQUIRED_TITLE', 'Modulo Principal de pago  (Core Module), Moneybookers es necesario');
  define('MB_ACTIVATION_CORE_REQUIRED_TEXT', 'El m&oacute;dulo principal de pago Moneybookers es necesario para soportar las opciones de pago de Moneybookers Quick Checkout. Por favor, continue para instalar y configurar el m&oacute;dulo de pago principal.');
  define('MB_ACTIVATION_VERIFY_ACCOUNT_BUTTON', 'Verificar cuenta');
  define('MB_ACTIVATION_CONTINUE_BUTTON', 'Continue y configure el m&oacute;dulo de pago');
  define('MB_ACTIVATION_SUPPORT_TITLE', 'Soporte');
  define('MB_ACTIVATION_SUPPORT_TEXT', 'Tiene preguntas ? Contacte a Moneybookers por Correo Electr&oacute;nico a <a href="mailto:ecommerce@moneybookers.com">ecommerce@moneybookers.com</a> o por tel&eacute;fono +44 (0) 870 383 0762. Su pregunta tambi&eacute;n puede ser contestada en el <a href="http://forums.oscommerce.com/forum/78-moneybookers/" target="_blank">Foro de soporte de la Comunidad osCommerce</a>.');
?>
