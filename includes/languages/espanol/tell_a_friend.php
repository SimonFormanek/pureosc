...
define('TEXT_EMAIL_SUCCESSFUL_SENT', 'Tu Correo Electrónico sobre <strong>%s</strong> ha sido enviado con éxito a <strong>%s</strong>.',true);

define('TEXT_EMAIL_SUBJECT', 'Tu amigo %s ha recomendado este gran producto de %s',true);
define('TEXT_EMAIL_INTRO', '¡Hola %s!' . "\n\n" . 'Tu amigo %s, pensó que estarías interesado en %s de %s.',true);
...
define('ERROR_TO_NAME', 'Error: El Nombre de su amigo no puede estar vacío.',true);
define('ERROR_TO_ADDRESS', 'Error: El Correo Electrónico de tu amigo debe ser una dirección válida de correo electrónico.',true);
define('ERROR_FROM_NAME', 'Error: Su nombre no puede estar vacío.',true);
define('ERROR_FROM_ADDRESS', 'Error: Su dirección de correo electrónico debe ser una dirección v&aacute;lida de correo electrónico.',true);
define('ERROR_ACTION_RECORDER', 'Error: Un correo electrónico ya ha sido enviado. Por favor intente de nuevo en %s minutos.',true);
?>
