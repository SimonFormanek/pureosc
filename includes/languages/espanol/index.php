...
define('TEXT_NO_PRODUCTS', 'No hay productos disponibles en esta categoría.',true);
define('TEXT_NUMBER_OF_PRODUCTS', 'Número de Productos: ',true);
define('TEXT_SHOW', '<strong>Mostrar:</strong>',true);
define('TEXT_BUY', 'Comprar 1 \'',true);
