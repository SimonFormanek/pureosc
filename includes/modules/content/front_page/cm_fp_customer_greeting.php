...
*/
  ...
  class cm_fp_customer_greeting {
    ...
    function __construct() {
      ...
      $this->title = MODULE_CONTENT_FRONT_PAGE_CUSTOMER_GREETING_TITLE;
      $this->description = MODULE_CONTENT_FRONT_PAGE_CUSTOMER_GREETING_DESCRIPTION;
      ...
      if ( defined('MODULE_CONTENT_FRONT_PAGE_CUSTOMER_GREETING_STATUS') ) {
        ...
        $this->enabled = (MODULE_CONTENT_FRONT_PAGE_CUSTOMER_GREETING_STATUS == 'True');
      }
    }
