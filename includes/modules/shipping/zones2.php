...
// rest of the world eof
      ...
      if ($shipping == -1) $this->quotes['error'] = MODULE_SHIPPING_ZONES2_UNDEFINED_RATE;
 ...
 */	  
    ...
    function install() {
      ...
      for ($i = 1; $i <= $this->num_zones; $i++) {
        ...
        tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Zone " . $i ." Shipping Method Name', 'MODULE_SHIPPING_ZONES2_TITLE_" . $i ."', 'UPS Air " . $default_countries . "', 'Description of this shipping method shown during checkout. ie. UPS Ground', '6', '0', now())");
    ...
    function keys() {
      $keys = array('MODULE_SHIPPING_ZONES2_STATUS', 'MODULE_SHIPPING_ZONES2_MODE', 'MODULE_SHIPPING_ZONES2_TAX_CLASS', 'MODULE_SHIPPING_ZONES2_SORT_ORDER');
