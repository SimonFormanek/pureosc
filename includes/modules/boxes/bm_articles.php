    ...
    function execute() {
      ...
      // display topic name
          ...
          if (tep_not_null(ARTICLE_BOX_DISPLAY_TOPICS_LINKS_LIMIT) && $topicCtr >= ARTICLE_BOX_DISPLAY_TOPICS_LINKS_LIMIT) {
              $topics_string .= '<span class="articleLinkMarker">-&nbsp;<a href="' . tep_href_link(FILENAME_ARTICLE_TOPICS, '', 'NONSSL') . '">' . $boldTags['start'] . '<div style="float:right; color:red;">...more</div>' . $boldTags['stop'] . '</a></span><br />';
              return;
          }
          $topicCtr++;
           ...
           if (ARTICLE_BOX_DISPLAY_All_ARTICLES_LINKS == 'true') {
              ...
              foreach ($allArticles as $all) {
                 if (! tep_not_null(ARTICLE_BOX_DISPLAY_ALL_ARTICLES_LINKS_LIMIT) || (tep_not_null(ARTICLE_BOX_DISPLAY_ALL_ARTICLES_LINKS_LIMIT) && $ctr < ARTICLE_BOX_DISPLAY_ALL_ARTICLES_LINKS_LIMIT)) {
                     ...
                     $articlesArray['all_articles']['string'] .= '<span class="articleLinkMarker">-&nbsp;<a href="' . tep_href_link(FILENAME_ARTICLE_INFO, 'articles_id='.$all['id'], 'NONSSL') . '">' . $boldTags['start'] . $all['text'] . $boldTags['stop'] . '</a></span>' . (SEPARATE_ARTICLES == 'true' ? '<hr class="separatorArticle">' : '<br />');
                 } else {
                     $articlesArray['all_articles']['string'] .= '<span class="articleLinkMarker">-&nbsp;<a href="' . tep_href_link(FILENAME_ARTICLES, '', 'NONSSL') . '">' . $boldTags['start'] . '<div style="float:right; color:red;">...more</div>' . $boldTags['stop'] . '</a></span><br />';
                     break;
                 }
                 $ctr++;
              }
               ...
               if (ARTICLE_BOX_DISPLAY_NEW_ARTICLES_LINKS == 'true') {
                  ...
                  foreach ($newArticles as $new) {
                     if (! tep_not_null(ARTICLE_BOX_DISPLAY_NEW_ARTICLES_LINKS_LIMIT) || (tep_not_null(ARTICLE_BOX_DISPLAY_NEW_ARTICLES_LINKS_LIMIT) && $ctr < ARTICLE_BOX_DISPLAY_NEW_ARTICLES_LINKS_LIMIT)) {
                         ...
                         $articlesArray['new_articles']['string'] .= '<span class="articleLinkMarker">-&nbsp;<a href="' . tep_href_link(FILENAME_ARTICLE_INFO, 'articles_id='.$new['id'], 'NONSSL') . '">' . $boldTags['start'] . $new['text'] . $boldTags['stop'] . '</a></span>' . (SEPARATE_NEW_ARTICLES == 'true' ? '<hr class="separatorArticle">' : '<br />');
                     } else {
                         $articlesArray['new_articles']['string'] .= '<span class="articleLinkHdr">-&nbsp;<a href="' . tep_href_link(FILENAME_ARTICLES_NEW, '', 'NONSSL') . '">' . $boldTags['start'] . '<div style="float:right; color:red;">...more</div>' . $boldTags['stop'] . '</a></span><br />';
                         break;
                     }
                     $ctr++;
                  }
        ...
        if (ARTICLE_BOX_DISPLAY_TOPICS_SECTION == 'true') {
          ...
          $articlesArray['all_topics']['string'] = '<span class="articleLinkHdr"><a href="' . tep_href_link(FILENAME_ARTICLE_TOPICS, '', 'NONSSL') . '">' . $boldTags['start'] . BOX_ARTICLE_TOPICS . $boldTags['stop'] . '</a></span><br />';
        ...
        if (ARTICLE_BOX_DISPLAY_RSS_FEED_SECTION == 'true') {
          ...
          $articlesArray['rss_feed']['string'] = '<span class="articleLinkHdr"><a href="' . tep_href_link(FILENAME_ARTICLES_RSS, '', 'NONSSL') . '" target="_blank">' . BOX_RSS_ARTICLES . '</a></span><br />';
        }
        ...
        if (ARTICLE_BOX_DISPLAY_SUBMIT_ARTICLE_SECTION == 'true')
        {
          ...
          $articlesArray['submit_article']['string'] = '<span class="articleLinkHdr"><a href="' . tep_href_link(FILENAME_ARTICLE_SUBMIT, '', 'NONSSL') . '">' . $boldTags['start'] . BOX_ARTICLE_SUBMIT . $boldTags['stop'] . '</a></span><br />';
        }
        ...
        if (ARTICLE_BOX_DISPLAY_UPCOMING_SECTION == 'true')
        {
          ...
          if (tep_db_num_rows($upcoming_query) > 0) {
            ...
            $articlesArray['upcoming']['string'] = substr($articlesArray['upcoming']['string'], 0, -4) . '<br />';
          }
        }
        ...
        if (ARTICLE_BOX_DISPLAY_ALL_BLOG_SECTION == 'true')
        {
           ...
           $articlesArray['blog']['string'] .= '<a href="' . tep_href_link(FILENAME_ARTICLES, 'showblogarticles=true', 'NONSSL') . '">' . $boldTags['start'] . BOX_ALL_BLOG_ARTICLES . $boldTags['stop'] . '</a>';
           ...
           if (ARTICLE_BOX_DISPLAY_All_BLOG_LINKS == 'true') {
              ...
              foreach ($allArticles as $all) {
                 if (! tep_not_null(ARTICLE_BOX_DISPLAY_ALL_BLOG_LINKS_LIMIT) || (tep_not_null(ARTICLE_BOX_DISPLAY_ALL_BLOG_LINKS_LIMIT) && $ctr < ARTICLE_BOX_DISPLAY_ALL_BLOG_LINKS_LIMIT)) {
                     ...
                     $articlesArray['blog']['string'] .= '<span class="articleLinkMarker">-&nbsp;<a href="' . tep_href_link(FILENAME_ARTICLE_BLOG, 'articles_id='.$all['id'], 'NONSSL') . '">' . $boldTags['start'] . $all['text'] . $boldTags['stop'] . '</a></span>' . (SEPARATE_BLOG_ARTICLES == 'true' ? '<hr class="separatorBlogArticle">' : '<br />');
                 } else {
                     $articlesArray['blog']['string'] .= '<span class="articleLinkMarker">-&nbsp;<a href="' . tep_href_link(FILENAME_ARTICLES, '', 'NONSSL') . '">' . $boldTags['start'] . '<div style="float:right; color:red;">...more</div>' . $boldTags['stop'] . '</a></span><br />';
                     break;
                 }
                 $ctr++;
              }
